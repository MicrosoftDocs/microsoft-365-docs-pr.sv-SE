...
description: Använd verktyget Innehållssökning i Microsoft 365 Efterlevnadscenter för att snabbt hitta e-post i Exchange-postlådor, dokument på SharePoint-webbplatser och OneDrive-platser samt snabbmeddelandekonversationer i Skype för företag.
...
Använd verktyget innehållssökning i Microsoft 365 Efterlevnadscenter för att snabbt hitta e-post i Exchange-postlådor, dokument på SharePoint-webbplatser och OneDrive-platser samt snabbmeddelandekonversationer i Skype för företag. Du kan använda verktyget för innehållssökning för att söka efter e-post, dokument och snabbmeddelandekonversationer i samarbetsverktyg som Microsoft Teams och Microsoft 365 Grupper.
...
- [Funktionsreferens](content-search-reference.md) för innehållssökning
...
- [Försök att göra en innehållssökning igen](retry-failed-content-search.md) för att lösa ett innehållsplatsfel
