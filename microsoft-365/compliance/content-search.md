...
Med verktyget Innehållssökning i efterlevnadscentret i Office 365 eller Microsoft 365 kan du söka efter lokala objekt, till exempel e-post, dokument och snabbmeddelandekonversationer i organisationen. Du kan söka efter objekt i följande tjänster med verktyget:
...
- Skype för företag-konversationer

När du har kört en innehållssökning visas antalet innehållsplatser och ett uppskattat antal sökresultat i sökstatistiken. Du kan också snabbt visa statistik, till exempel vilka innehållsplatser som har flest objekt som matchar sökfrågan. När du har kört en sökning kan du förhandsgranska resultatet eller exportera det till en lokal dator.

## <a name="create-a-search"></a>Skapa en sökning

För att få åtkomst till sidan **Innehållssökning** och kunna köra sökningar och förhandsgranska och exportera sökresultat måste administratören, den som ansvarar för uppfyllelse av myndighetskrav eller eDiscovery-hanteraren vara medlem i rollgruppen eDiscovery-hanterare i Säkerhets- och efterlevnadscentret. Mer information finns i [Tilldela eDiscovery-behörigheter](assign-ediscovery-permissions.md).
  
1. Gå till [https://compliance.microsoft.com](https://compliance.microsoft.com), logga in med din Microsoft-e-postadress och ditt lösenord.
...
3. Klicka på **Ny sökning** på sidan **Innehållssökning**.
    ...
    Du kan också välja något av de andra sökalternativen:
    
    - **Guidad sökning:** Det här alternativet startar en guide som hjälper dig att skapa sökningen. Användargränssnittet för att välja innehållsplatser och skapa sökfrågan är detsamma som för alternativet **Ny sökning**.
    
    - **Sök efter ID-lista:** Med det här alternativet kan du söka efter specifika e-postmeddelanden och andra postlådeobjekt med en lista med Exchange-ID:n. Om du vill skapa en sökning med en ID-lista skickar du en fil med kommaavgränsade värden (CSV) som identifierar de specifika postlådeobjekt som du vill söka efter. Anvisningar finns i [Förbereda en CSV-fil för en ID-listsökning](csv-file-for-an-id-list-content-search.md). 
    
4. Ange följande under **Sökfråga**:
    
    ![Ange nyckelord, villkor och platser för sökning](../media/1e6de9dd-eac9-4e2a-819d-9740cf6c9106.png)
  
   1. **Nyckelord att söka efter:** Skriv en sökfråga i rutan **Nyckelord**. Du kan ange nyckelord, meddelandeegenskaper (till exempel datum för skickat och mottaget) eller dokumentegenskaper (till exempel filnamn eller det datum då ett dokument senast ändrades). Du kan använda mer komplexa frågor som innehåller booleska operatorer som **AND**, **OR**, **NOT**, och **NEAR**. Du kan också söka efter känslig information (t.ex. personnummer) i dokument, eller söka efter dokument som delats externt. Om du lämnar nyckelordsrutan tom inkluderas allt innehåll på den angivna innehållsplatsen i sökresultatet.

      Alternativt kan du klicka på kryssrutan **Visa nyckelordlista** och skriva ett nyckelord på varje rad. Om du gör det kopplas nyckelorden på varje rad samman med en logisk operator (**c:s**) som fungerar ungefär som operatorn **OR** i sökfrågan som skapas. 
    
      Varför ska jag använda nyckelordslistan? Du kan få statistik som visar hur många objekt som matchar varje nyckelord. Det kan hjälpa dig att snabbt ta reda på vilka nyckelord som är mest (och minst) effektiva. Du kan också använda en nyckelordsfras (omgiven av parenteser) på en rad. Mer information om sökstatistik finns i [Visa nyckelordsstatistik för resultat av innehållssökning](view-keyword-statistics-for-content-search.md).

      > [!NOTE]
      > Eftersom stora nyckelordlistor kan orsaka problem kan du nu använda maximalt 20 rader i nyckelordslistan.
    
    2. **Villkor:** Du kan lägga till sökvillkor om du vill begränsa sökningen och få en mer förfinad uppsättning resultat. Varje villkor lägger till en sats i sökfrågan som skapas och körs när du startar sökningen. Ett villkor kopplas till nyckelordsfrågan (anges i nyckelordsrutan) med en logisk operator (**c:c**) som fungerar ungefär som operatorn **AND**. Det innebär att objekten måste uppfylla både nyckelordsfrågan och ett eller flera villkor för att tas med i resultatet. Det är så du begränsar resultatet med hjälp av villkor. En lista och en beskrivning av de villkor som du kan använda i en sökfråga finns i avsnittet Sökvillkor i [Nyckelordsfrågor och sökvillkor för Innehållssökning](keyword-queries-and-search-conditions.md#search-conditions).
    
    3. **Platser:** Välj innehållsplatser för sökning.
    
      - **Alla platser:** Använd det här alternativet om du vill söka på alla innehållsplatser i organisationen. Det omfattar e-post i alla Exchange-postlådor (inklusive alla inaktiva postlådor, och postlådor för alla Microsoft Teams, Yammer-grupper och Microsoft 365-grupper), alla Skype för företag-konversationer, alla SharePoint- och OneDrive för företag-webbplatser (inklusive webbplatserna för alla Microsoft Teams, Yammer-grupper och Microsoft 365-grupper) och alla objekt i alla gemensamma Exchange-mappar.
    
      - **Särskilda platser:** Använd det här alternativet om du vill söka på särskilda innehållsplatser. Du kan söka på alla innehållsplatser för en viss Office 365-tjänst (t.ex. söka i alla Exchange-postlådor eller söka på alla SharePoint-webbplatser), eller så kan du söka efter innehåll på specifika platser i alla Office 365-tjänster som visas. 
    
        ![Användargränssnitt för att välja innehållsplatser att söka på](../media/9a09708b-f8a2-4382-8c4e-2c610ec33c72.png)
  
         Du kan också lägga till distributionsgrupper i listan med Exchange-postlådor som du vill söka i. För distributionsgrupper genomsöks postlådorna för gruppmedlemmarna. Dynamiska distributionsgrupper stöds inte.
    
        > [!NOTE]
        > När du söker i alla postlådor eller bara specifika postlådor tas data från andra Office 365-program som sparas i användarpostlådor med när du exporterar resultaten av en innehållssökning. Dessa data tas inte med i de uppskattade sökresultaten och är inte tillgängliga för förhandsgranskning. De tas med när du exporterar och laddar ned sökresultatet. Mer information finns i [Innehåll som lagras i Exchange Online-postlådor](what-is-stored-in-exo-mailbox.md).

   4. **Lägg till appinnehåll för lokala användare:** Markera den här kryssrutan om du vill ta med Teams-innehåll för lokala användare i sökningen. Om du till exempel söker i alla Exchange-postlådor i organisationen och markerar den här kryssrutan tas molnbaserad lagring som används för att lagra Teams chattdata för lokala användare med i sökningen. Mer information finns i [Söka efter Teams chattdata för lokala användare](search-cloud-based-mailboxes-for-on-premises-users.md).

5. Klicka på **Spara och kör** när du har skapat din sökfråga.
    
6. På sidan **Spara sökning** anger du ett namn för sökningen och en valfri beskrivning som hjälper dig att identifiera sökningen. Namnet på sökningen måste vara unikt i din organisation. 
    
7. Klicka på **Spara** för att starta sökningen. 
    
    När du har sparat och kört sökningen visas alla resultat som returneras av sökningen i resultatfönstret. Antingen visas sökresultatet eller så måste du klicka på **Förhandsgranska** för att visa det, beroende på hur du har konfigurerat förhandsgranskningsinställningen. Se nästa avsnitt för mer information. 
...
Klicka på ![Ikonen Lägg till](../media/O365-MDM-CreatePolicy-AddIcon.gif) **Ny sökning** om du vill rensa resultatet eller skapa en annan sökning.
  
## <a name="preview-search-results"></a>Förhandsgranska sökresultat

Det finns två konfigurationsinställningar för förhandsgranskning av sökresultat. När du har kört en ny sökning eller öppnat en befintlig sökning kan du visa följande förhandsgranskningsinställningar genom att klicka på **Individuella resultat**: 
  
![Inställningar för förhandsgranskning av sökresultat](../media/83519477-1c85-4442-8886-481f186fd758.png)
  
1. **Förhandsgranska resultatet automatiskt:** Den här inställningen visar sökresultatet när du har kört en sökning.
    
2. **Förhandsgranska resultatet manuellt:** Den här inställningen visar platshållare i sökresultatfönstret och visar knappen **Förhandsgranska resultat** som du måste klicka på för att visa sökresultat. Det här är standardinställningen. Sökprestandan blir bättre eftersom sökresultaten inte visas automatiskt när du öppnar en befintlig sökning. 
    
Antalet objekt som är tillgängliga för förhandsgranskning är begränsat. Mer information finns i [Begränsningar för innehållssökning](limits-for-content-search.md). 
  
En lista över filtyper som kan förhandsgranskas finns i avsnittet ”Mer information om innehållssökning” i [Förhandsgranska sökresultat](#previewing-search-results). Om en filtyp inte kan förhandsgranskas eller om du vill ladda ned en kopia av ett dokument kan du klicka på **Ladda ned original** för att ladda ned filen till din lokala dator. För ASPX-webbsidor ingår URL-adressen för sidan, men du kanske inte har behörighet att komma åt sidan. 
  
Observera även att icke indexerade objekt inte är tillgängliga för förhandsgranskning.
  
## <a name="view-information-and-statistics-about-a-search"></a>Visa information och statistik om en sökning

När du har skapat och kört en innehållssökning kan du visa statistik om uppskattade sökresultat. Det omfattar en sammanfattning av sökresultatet, frågestatistik (till exempel antalet innehållsplatser med objekt som matchar sökfrågan) och namnet på de innehållsplatser som har flest matchande objekt. Du kan visa statistik för en eller flera innehållssökningar. Det gör att du snabbt kan jämföra resultaten för flera sökningar och avgöra hur effektiva dina sökfrågor är.
  
Du kan också ladda ned sökstatistiken och nyckelordsstatistiken till en CSV-fil. På så sätt kan du använda filtrerings- och sorteringsfunktionerna i Excel för att jämföra resultat och förbereda rapporter för sökresultaten.
  
Så här visar du sökstatistik:
  
1. Klicka på **Öppna** på sidan **Innehållssökning** och klicka sedan på sökningen som du vill visa statistik för.
  
2. Klicka på **Öppna fråga** på den utfällbara sidan. 
  
3. Klicka på **Sökstatistik** i listrutan **Individuella resultat**.
  
4. I listrutan **Typ** klickar du på något av följande alternativ beroende på vilken sökstatistik du vill visa:
  
    - **Sammanfattning:** Visar statistik för varje typ av innehållsplats som genomsöks. Här visas antalet innehållsplatser som innehöll objekt som matchade sökfrågan samt det totala antalet och storleken på sökresultatobjekten. Det här är standardinställningen.

    - **Frågor:** Visar statistik om sökfrågan. Det här omfattar den typ av innehållsplats som frågestatistiken avser, den del av sökfrågan som statistiken avser (observera att **Primär** anger att det är hela sökfrågan), antalet innehållsplatser som innehåller objekt som matchar sökfrågan och det totala antalet, storleken och objekten som hittades (på den angivna innehållsplatsen) som matchar sökfrågan. Statistik för icke indexerade objekt (även kallade *delvis indexerade objekt*) visas också. Men endast delvis indexerade objekt från postlådor tas med i statistiken. Delvis indexerade objekt från SharePoint och OneDrive tas inte med i statistiken.

    - **Översta platser:** Visar statistik om antalet objekt som matchar sökfrågan på varje innehållsplats. De 1 000 översta platserna visas.

Mer detaljerad information om sökstatistik finns i [Visa nyckelordsstatistik för resultat av innehållssökning](view-keyword-statistics-for-content-search.md).
  
## <a name="export-search-results"></a>Exportera sökresultat

När en sökning har körts kan du exportera sökresultatet till en lokal dator. När du exporterar e-postresultat kan du ladda ned dem till datorn som PST-filer eller som enskilda meddelanden (MSG-filer). När du exporterar innehåll från SharePoint- och OneDrive-webbplatser exporteras kopior av ursprungliga Office-dokument. Det finns även andra dokument och rapporter som ingår i exporterade sökresultat. Du kan också exportera sökresultatrapporten utan de faktiska objekten.
  
Så här exporterar du sökresultat:
  
1. På sidan **Innehållssökning** klickar du på den sökning som du vill exportera sökresultat för. 

2. Klicka på **Exportera resultat** på den utfällbara sidan. Du kan också exportera en sökresultatrapport.

3. Slutför avsnitten på sidan **Exportera resultat**. Använd rullningslisten så att du ser alla exportalternativ.

Mer detaljerade instruktioner och felsökningstips finns i:
...
## <a name="more-information-about-content-search"></a>Mer information om innehållssökning

I följande avsnitt finns mer information om innehållssökning.
  
[Begränsningar för innehållssökning](#content-search-limits)
  
[Skapa en sökfråga](#building-a-search-query)
  
[Söka i OneDrive-konton](#searching-onedrive-accounts)
  
[Söka i Microsoft Teams och Microsoft 365-grupper](#searching-microsoft-teams-and-microsoft-365-groups)

[Söka i Yammer-grupper](#searching-yammer-groups)
  
[Söka i inaktiva postlådor](#searching-inactive-mailboxes)
  
[Söka i frånkopplade eller avlicensierade postlådor](#searching-disconnected-or-de-licensed-mailboxes)

[Förhandsgranska sökresultat](#previewing-search-results)
  
[Delvis indexerade objekt](#partially-indexed-items)

[Söka efter innehåll i en SharePoint Multi-Geo-miljö](#searching-for-content-in-a-sharepoint-multi-geo-environment)
...
### <a name="previewing-search-results"></a>Förhandsgranska sökresultat

Du kan förhandsgranska de filtyper som stöds i förhandsgranskningsfönstret. Om filtypen inte stöds måste du ladda ned en kopia av filen till den lokala datorn för att kunna visa den. Följande filtyper stöds och kan förhandsgranskas i sökresultatfönstret.
