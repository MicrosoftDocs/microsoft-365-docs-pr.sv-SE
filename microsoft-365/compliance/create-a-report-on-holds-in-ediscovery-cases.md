...
Det första steget är att ansluta till Security & Compliance Center, PowerShell för din organisation. Stegvisa instruktioner finns i Skapa säkerhets- [Anslut Säkerhets- & Compliance Center PowerShell.](/powershell/exchange/connect-to-scc-powershell)
