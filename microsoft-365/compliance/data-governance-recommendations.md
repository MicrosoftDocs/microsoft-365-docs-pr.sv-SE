...
Den här rekommendationen visas när e-postmeddelanden identifieras som meddelandetypen ‘Röstmeddelanden’ upptäcks i användarnas postlådor. Läs mer om [meddelandeegenskaper i Exchange](/exchange/policy-and-compliance/ediscovery/message-properties-and-search-operators?view=exchserver-2019#searchable-properties-in-exchange).
