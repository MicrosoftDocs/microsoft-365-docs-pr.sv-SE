...
#### <a name="step-2-install-mcca"></a><span data-ttu-id="3ea3f-122">Steg 2: Installera MCCA</span><span class="sxs-lookup"><span data-stu-id="3ea3f-122">Step 2: Install MCCA</span></span>
...
<span data-ttu-id="3ea3f-153">Följ de här anvisningarna om du vill köra en rapport baserat på en viss plats:</span><span class="sxs-lookup"><span data-stu-id="3ea3f-153">Follow these instructions to run a report based on a specific location:</span></span>
...
<span data-ttu-id="3ea3f-190">Rapporten anpassas också efter din roll.</span><span class="sxs-lookup"><span data-stu-id="3ea3f-190">Your report will also be customized based on your role.</span></span>

<span data-ttu-id="3ea3f-191">I tabellen nedan visas vilka roller som har åtkomst till vilka avsnitt i rapporten.</span><span class="sxs-lookup"><span data-stu-id="3ea3f-191">The table below shows which roles have access to which sections of the report.</span></span> <span data-ttu-id="3ea3f-192">Andra roller i organisationen (som inte visas i tabellen nedan) kanske inte kan köra verktyget, eller så kan de köra verktyget och har begränsad åtkomst till information i den slutliga rapporten.</span><span class="sxs-lookup"><span data-stu-id="3ea3f-192">Other roles within your organization (not listed in the table below) may not be able to run the tool, or they may run the tool and have limited access to information in the final report.</span></span>

<span data-ttu-id="3ea3f-193">![MCCA – roller](../media/compliance-manager-mcca-roles.png "MCCA-roller")</span><span class="sxs-lookup"><span data-stu-id="3ea3f-193">![MCCA - roles](../media/compliance-manager-mcca-roles.png "MCCA roles")</span></span>

<span data-ttu-id="3ea3f-194">Undantag:</span><span class="sxs-lookup"><span data-stu-id="3ea3f-194">Exceptions:</span></span>
1. <span data-ttu-id="3ea3f-195">Användarna kan inte generera rapporten om IP förutom avsnittet "Använd IRM för Exchange Online".</span><span class="sxs-lookup"><span data-stu-id="3ea3f-195">Users won't be able to generate report for IP apart from “Use IRM for Exchange Online” section.</span></span>
2. <span data-ttu-id="3ea3f-196">Användarna kan generera rapporten om IP förutom avsnittet "Använd IRM för Exchange Online".</span><span class="sxs-lookup"><span data-stu-id="3ea3f-196">Users will be able to generate report for IP apart from “Use IRM for Exchange Online” section.</span></span>
3. <span data-ttu-id="3ea3f-197">Användarna kommer att kunna generera en rapport om IP förutom avsnittet "Aktivera kommunikationsefterlevnad i O365".</span><span class="sxs-lookup"><span data-stu-id="3ea3f-197">Users will be able to generate report for IP apart from “Enable Communication Compliance in O365” section.</span></span>
4. <span data-ttu-id="3ea3f-198">Användarna kan inte generera rapporter för IP förutom avsnittet "Aktivera granskning i Office 365".</span><span class="sxs-lookup"><span data-stu-id="3ea3f-198">Users won't be able to generate report for IP apart from “Enable Auditing in Office 365” section.</span></span>
5. <span data-ttu-id="3ea3f-199">Användarna kan generera rapporten för IP förutom avsnittet "Aktivera granskning i Office 365".</span><span class="sxs-lookup"><span data-stu-id="3ea3f-199">Users will be able generate report for IP apart from “Enable Auditing in Office 365” section.</span></span>
...
<span data-ttu-id="3ea3f-210">Markera en ruta för att visa förbättringar och rekommendationer.</span><span class="sxs-lookup"><span data-stu-id="3ea3f-210">Select a box to view improvements and recommendations.</span></span>
