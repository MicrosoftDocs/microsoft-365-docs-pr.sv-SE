...
- Som tidigare har föreslagits behöver du inte använda  en filterlista för att inkludera ett filter för Webbplats och **SiteContent** i ett enda filter för sökbehörigheter. Du kan till exempel kombinera **Webbplats och** ett **SiteContent-filter** med hjälp av en **-eller operator.**
