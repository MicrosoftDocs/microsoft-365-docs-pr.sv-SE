...
|Namn på bifogade filer|AttachmentNames|Attachment_Names|Lista över namn på bifogade filer.|
...
|Dokumentändring||Doc_revision|Revision från dokumentmetadata.|
...
|Leveranskvitto för e-post||Email_delivery_receipt|E-postadress som anges i Internethuvuden för leveranskvitto.|
...
|EmailReadReceipt*||Email_read_receipt|E-postadress som anges i Internethuvuden för läskvitto.|
...
|Extraherad innehållstyp||Extracted_content_type|Extraherad innehållstyp, i form av mimetyp. till exempel **bild/jpeg**|
|ExtractedTextLength*||Extracted_text_length|Antal tecken i den extraherade texten.|
|Relevansresultat för familjen – ärende 1*||Family_relevance_score_case_issue_1|Relevanspoäng för familjen – ärende 1 från Relevans.|
...
|Resultat för filrelevans – ärende 1*||File_relevance_score_case_issue_1|Poäng för filrelevans Ärende 1 från Relevans.|
...
|Markerat som förtaggat ärendeproblem 1*||Marked_as_pre_tagged_Case_issue_1|Markerat som förtaggat Ärendeproblem 1 från Relevans.|
|Markerat som startfall – problem 1*||Marked_as_seed_Case_issue_1|Markerat som startfall – problem 1 i relevans.|
...
|Normaliserad relevansresultat , ärende 1||Normalized_relevance_score_case_issue_1|Normaliserad relevansresultat Ärende 1 från Relevans.|
...
|Överordnad sökväg|ParentPath|Parent_path|Sammansatt sökväg för det direkta överordnade objektet.|
...
|Läs upp problem med procent, ärende 1||Read_percent_Case_issue_1|Läs procentfallsproblemet 1 i Relevans.|
...
|Relevans inläsningsgrupp – problem 1||Relevance_load_group_case_issue_1|Relevans inläsningsgrupp – problem 1 i relevans.|
|Relevansstatusbeskrivning – problem 1||Relevance_status_description_Case_issue_1|Relevansstatusbeskrivning Ärende 1 från Relevans.|
|Problem med relevanstagg – ärende 1||Relevance_tag_case_issue_1|Problem med relevanstaggen Ärende 1 från Relevans.|
|Relevanskommentar||Relevance_comment|Fältet Kommentar från Relevans.|
...
|Tagged by Case issue 1||Tagged_by_Case_issue_1|Användaren som har taggat det här dokumentet för ärende 1 i relevans.|
