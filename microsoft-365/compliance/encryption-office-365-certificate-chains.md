...
### <a name="digicert-cloud-services-ca-1-older"></a>**DigiCert Cloud Services CA-1** (äldre)
...
### <a name="globalsign-organization-validation-ca---sha256---g2-older"></a>**GlobalSign Organization Validation CA – SHA256 – G2** (äldre)
