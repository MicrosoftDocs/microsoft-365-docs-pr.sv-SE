...
- Stegen i den här artikeln förutsätter att du har skapat ett PST-importjobb i Office 365 med nätverksuppladdning eller leverans av hårddisk. Stegvisa instruktioner finns i följande avsnitt:
  ...
  - [Använd nätverksuppladdning för att importera PST-filer till Office 365](use-network-upload-to-import-pst-files.md)
...
2. Klicka **på Informationsstyrning** \> **Importera** \> **PST-filer.**
    
    Importjobben för din organisation visas på sidan **Importera PST-filer.** Observera att värdet **För analys slutfört** i kolumnen **Status** anger importjobben som har analyserats av Microsoft 365 och är redo att importeras. 
    
    ![Status för analys är att Microsoft 365 har analyserat data i PST-filer](../media/de5294f4-f0ba-4b92-a48a-a4b32b6da490.png)
  
3. Klicka **på Redo att importera Office 365** importjobbet du vill slutföra. 
...
4. Klicka **på Importera för att Office 365**.
    ...
    Sidan **Filtrera dina data** visas. Den innehåller datainsikter om data i PST-filerna för importjobbet, inklusive information om datas ålder. 
...
5. Gör något av följande beroende på om du vill trimma data som importerats till Microsoft 365 under Vill du **filtrera data?**
    ...
    Du kan konfigurera dessa filter:
      ...
      - **Typ** – I det här avsnittet visas alla meddelandetyper som hittades i PST-filerna för importjobbet. Du kan avmarkera en ruta bredvid en meddelandetyp som du vill utesluta. Observera att du inte kan utesluta meddelandetypen Annan. I avsnittet [Mer information](#more-information) finns en lista över postlådeobjekt som ingår i kategorin Annan. 
    ...
    Datainsikterna på sidan **Importera data till Office 365** uppdateras baserat på filterinställningarna, inklusive den totala mängden data som kommer att importeras baserat på filterinställningarna. Observera att även en sammanfattning av filterinställningarna visas. Du kan klicka **på** Redigera bredvid ett filter för att ändra inställningen om det behövs. 
    ...
    e. Klicka **på Importera data** för att starta importen. Observera att den totala mängden data som ska importeras visas. 
    ...
    b. På sidan **Importera data till Office 365** klickar du på Importera data **för** att starta importen. Observera att den totala mängden data som ska importeras visas. 
    
6. Klicka på **Uppdatera uppdatering på** sidan Importera  ![ PST-filer. ](../media/165fb3ad-38a8-4dd9-9e76-296aefd96334.png) Status för importjobbet visas i **kolumnen** Status. 
