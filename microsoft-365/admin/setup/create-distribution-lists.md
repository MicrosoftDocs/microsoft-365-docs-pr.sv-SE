...
Används när du vill skicka e-post till en grupp personer utan att behöva skriva varje enskild mottagares namn, organiseras distributionsgrupper av ett visst diskussionsämne (till exempel "Marknadsföring") eller av användare som delar gemensamt arbete som kräver att de kommunicerar ofta. De ger dig också ett sätt för dig att automatiskt vidarebefordra e-post till flera e-postadresser.
