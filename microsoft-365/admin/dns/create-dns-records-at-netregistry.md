...
När du har lagt till dessa poster i Netregistry konfigureras domänen så att den fungerar med Office 365-tjänster.
...
2. Bredvid den domän som du vill hantera väljer du **Hantera**.
    
    ![Netregistry_Manage](../../media/64ad542a-5ec4-4148-96f8-d6e163449352.png)
  
3. Välj **Zonhanteraren**.
    
    ![Netregistry_selectZoneManager](../../media/e18c32f9-c1e7-4aa2-9aa6-8dc9c5ea44af.png)
  
4. Under **Lägg till en zonpost**väljer du **TXT-post** i listan och väljer sedan **Skapa ny post**.
...
4. Under **Lägg till en zonpost**väljer du **CNAME-post** i listan och väljer sedan **Skapa ny post**.
...
4. Under **Lägg till en zonpost**väljer du **SRV-post** i listan och väljer sedan **Skapa ny post**.
