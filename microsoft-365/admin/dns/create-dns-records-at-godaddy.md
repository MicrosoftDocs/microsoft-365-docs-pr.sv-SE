...
4. Välj **TXT (Text)** i listrutan. I den nya postens rutor skriver du in, eller kopierar och klistrar in, värdena från följande tabell.
    ...
    |:-----|:-----|:-----|:-----|
    |TXT (Text)|@|MS=ms *XXXXXXXX*<br>**Obs:** Detta är ett exempel. Använd ditt specifika **mål- eller poäng till-adress-värde** här, från bordet. [Hur hittar jag detta?](../get-help-with-domains/information-for-dns-records.md)|1 timme  <br>(Välj ett värde i listrutan.)|
