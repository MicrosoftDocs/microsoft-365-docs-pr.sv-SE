...
När du har lagt till dessa poster på galna Domains är domänen konfigurerad för att fungera med Microsoft-tjänster.
...
3. Välj namnet på den domän som du uppdaterar i avsnittet **Domain** på sidan **Domain Names** . 
    
    ![CrazyDomains-BP-Configure-1-3](../../media/4dd7bb74-c8ed-4b4a-b4c1-d9538fc6bd9a.png)
  
4. I avsnittet **DNS Settings** väljer du ikonen för List rutan. 
...
10. Om det finns andra MX-poster i avsnittet **MX Record** väljer du **ändra** för en av dessa poster. 
...
11. Välj **Uppdatera** för att spara ändringarna. 
...
8. Lägg till den första av de två SRV-posterna.
    ...
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |SRV Record  <br/> |_sip _sip._tls  <br/> |100  <br/> |9.1  <br/> |443  <br/> |sipdir.online.lync.com  <br/> |
    |SRV Record  <br/> |_sipfederationtls _sipfederationtls._tcp  <br/> |100  <br/> |9.1  <br/> |5061  <br/> |sipfed.online.lync.com  <br/> |
