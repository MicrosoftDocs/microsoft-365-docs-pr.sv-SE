...
> [!IMPORTANT]
> För DNSMadeEasy-konton: domänen du lade till köptes från en separat domänregistrator. DNSMadeEasy erbjuder inte domänregistreringstjänster. Möjligheten att logga in på DNSMadeEasy och skapa DNS-posten är ett tillräckligt bevis på ägarskap. 
...
2. Välj den domän du vill **uppdatera i området Recently Updated Domains** på sidan Management **Console.** 
    
3. På sidan **Managed DNS,** i området **TXT Records,** väljer du kontrollen ( **+** ) ( Add **new**).
...
2. Välj den domän du vill **uppdatera i området Recently Updated Domains** på sidan Management **Console.** 
    ...
    Välj den domän du vill **uppdatera i området Recently Updated Domains** på sidan Management **Console.** 
    
    ![DNSMadeEasy-BP - Konfigurera-1-2](../../media/8d8f403e-d7cd-429e-913b-dacb1f4644a2.png)
  
3. Gå till **sidan Managed DNS** och området MX **Records.** Välj kontrollen **(+)** ( Add **new**).
...
4. Gå till området **Add MX Records**. I den nya postens rutor skriver du in, eller kopierar och klistrar in, värdena från följande tabell. 
    ...
    |:-----|:-----|:-----|:-----|
    |(Lämna det här fältet tomt.)  <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **Värdet MÅSTE sluta med en punkt (.)** <br/> **Obs!** Hämta din \<*domain-key*\> från ditt Microsoft-konto. [Hur hittar jag det?](../get-help-with-domains/information-for-dns-records.md)          |10  <br/> Mer information om prioritet finns i [Vad är MX-prioritet?](../setup/domains-faq.yml) <br/> |1800  <br/> |
...
8. I dialogrutan **Delete MX Records** väljer du Delete **för** att bekräfta ändringarna. 
...
3. Gå till **sidan Managed DNS** och området **CNAME Records.** Välj kontrollen **(+)** ( Add **new**).
...
6. Lägg till var och en av de andra fyra CNAME-posterna.
    ...
    I **avsnittet CNAME Records** väljer du kontrollen **(+) (** **Add new**), skapar en post med värdena från nästa rad i tabellen och väljer sedan **Submit** igen för att slutföra posten. 
...
3. Gå till **sidan Managed DNS** och området TXT **Records.** Välj kontrollen **(+)** (Add **new).**
...
3. På sidan **Managed DNS,** i området **SRV Records,** väljer du **kontrollen (+)** ( Add **new**).
...
6. Lägg till den andra SRV-posten.
    ...
    I avsnittet **SRV Records** väljer du kontrollen **(+) (** **Add new**), skapar en post med hjälp av värdena från nästa rad i tabellen och väljer sedan **Submit** igen för att slutföra posten. 
