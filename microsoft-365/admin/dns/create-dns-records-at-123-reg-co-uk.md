...
När du har lagt till dessa 123-reg.co.uk posterna är domänen konfigurerad för att fungera med Microsoft-tjänster.
...
4. På sidan **Manage your DNS** väljer du fliken Advanced **DNS.** 
...
5. Gå till avsnittet **Advanced DNS**. I den nya postens rutor skriver du in, eller kopierar och klistrar in, värdena från följande tabell. 
    ...
    |:-----|:-----|:-----|:-----|
    |@  <br/> |MX  <br/> |1  <br/> [Mer information om prioritet finns i ](../setup/domains-faq.yml)Vad är MX-prioritet? <br/> | *\<domain-key\>*  .mail.protection.outlook.com.  <br/> **Värdet MÅSTE sluta med en punkt (.)** <br/> **Obs!** Hämta din \<domain-key\> från ditt Microsoft-konto. [Hur hittar jag det här?](../get-help-with-domains/information-for-dns-records.md)          |
...
7. Om det finns andra MX-poster tar du bort var och en av dem genom att välja ikonen Ta bort **(papperskorg)** för den posten. 
...
5. Lägg till den första av de fem CNAME-posterna.
...
7. Lägg till de andra fyra CNAME-posterna.
    ...
    I avsnittet **Advanced DNS** skapar du en post med värdena från nästa rad i tabellen och väljer sedan **Add** igen för att slutföra posten. 
...
7. Lägg till den andra SRV-posten:
    ...
    I avsnittet **Advanced DNS** skapar du en post med värdena från den andra raden i tabellen och väljer sedan **Add** igen för att slutföra posten. 
