...
5. Lägg till den första av de två SRV-posterna:
    ...
    ||||||
    |:-----|:-----|:-----|:-----|:-----|
    |Hostname|Type (Typ)|Priority|TTL|Destination SRV|
