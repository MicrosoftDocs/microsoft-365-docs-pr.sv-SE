...
- [Lägg till de sex CNAME-posterna som krävs för Microsoft](#add-the-six-cname-records-that-are-required-for-microsoft)
...
När du har lagt till dessa poster på Microsoft är domänen konfigurerad för att fungera med Microsoft-tjänster.
