...
**Om du är användare eller har ett Microsoft 365-familjeabonnemang har du inget administrationscenter.** Om du vill konfigurera Microsoft 365 går du till [Hämta och installera eller installera om Microsoft 365 eller Office 2019 på en PC eller Mac](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658).
...
2. Välj ikonen för startprogrammet i det övre vänstra hörnet, och välj sedan **Admin**.
    ...
    Panelen **Admin** visas bara för personer som har microsoft 365-administratörsbehörigheter . [admin permissions](../add-users/about-admin-roles.md) Om du inte ser panelen har du inte behörighet att komma åt organisationens administrationscenter.
