...
**Om du har köpt ett Microsoft 365 för affärsabonnemang och du har administratörsbehörighet har du åtkomst till administrationscentret**. Den här artikeln är för dig!
...
2. Välj ikonen för startprogrammet i det övre vänstra hörnet, och välj sedan **Admin**.
    ...
    Panelen **Admin** visas bara för personer som har Microsoft 365-administratörsbehörighet . [admin permissions](../add-users/about-admin-roles.md) Om du inte ser panelen har du inte behörighet att komma åt organisationens administrationscenter.
