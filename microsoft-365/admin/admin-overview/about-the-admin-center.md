...
**Om du har köpt Microsoft 365 för affärsplan och du har administratörsbehörighet har du åtkomst till administrationscentret**. Den här artikeln är för dig!

**Om du är användare eller har Microsoft 365 Family en plan har du inget administrationscenter.** Om du vill Microsoft 365 till Hämta och [installera eller installera om Microsoft 365 eller Office 2019 på en PC eller Mac](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658).
...
2. Välj ikonen för startprogrammet i det övre vänstra hörnet, och välj sedan **Admin**.
    ...
    Panelen **Admin** visas bara för personer som har Microsoft 365 [administratörsbehörigheter](../add-users/about-admin-roles.md). Om du inte ser panelen har du inte behörighet att använda administrationscentret för din organisation.
...
- Hantera användare: [Lägg till användare och tilldela licenser samtidigt](../add-users/add-users.md), Ta bort eller återställ [användare](../add-users/delete-a-user.md)eller Återställ en [användares lösenord](../add-users/reset-passwords.md).
