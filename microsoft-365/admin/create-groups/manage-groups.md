...
1. Gå till sidan grupper i administrations centret **Groups** \> **Groups** och välj den grupp du vill ändra.

2. Bredvid **namn**väljer du **Redigera**.

3. Aktivera **skicka kopior av gruppkonversationer och händelser till grupp medlemmarnas inkorgar** **om du vill att medlemmarna** ska få kopior av grupp meddelanden och Kalender objekt i sin egen inkorg.
...
1. Uppdatera din administratörs Center sida så att den nya gruppen visas.
    
2. I listan administrations Center grupper väljer du den grupp du vill ändra och väljer sedan **Redigera**bredvid **namn**. 
