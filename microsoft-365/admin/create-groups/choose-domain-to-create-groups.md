...
- Alla andra användare i groups.contoso.com-domänen. Använd det här kommandot:
...
- Grupper av användare bestäms med standardfrågorna (Användaregenskaper) som redan finns tillgängliga. Läs filter bara [Egenskaper för parametern-RecipientFilter](https://go.microsoft.com/fwlink/p/?LinkId=785918) för filter bara egenskaper som stöds. 
...
[Skapa en Microsoft 365-grupp i administrations centret](create-groups.md)
