...
Vi har moderniserat meddelandecentret för att hjälpa dig att upptäcka relevanta meddelanden och lagt till en mer flexibel läsupplevelse. Vi har lagt till en ny **kolumn för** tjänster som hjälper dig att söka igenom vilken tjänst ett meddelande gäller för och filtrera meddelanden efter tjänst och andra metadata. Du kan markera ett meddelande som en favorit för uppföljning, välja vilka kolumner som ska visas i meddelandelistan och navigera mellan meddelanden med knapparna Bakåt och Nästa. Vi har också förbättrat processen för att göra det enklare att ge feedback på inlägg i Meddelandecenter.
...
Välkommen till Microsoft Ignite – vår första ignite online. Vi hoppas att du är med i en av våra sessioner: [Microsoft Ignite 2020 Sessionskatalog](https://myignite.microsoft.com/sessions). Här är bara några av de saker vi kommer att prata om på Ignite.
> [!NOTE]
> Alla funktioner blir inte tillgängliga för alla direkt. Om du inte ser de nya funktionerna kan du [ansluta till Riktad version.](manage/release-options-in-office-365.md)

### <a name="multi-tenant-management"></a>Hantering av flera innehavare

Vi har utvecklat en uppsättning funktioner för administratörer med flera klientorganisationen som du för att få ditt jobb gjort snabbare och mer effektivt. Mer information finns i [Hantera flera klientorganisationar.](multi-tenant/manage.md)

- **Dina klientorganisationen:** Växla snabbt mellan de klientorganisationar som du hanterar.
- **Alla klientorganisationen**: En ny sida där du snabbt kan se hälsotillståndet för alla klientorganisationens tjänster, alla öppna tjänstförfrågningar, dina produkter och fakturering, rekommenderade konfigurationsuppgifter och antalet användare i klientorganisationen.
- **Konfiguration:** Sidan Konfiguration för flera innehavare ger dig en listvy av sidan Inställningar, men ordnad för många klientorganisationar. Du kan se vilka funktioner som inte är aktiverat, vilka uppgifter som är slutförda för alla klientorganisationen, aktiviteter som klientorganisationen fortfarande behöver slutföra. Den här vyn hjälper dig att hålla reda på införande av funktioner och att se till att de rekommenderade säkerhetsinställningarna alltid utförs.
- **Tjänstens** hälsa: Vyn Tjänstens hälsa visar om några incidenter eller rådgivning påverkar klientorganisationen. Där ser du även hur många av dina hanterade klientorganisationar som påverkas. Välj en incident för att få mer information på fliken Översikt och växla sedan till fliken Klientorganisationen som påverkas för att granska nedåt och ge support för den klientorganisationen.
- **Postlådemigrering** mellan klientorganisationen är en ny tjänst, som nu är en offentlig förhandsversion, och som gör att du kan flytta postlådor mellan klientorganisationen utan att behöva offboard och sedan registrera postlådor. 
- **Domändelning mellan klientorganisationen:** Snart kan du ansluta till en privat förhandsgranskning för funktioner som gör att du kan dela en domän mellan flera klientorganisationar. Om Contoso exempelvis köper Wingtip Toys kan Contoso dela domänen med Wingtip Toys så att personer i båda innehavarna kan använda "contoso.com" som sina e-postadresser.

![Sidan Tjänstens hälsa för flera innehavare där en incident har markerats och fliken Klientorganisation som påverkas öppnas. Navigeringsmenyn har Alla innehavare, Installation och Tjänstens hälsa som de enda alternativen.](../media/MAC-WN-MTinServiceHealth.png)
...
### <a name="search-faster-and-get-better-results-from-any-page"></a>Sök snabbare och få bättre resultat från valfri sida

Vi har börjat lansera en ny sökupplevelse för administrationscentret och vi kan inte vänta på att du provar den. ![Sökrutan har flyttats till banderollområdet. Alt+S om du vill söka på valfri sida.](../media/MAC-WN-GlobalSearch.png)
...
Små och medelstora företag kan  få en rekommendation på startsidan om några av personerna i organisationen inte aktivt använder Teams, OneDrive eller Office-appar. När du ser rekommendationen kan du snabbt skicka microsoft-utbildning till inaktiva användare via e-post för att hjälpa dem att komma igång med appen och se till att du får ut det fulla värdet från dina prenumerationer.

### <a name="remote-work-collection"></a>Fjärransluten arbetssamling

I oktober lägger vi till en samling för distansarbete som hjälper ägare av småföretag och deras personal att komma online och arbeta på distans.  **Konfiguration av distansarbete är** en lista över alla funktioner som Microsoft rekommenderar för att säkert möjliggöra distansarbete och effektivt samarbete. Om några veckor kan du prova det i **Fjärrinstallation, work**  >  **essentials**.

![Sidan Distansarbete i installationsprogrammet med 7 uppgifter som inte har startats.](../media/MAC-WN-RemoteWork.png)

Mer information om hur du på ett säkert sätt tillåter distansarbete och en praktisk webbadress som är lätt att komma ihåg och dela finns [i aka.ms/remote-business](https://aka.ms/remote-business).

### <a name="need-help-moving-to-more-admin-centers"></a>Behöver du hjälp? flytta till fler administrationscenter
...
Mer information finns i den här artikeln och videon om du vill se hur det fungerar: [Spåra inlägg i meddelandecentret i Planner](/Office365/Planner/track-message-center-tasks-planner)
...
### <a name="getting-ready-for-ignite-2020"></a>För förbereda Ignite 2020

Under säsong på Microsoft släpper vi inte lika många funktioner så att vi har mycket att prata om under våra sessioner.

Nästa uppdatering i den här artikeln är invigningsdagen för vår första Ignite som endast är tillgänglig online. Och i år är det kostnadsfritt att delta! Kolla in det, skaffa ett konto: [Microsoft Ignite 2020](https://www.microsoft.com/ignite).

### <a name="your-products"></a>Dina produkter

Det har gjorts mycket arbete i hantering av prenumerationer för att göra sidan snabbare att läsa in, snabbare hitta det du letar efter och för att uppfylla webbtillgänglighetsstandarder[(WCAG 2.1 riktlinjer).](http://www.w3.org/TR/WCAG21/)

- **Tabellens design:** Tabellen har omarbetats så att du kan gruppera liknande prenumerationer. Gå till **Fakturering**  >  **Dina produkter.**
...
### <a name="export-groups-list"></a>Exportera grupplista

Många administratörer har hört att de behöver dela information om grupper och deras användning med personer som inte har tillgång till administrationscentret. Nu kan du exportera listan Grupper till en CSV-fil i granskningssyfte, vilket innebär att du kan kasta ut det gamla PowerShell-skriptet. Prova genom att gå till **Grupper**  >  **grupper** och sedan välja **Exportera grupper** i kommandofältet.
...
### <a name="sync-message-center-posts-to-planner"></a>Synkronisera meddelandecenter-inlägg i Planner

Från och med maj kommer administratörer i riktad version att se knappen "Planner-synkronisering" i meddelandecentret. Nu kan du spåra meddelanden som behöver en åtgärd, välja vilken typ av meddelanden du vill spåra, tilldela meddelanden att spåra som uppgifter och tagga meddelanden för senare uppmärksamhet.
...
Produktivitetsresultatet ger insikter om hur användare använder Microsofts molntjänster och de teknikupplevelser som stöder dem. Poängen återspeglar organisationens resultat med mått på personal- och teknikupplevelse och jämför din poäng med organisationer som din. Den här månaden introducerar vi följande nya begrepp till förhandsversionen:

- Trendvyn med primära insikter på startsidan och kategoriinformationssidorna – Slutpunktsanalys och nätverksanslutningar som lagts till i teknikupplevelsen
- Relevant teknikupplevelseinsikt som visas i kategorierna Medarbetarupplevelse
...
### <a name="featured-feedback-fix-improve-add-user-reliability-for-licensing"></a>Aktuell feedbackkorrigering: Förbättra "lägga till användartillförlitlighet" för licensiering

Vi har fått mycket feedback från administratörer om hur svårt det är att tilldela licenser när användare läggs till. Vi har gjort den första uppdateringen av den här korrigeringen och vi har migrerat till en mer tillförlitlig tjänst bakom kulisserna för att bearbeta dessa begäranden. Och om något går fel får du nu ett felmeddelande där du kan försöka igen.
...
### <a name="featured-feedback-fix-multi-organization-switcher"></a>Aktuell feedbackkorrigering: Omkopplare för flera organisationer

Vi har fått mycket feedback från partner och administratörer om utmaningarna med att hantera flera Microsoft-molntjänster. En av våra första funktioner för hantering av flera organisationer är Organisationsväxling, som gör att du kan växla mellan de organisationer som du hanterar med två musklick.
> [!TIP]
...
![Skärmdump: Omkopplaren för mina organisationer med Consolidated Messenger-klientorganisation markerad](../media/MAC-OrgSwitcherSelected.png)
