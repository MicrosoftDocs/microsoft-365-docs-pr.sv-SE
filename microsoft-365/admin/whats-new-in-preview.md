...
### <a name="multi-tenant-management"></a>Hantering av flera klientorganisationer
...
![Sidan Tjänstens hälsa för flera innehavare med ett markerat incident och den klientorganisationens påverkade flik öppen. Navigeringsmenyn har alla klientorganisationens, installationsprogrammets och tjänstens hälsa som de enda alternativen.](../media/MAC-WN-MTinServiceHealth.png)
...
Vi har börjat lansera en ny sökupplevelse för administrationscentret och vi kan inte vänta på att du provar det. ![Sökrutan har flyttats till banderollområdet. Alt+S för att söka på valfri sida.](../media/MAC-WN-GlobalSearch.png)
...
### <a name="remote-work-collection"></a>Samling på distans
...
### <a name="getting-ready-for-ignite-2020"></a>Redo för Ignite 2020
...
### <a name="docs-training-and-videos-july-2020"></a>Dokument, utbildning och videoklipp (juli 2020)
...
### <a name="keeping-up-with-office-whats-new-management"></a>Håll dig ajour med den nya hanteringen i Office
...
### <a name="sync-message-center-posts-to-planner"></a>Synkronisera inlägg i Meddelandecenter i Planner
...
### <a name="need-help-launched-in-teams-admin-center--security-and-compliance-centers"></a>"Behöver du hjälp?" lanseras i administrationscentret för Teams & säkerhets- och efterlevnadscenter
...
#### <a name="need-chat"></a>Behöver du chatt?
...
### <a name="improvements-to-the-add-a-group-wizard"></a>Förbättringar i guiden Lägg till en grupp
...
### <a name="featured-feedback-fix-multi-organization-switcher"></a>Aktuell feedbackkorrigering: Byta till flera organisationer
...
![Skärmdump: högst upp på startsidan som visar organisationens profilnamn med växlingsikonen.](../media/MAC-Organization-switcher.png)

2. I organisationsväxeln väljer du den organisation du vill hantera.
![Skärmdump: Omkopplaren för mina organisationer med Consolidated Messenger-klientorganisationen markerad](../media/MAC-OrgSwitcherSelected.png)
...
> [!NOTE]
> Visste du att det finns en nyhet [i Microsoft 365-videoserien](https://go.microsoft.com/fwlink/p/?linkid=2118096) på YouTube? Där framhävs de senaste funktionerna som vi distribuerat till användarna. Varje månad länkar vi till det senaste avsnittet i avsnittet [Videor, utbildning och dokument.](#videos-training-and-docs) <br> <br> Här är det senaste avsnittet: [Nyheter i Microsoft 365](https://go.microsoft.com/fwlink/p/?linkid=2118096)
...
### <a name="office-whats-new-management"></a>Ny hantering för Office
