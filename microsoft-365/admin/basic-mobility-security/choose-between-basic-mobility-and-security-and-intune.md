...
|Enhetskonfiguration  |Konfigurera enhets inställningar (till exempel att inaktivera kameran)|Begränsad uppsättning inställningar.|Ja|Kompatibilitet med enheter|Ange och hantera säkerhets principer, som PIN-lås och jailbreak identifiering på enhets nivå. |Begränsningar för Android 9 och senare enheter. Visa [information](capabilities.md). |Ja|
