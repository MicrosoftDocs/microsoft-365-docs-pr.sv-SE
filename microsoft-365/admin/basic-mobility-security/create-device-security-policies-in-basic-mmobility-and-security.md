...
- Läs mer om enheter, mobila enheter och säkerhets inställningar som grundläggande mobilitet och säkerhet kan hantera. Se [möjligheter till grundläggande mobilitet och säkerhet](capabilities-of-basic-mobility-and-secruity.md).
...
Innan du kan börja bör du kontrol lera att du har aktiverat och konfigurerat grundläggande mobilitet och säkerhet. Anvisningar finns i [Översikt över grundläggande mobilitet och säkerhet](overview-of-basic-mobility-and-security-for-microsoft-365.md).
...
[Översikt över grundläggande mobilitet och säkerhet](overview-of-basic-mobility-and-security-for-microsoft-365.md)

[Möjligheter till grundläggande mobilitet och säkerhet](capabilities-of-basic-mobility-and-secruity.md)
