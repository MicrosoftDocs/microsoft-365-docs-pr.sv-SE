...
Om du skapar en princip för att blockera åtkomst med vissa inställningar aktiverade hindras användarna från att få åtkomst till Microsoft 365-resurser när ett program som stöds visas i [åtkomst kontroll för Microsoft 365 e-post och dokument](https://support.microsoft.com/office/capabilities-of-basic-mobility-and-security-a1da44e5-7475-4992-be91-9ccec25905b0?ui=en-us&rs=en-us&ad=us#bkmk_accesscontrol). 
...
[Översikt över grundläggande mobilitet och säkerhet för Microsoft 365](overview-of-basic-mobility-and-security-for-microsoft-365.md)
