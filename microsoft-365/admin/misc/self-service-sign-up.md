...
|**Microsoft-flöde** <br/> |Microsoft Flow är en produkt som hjälper dig att konfigurera automatiska arbetsflöden mellan dina favoritappar och tjänster för att synkronisera filer, få aviseringar, samla in data med mera.  <br/> |[Registrera dig och logga in för Microsoft Flow](https://go.microsoft.com/fwlink/p/?linkid=841468) <br/> |[Microsoft-flöde](https://go.microsoft.com/fwlink/p/?linkid=841465) <br/> |
