...
5. Välj **Spara ändringar**.
    ...
    Om du vill se hur kontaktkortet ser ut loggar du ut och in igen. Du bör testa länkarna på kortet så fort du loggar in igen. Användarna kan se kortet nästa gång de loggar in.
