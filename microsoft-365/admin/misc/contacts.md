...
1. Gå till sidan Användare kontakter **i** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2053302" target="_blank">administrationscentret.</a>
...
Mina kontakter är kontakter som du skapar åt dig själv och som dina användare skapar åt sig själva, men som andra inte kan se. Kontakter som du skapar i administrationscentret är kontakter för organisationen som alla kan se jämte sina egna kontakter. Mer information finns i [Kontaktöversikt – Outlook Web App.](https://support.microsoft.com/office/5fe173cf-e620-4f62-9bf6-da5041f651bf)
...
## <a name="how-does-everyone-get-to-the-contacts-i-created-in-the-admin-center"></a>Hur kommer andra åt de kontakter som jag skapat i administrationscentret?
 ...
 De kan gå till **Kontakter** i Microsoft 365, visa **Katalog** och välja **Alla kontakter.** Där kan de visa varje kontakt och information om kontakten.
...
Ta en titt i resten av vår [administratörshjälp](https://docs.microsoft.com/microsoft-365/admin/) eller lämna feedback till oss nedan.