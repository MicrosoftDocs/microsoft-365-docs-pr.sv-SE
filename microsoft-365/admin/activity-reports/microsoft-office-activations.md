...
2. I list rutan **Välj en rapport** väljer du **Office 365** - \> **aktiveringar**. 
...
|Objekt|Beskrivning|
|:-----|:-----|
|9.1  <br/> |Rapporten Office-aktiveringar visar aktuell status för data om Office-licensaktiveringar [från rapportdatumet som visas längst upp till höger i diagrammet].  <br/> |
|två  <br/> |Informationen i varje rapport täcker vanligt vis upp till de senaste 24 till 48 timmar.  <br/> |
|amp;3D  <br/> |Diagrammet **Aktiveringar** visar antalet Office-aktiveringar på datorer och andra enheter.  <br/> |
