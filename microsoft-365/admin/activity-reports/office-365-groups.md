...
2. Välj aktivitet för **Välj** en rapport i listrutan **Välj en rapport** \> **Groups activity**.
...
|10,  <br/> |Markera eller tryck på Knappen **Fler åtgärder** ![ Mobil OWA Fler åtgärder ](../../media/80044eef-2368-4c7e-8d31-7155b029e0cf.png) bredvid en kolumnrubrik för att lägga till eller ta bort kolumner från rapporten.  <br/> ![Grupprapport - välj kolumner](../../media/d7fb95d6-2a2e-4144-b80d-581223e48043.png)|
