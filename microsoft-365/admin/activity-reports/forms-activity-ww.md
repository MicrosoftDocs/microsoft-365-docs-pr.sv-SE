...
2. På startsidan för instrumentpanelen klickar du på **knappen Visa** mer på kortet Formulär.
...
|Antal formulär som skapats  <br/> |Antalet formulär som användaren har skapat.   <br/> |
|Antal formulär som svarat  <br/> |Antalet formulär som användaren har skickat svar till.|
|||
