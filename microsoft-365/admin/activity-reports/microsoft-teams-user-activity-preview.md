...
Du kan visa användaraktiviteten i rapporten Teams genom att välja **fliken Användaraktivitet.** <br/>![Microsoft 365 – Microsoft Teams användaraktivitet.](../../media/1011877f-3cf0-4417-9447-91d0b2312aab.png)
...
|Annan aktivitet  <br/>|Användaren är aktiv, men har utfört andra aktiviteter än de åtgärdstyper som exponeras som erbjuds i rapporten (skicka eller svara på kanalmeddelanden och chattmeddelanden, schemalägga eller delta i 1:1-samtal och -möten). Exempelåtgärder är när en användare ändrar status Teams eller statusmeddelandet Teams öppnar ett kanalmeddelandeinlägg men inte svarar.  <br/>|
