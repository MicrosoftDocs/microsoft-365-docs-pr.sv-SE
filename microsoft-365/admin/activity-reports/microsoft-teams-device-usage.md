...
2. I **listrutan Välj en** rapport väljer du **Enhetsanvändning för Microsoft Teams** \> .
...
|6.  <br/> |Du kan filtrera serierna du ser i diagrammet genom att välja ett objekt i förklaringen. I diagrammet Användare väljer du **till** exempel **Windows,** **Mac,** **Samtal,** **Webb,** **Android-telefon** eller **Windows-telefon** om du bara vill se den relaterade informationen. När du ändrar det här valet ändras inte informationen i rutnätstabellen.  <br/> ![Du kan filtrera appanvändningsdiagrammen för Microsoft Teams genom att välja apptyp.](../../media/64ee1cb1-ca80-4964-8234-7fc671135c3d.png)|
