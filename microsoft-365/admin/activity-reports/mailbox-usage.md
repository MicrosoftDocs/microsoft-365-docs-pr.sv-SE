...
---
# <a name="microsoft-365-reports-in-the-admin-center---mailbox-usage"></a>Microsoft 365 Rapporter i administrationscentret – Postlådeanvändning

Rapporten **Postlådeanvändning** innehåller information om användare med en användarpostlåda och aktivitetsnivån för dem baserat på aktivitet när du skickar och läser e-post, skapar avtalad tid, skickar möten, accepterar möten, avböjer möten och ställer in möten. Du får även information om hur mycket lagringsutrymme som har förbrukats av varje användarpostlåda och hur många av dem som närmar sig lagringskvotens gräns. 
...
3. I **listrutan** E-postaktivitet väljer du Exchange **Postlådeanvändning.** \> 
...
|Objekt|Beskrivning|
|:-----|:-----|
|1.  <br/> |I rapporten **Postlådeanvändning** kan du se trender under de senaste 7, 30, 90 eller 180 dagarna. Men om du väljer en viss dag i rapporten visar tabellen data för de senaste 28 dagarna (inte från det datum då rapporten skapades).  <br/> |
...
|4.  <br/> |Diagrammet **Lagring** visar hur stort lagringsutrymme som används i din organisation. Storage Diagram innehåller inte arkivpostlådor. Mer information om automatiskt expanderande arkivering finns i [Översikt över obegränsat arkivering i Microsoft 365](../../compliance/unlimited-archiving.md).<br/> |
...
|10.  <br/> |Du kan också exportera rapportdata till en Excel .csv fil genom att välja **länken** Exportera.  <br/> |
|||
