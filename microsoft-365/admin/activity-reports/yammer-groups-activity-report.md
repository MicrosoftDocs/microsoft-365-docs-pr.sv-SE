...
|6.  <br/> |Du kan filtrera serien som visas i diagrammet genom att markera ett objekt i förklaringen. I gruppdiagrammet **Groups** väljer du till exempel **Totalt** eller **Aktivt**totalt och Aktiva ikoner om du bara vill visa information som ![ är ](../../media/8eebd496-5955-4419-8d53-5f3ba1ad1c88.png) relaterad till var och en.   När du ändrar det här valet ändras inte informationen i rutnätstabellen.  <br/> |
