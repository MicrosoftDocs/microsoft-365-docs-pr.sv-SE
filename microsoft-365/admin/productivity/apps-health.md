---
title: Microsoft Productivity Score – Microsoft 365 appens hälsa
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
- MET150
- MOE150
description: Information om Microsoft 365 apps hälsa – teknikupplevelser Produktivitetsresultat.
...
## <a name="why-your-organization39s-microsoft-365-apps-health-score-matters"></a>Varför det är viktigt&#39;organisationen Microsoft 365 dina appars hälsoresultat

Organisationens produktivitet är beroende av felfria programmiljöer. Enheter som kör de flesta aktuella Microsoft 365-appar på den rekommenderade kanalen är säkrare och hjälper personer i din organisation att få ut mesta av funktionerna i Microsoft 365.

## <a name="how-we-calculate-the-microsoft-365-apps-health-score"></a>Så här beräknar vi Microsoft 365 för appar

Vi beräknar ditt Microsoft 365 för appar genom att mäta antalet enheter på varje uppdateringskanal. Vi avgör även om enheterna kör en version som stöds och den senaste versionen av Microsoft 365 program.
...
:::image type="content" source="../../media/appshealth-primary.png" alt-text="Primär visualisering av syn, för Microsoft 365 appar.":::

Information som beaktas för detta Microsoft 365 kanal för appar, version och version som körs på enheten.
...
Hälsoresultatet Microsoft 365 appar mäter om enheter körs med Microsoft 365 på den rekommenderade kanalen och i de senaste versionerna.

## <a name="explore-your-organization-microsoft-365-app-channels-and-versions"></a>Utforska din organisation Microsoft 365 appkanaler och versioner
...
1. **Sidhuvud:** Höjdpunkter procentandelen enheter på den aktuella kanalen kör versioner av Microsoft 365-appar  
1. **Brödtext:**  Innehåller information om värdet på enheter som kör Microsoft 365 appar på den rekommenderade kanalen.
1. **Visualisering:**  Fördelningen i visualiseringen visar i vilken grad procentandelen enheter på senaste och kompatibla versioner av Microsoft 365 över olika kanaler), enligt följande:
...
1. **Sidhuvud:** Höjdpunkter procentandel av enheter som kör versioner som stöds och enheter som kör de senaste versionerna.  
...
1. **Visualisering:** Fördelningen i visualiseringen är avsedd att representera hur många enheter som kör versioner som stöds och de senaste versionerna av Microsoft 365 appar):
    - **Versioner som stöds:** Den blå (färgade) delen av stapeln och bråket (täljare/nämnare) i fältet representerar procentandelen enheter som kör en version av Microsoft 365 program.
        - Täljare: Antalet enheter i versioner av appar som Microsoft 365 stöds under de senaste 28 dagarna
        - Nämnare: Antalet enheter som använder Microsoft 365 senaste 28 dagarna
    - **Senaste versionerna:** Den färgade delen av stapeln och bråktalet (täljare/nämnare) i fältet representerar procentandelen enheter som kör de senaste versionerna av Microsoft 365 program.
        - Täljare: Antalet enheter i de senaste Microsoft 365 apparna under de senaste 28 dagarna
        - Nämnare: Antalet enheter som använder Microsoft 365 senaste 28 dagarna
1. **Läs mer:**   Välj den här länken om du vill visa hjälpinnehåll.

#### <a name="trend-visualization-of-the-devices"></a>Trendvisualisering av enheter

Det här diagrammet visar trendlinjen på de enheter som har versioner som stöds och de senaste Microsoft 365 senaste 180 dagarna.
...
I det här avsnittet får du hjälp att agera på de mätvärden du vill fokusera på genom att ange relevant information för alla mätvärden för Microsoft 365 hälsa – teknikupplevelser.

Följande kolumner visas i tabellen på kanal-/versionsnivå:

- **Kanal** : Microsoft 365 appkanal på enheterna.
- **Status:**   Microsoft 365 appar har stöd för enheternas status baserat på aktuell kanal och version.
- **Versioner:**   Aktuella Microsoft 365 versioner av appar på enheterna.
