...
### <a name="areas-of-scoring"></a>Områden av poängsättning 
...
### <a name="scoring-user-actions"></a>Bedömning av användaråtgärder 
...
### <a name="products-included-in-the-productivity-score"></a>Produkter som ingår i produktivitetspoängen 
...
### <a name="learn-how-your-organization-works"></a>Läs om hur din organisation fungerar 
...
### <a name="insights-to-identify-opportunities-to-improve-experiences"></a>Insikter för att identifiera möjligheter att förbättra upplevelser 
...
### <a name="area-detail-page--collaborating-on-content"></a>Sidan Områdesinformation – Samarbeta om innehåll 
...
### <a name="area-detail-page--working-anywhere"></a>Sidan Områdesinformation – Arbeta var som helst 
...
### <a name="actions-for-update-skills-and-systems"></a>Åtgärder för att uppdatera färdigheter och system 
