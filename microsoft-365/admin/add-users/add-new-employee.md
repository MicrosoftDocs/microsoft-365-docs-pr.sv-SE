...
Den här artikeln hjälper dig att gå ombord på en ny anställd till Office 365 för företag. Vi förutsätter att du är administratör och att du redan har [konfigurerat Office 365](../setup/setup.md)och nu har du någon ny ansluter till företaget.
  
Du är på rätt plats om den nya medarbetaren behöver Office 365 och använder ett [Office 365-abonnemang](https://products.office.com/business/compare-office-365-for-business-plans) som gör att du kan installera Office-program som Word och Excel på en dator. 
  
 **Är du inte administratör?** [Lär dig igenom Office 365](https://support.office.com/article/office-basics-video-training-396b8d9e-e118-42d0-8a0d-87d1f2f055fb) hjälper företags- och hemanvändare med Office 365 konfigurerat. 
...
|**Steg**|**Varför göra så här?**|
|:-----|:-----|
|[Steg 1: Skapa ett Office 365-konto för medarbetaren](#step-1-create-an-office-365-account-for-the-employee) <br/> |Varje gång en ny medarbetare ansluter till ditt företag skapar du ett konto åt dem så att de kan börja använda Office 365.  <br/> |
|[Steg 2: Ge den anställde deras användar-ID och lösenord](#step-2-give-the-employee-their-user-id-and-password) <br/> |När du skapar ett konto får du ett ID och lösenord som du kan skicka till din medarbetare så att de kan logga in.  <br/> |
...
|[Steg 4: Hjälp din medarbetare att komma igång](#step-4-help-your-employee-get-started) <br/> |Meddela den anställde hur du använder OneDrive eller några gruppwebbplatser i organisationen.  <br/> |
   
## <a name="step-1-create-an-office-365-account-for-the-employee"></a>Steg 1: Skapa ett Office 365-konto för medarbetaren


Instruktioner finns [i Lägga till användare individuellt eller i grupp i Office 365 - Hjälp om administratörer](add-users.md). När du konfigurerar den nya medarbetaren kan du välja att skicka inloggningsuppgifter till medarbetarens personliga konto. På så sätt får de ett e-postmeddelande från Microsoft Online Service Team som talar om för dem hur de loggar in på Office 365.
  
## <a name="step-2-give-the-employee-their-user-id-and-password"></a>Steg 2: Ge den anställde deras användar-ID och lösenord


Om du inte har skickat den till deras personliga e-postadress skriver du ut den anställdes Office 365-inloggningsnamn och lösenord och lämnar det till dem. Eller berätta informationen via telefon.
  
Eftersom de ännu inte har tillgång till sitt Office 365-e-postmeddelande ska du inte skicka informationen till den e-postadressen.
...
## <a name="step-4-help-your-employee-get-started"></a>Steg 4: Hjälp din medarbetare att komma igång


Dela med dem [snabbinstallationen för medarbetare för Office 365 för](https://support.office.com/article/employee-quick-setup-b9700090-ce64-4046-ab92-ce8488a7bc0f) att logga in, installera programvara, konfigurera e-post med mera. 
  
Och här är en snabb referens för att hjälpa dem att komma igång:
  
|**Uppgift**|**Hitta information**|
|:-----|:-----|
|Logga in på Office  <br/> |Gå [https://www.office.com](https://www.office.com)till , välj Logga in och ange sedan ditt användar-ID och lösenord för Office 365. **Sign in**  <br/> |
