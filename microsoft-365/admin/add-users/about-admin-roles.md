...
|Läsare i Meddelandecenter |   Tilldela läsarrollen i Meddelandecenter till användare som behöver göra följande: <br> – Övervaka meddelanden i meddelandecentret <br> – Få veckovisa e-postmeddelanden med inlägg och uppdateringar i meddelandecentret <br> – Dela inlägg i Meddelandecenter <br> – Ha skrivskyddad åtkomst till Azure AD-tjänster, till exempel användare och grupper|
|Administratör för Power Platform |   Tilldela Power Platform administratörsrollen till användare som behöver göra följande: <br> – Hantera alla administrativa funktioner för PowerApps, Power Automate och dataförlustskydd <br> – Skapa och hantera tjänsteförfrågningar <br> – Övervaka tjänstens status  |
