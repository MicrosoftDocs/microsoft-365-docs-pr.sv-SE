...
För att administrera Microsoft 365 kan du [](assign-admin-roles.md) tilldela användarbehörigheter för att hantera din organisations e-post och postlådor från Exchange [administrationscenter.](/exchange/exchange-admin-center) Det gör du genom att tilldela dem rollen som administratör i Exchange.
  
 **Tips!** När du tilldelar någon Exchange administratörsroll ska du också tilldela den till tjänstadministratörsrollen. På så sätt kan de se viktig information Microsoft 365 administrationscentret, till exempel hälsotillståndet för Exchange Online, och ändra och släppa meddelanden.
...
- [Om administratörsrollen SharePoint Online](/sharepoint/sharepoint-admin-role)

- [Om administratörsrollen i Skype för företag](/skypeforbusiness/skype-for-business-online)

- [Använda Microsoft Teams administratörsroll](/MicrosoftTeams/using-admin-roles)