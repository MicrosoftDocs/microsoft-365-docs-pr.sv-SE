...
1. Gå till sidan Konfigurationsdomäner i  administrationscentret för Microsoft 365. \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834818" target="_blank"></a>

::: moniker-end

::: moniker range="o365-germany"

1. Gå till sidan Konfigurationsdomäner  > <a href="https://go.microsoft.com/fwlink/p/?linkid=854615" target="_blank">i administrationscentret.</a>

::: moniker-end

::: moniker range="o365-21vianet"

1. Gå till sidan Konfigurationsdomäner  > <a href="https://go.microsoft.com/fwlink/p/?linkid=2007048" target="_blank">i administrationscentret.</a>

::: moniker-end
    
2. Välj din **domän** på sidan Domäner och välj sedan **Starta installationen.** Du går tillbaka till domäninstallationsguiden för att se det specifika värde som du måste lägga till.
    
3. Välj Lägg **till en** **TXT-post i stället på** sidan Verifiera domän och välj sedan **Nästa.**
    
4. Kopiera **TXT-värdet som** visas. Så här ser det ut: **MS=msXXXXXXXX.** 
    
5. Gå till [Skapa DNS-poster](create-dns-records-at-any-dns-hosting-provider.md)hos en DNS-värd och välj din DNS-värd i listan med domänregistratorer om du vill se de stegvisa anvisningarna.
...
4. Gå till [Skapa DNS-poster](create-dns-records-at-any-dns-hosting-provider.md)hos en DNS-värd och välj sedan din DNS-värd i listan med domänregistratorer om du vill ha stegvisa instruktioner för hur du lägger till poster på DNS-värdens webbplats.
