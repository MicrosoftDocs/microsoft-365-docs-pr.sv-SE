...
3. Uppdatera organisationens information och välj sedan **Spara ändringar**. Se till att fylla i alla obligatoriska fält som är markerade med * för att spara ändringarna.
