...
2. Gå till Mottagare **grupper**i **administrationscentret** \> för Exchange .<br/>Du ser ett meddelande om att du har distributionslistor (kallas även **distributionsgrupper** ) som är kvalificerade för uppgradering till Office 365-grupper.<br/> ![Välj knappen Kom igång](../../media/8cf838b4-2644-401f-a366-08c1eea183eb.png)
...
> [!NOTE]
> Du kan också uppgradera en enda distributionslista till en Office 365-grupp med hjälp av PowerShell-cmdleten [New-UnifiedGroup](https://go.microsoft.com/fwlink/?LinkID=786379)
