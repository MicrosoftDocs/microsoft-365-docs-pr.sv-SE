...
description: Snabblänkar för de vanligaste administratörsuppgifterna i Microsoft 365.
ms.openlocfilehash: 102466b142d35125ab85d31cdf313ea6e9d9ba7e
ms.sourcegitcommit: 60c1932dcca249355ef7134df0ceb0e57757dc81
ms.translationtype: MT
ms.contentlocale: sv-SE
ms.lasthandoff: 04/29/2020
ms.locfileid: "43942193"
---
# <a name="manage"></a>Hantera

Snabblänkar för de vanligaste administratörsuppgifterna i Microsoft 365.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Jag har glömt mitt användarnamn eller lösenord</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ta bort en tidigare anställd</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Hitta och åtgärda domän- eller DNS-problem</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>Microsoft Teams</h3>
                            ...
                            <p><a href="https://support.office.com/article/8a0d4da8-9d58-44f9-9759-5c8f340cb3fb">Installera Skype för företag på en dator</a></p>
                            <p><a href="https://docs.microsoft.com/SkypeForBusiness/set-up-skype-for-business-online/troubleshoot-problems-with-skype-for-business-online">Felsöka problem</a></p>
                            <p><b>Fler uppgifter:</b> <a href="https://docs.microsoft.com/SkypeForBusiness/skype-for-business-online">Administration av Skype för företag – Online</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>E-post</h3>
                            ...
                            <p><b>Fler uppgifter:</b> <a href="../email/email.md">E-post i Microsoft 365 för företag</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>OneDrive</h3>
                            <p><a href="https://go.microsoft.com/fwlink/p/?LinkId=798319">Hämta Synkroniseringsklienten för OneDrive- och mobilappar</a></p>
                            <p><a href="https://support.office.com/article/615391c4-2bd3-4aae-a42a-858262e42a49">Synkronisera filer med OneDrive-synkroniseringsklienten i Windows</a></p>
                            ...
                            <p><b>Fler uppgifter:</b> <a href="https://docs.microsoft.com/onedrive/onedrive">OneDrive i Microsoft 365</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>SharePoint</h3>
                            ...
                            <p><a href="https://docs.microsoft.com/sharepoint/manage-site-creation">Hantera skapande av webbplatser</a></p>
                            <p><a href="https://docs.microsoft.com/sharepoint/overview-of-search">Anpassa sökupplevelsen</a></p>
                            <p><b>Fler uppgifter:</b> <a href="https://docs.microsoft.com/sharepoint/sharepoint-online">SharePoint Online</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Yammer</h3>
                            <p><a href="https://docs.microsoft.com/yammer/manage-yammer-users/office-365-sign-in">Microsoft 365-inloggning för Yammer</a></p>
                            <p><a href="https://docs.microsoft.com/yammer/manage-yammer-users/manage-users-across-their-lifecycle">Hantera Yammer-användare från Microsoft 365</a></p>
                            <p><a href="https://docs.microsoft.com/yammer/configure-your-yammer-network/enforce-office-365-identity">Framtvinga Microsoft 365-identitet för Yammer-användare</a></p>
                            <p><a href="https://docs.microsoft.com/yammer/integrate-yammer-with-other-apps/embed-a-feed-into-a-sharepoint-site">Bädda in en Yammer-feed på en SharePoint-webbplats</a></p>
                            <p><b>Fler uppgifter:</b> <a href="https://docs.microsoft.com/yammer/yammer-landing-page">Hjälp om Yammer-administratörer</a></p>
                    </div>
                </div>
            </div>
        </div>
