...
4. I avsnittet <b>Fästa personer kan</b> du fästa en person om du vill visa personen som ämnesexpert i ämnet. Börja med att skriva in <b></b> användarens namn eller e-postadress i rutan Lägg till en ny användare och välj sedan den användare du vill lägga till i sökresultatet. Du kan även "ta bort" dem genom att välja ikonen Ta bort <b>från listan</b> på användarkortet.
    ...
    I <b>avsnittet Föreslagna personer</b> visas användare som AI tror kan vara ämnesexperter på ämnet, från deras anslutning till resurser om ämnet. Du kan ändra deras status från Föreslagen till Fäst genom att välja fästikonen på användarkortet.
...
10. Välj **Publicera** eller **publicera om för** att spara ändringarna. **Publicera om** är det tillgängliga alternativet om ämnet har publicerats tidigare.
