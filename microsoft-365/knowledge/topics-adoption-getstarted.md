...
4. [Skapa ett mästarenätverk:](#build-a-champion-network)
    - Det kanske redan finns grupper av övning eller mästare på nätverk. Det här är bra sätt att umgås och sprida och hjälpa kollegor att hjälpa varandra. Och de kan dela framgångar som kan vara mycket värdefulla. De kan ge råd och skapa intresse.
...
- En anställd (Jordan) har en ny roll eller har nyligen anställts och har bara börjat med en roll. Jordan vill vara inblandat och produktivt så snabbt som möjligt. Men Jordan behöver också hjälp med att hitta en startpunkt.
...
|:-------|:-------|:--------|
| Huvudsponsor   | Kommunicera visioner och värden på hög nivå till företaget   |  Ledning   |
...
| Administratör för Power Platform| Konfigurera en vanlig miljö för datatjänster | IT-avdelning |
...
Nu när du är redo att distribuera bör du uppmuntra kontinuerligt engagemang.
