...
Hämtar eller uppdaterar information om en modell för dokumenttolkning i SharePoint Syntex (se [exempel](rest-getbyuniqueid-method.md#examples)).
...
|-----|---|--------|----|-----------|
|modelUniqueId|fråga|Sant|sträng|ID för Syntex-modellfilen.|
...
### <a name="get-the-contoso-contract-model-by-id"></a>Hämta Contoso Contract-modellen efter ID
...
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a>Hämta och ta bort Contoso Contract-modellen efter ID
