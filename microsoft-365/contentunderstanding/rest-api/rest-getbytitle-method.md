...
Hämtar eller uppdaterar information om en dokumenttolkningsmodell för SharePoint Syntex med användning av modellrubriken (se [exempel](rest-getbytitle-method.md#examples)).
...
För GET behövs ingen frågebrödtext.
...
### <a name="get-information-about-the-contoso-contract-model"></a>Få information om Contoso Contract-modell

I det här exemplet är namnet på tolkningsmodellen för Syntex-dokumentet `Contoso Contract`.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>Hämta och ta bort Contoso Contract-modellen med namn

I det här exemplet är namnet på tolkningsmodellen för Contoso Contract-dokumentet `Contoso Contract`.
