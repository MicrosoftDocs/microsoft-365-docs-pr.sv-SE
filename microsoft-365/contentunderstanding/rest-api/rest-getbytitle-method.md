...
---
# <a name="getbytitle"></a><span data-ttu-id="e73c3-103">GetBy rubrik</span><span class="sxs-lookup"><span data-stu-id="e73c3-103">GetByTitle</span></span>

<span data-ttu-id="e73c3-104">Hämtar eller uppdaterar information om en dokumenttolkningsmodell för SharePoint Syntex med användning av modellrubriken (se [exempel](rest-getbytitle-method.md#examples)).</span><span class="sxs-lookup"><span data-stu-id="e73c3-104">Gets or updates information about a SharePoint Syntex document understanding model using the model title (see [example](rest-getbytitle-method.md#examples)).</span></span>

## <a name="http-request"></a><span data-ttu-id="e73c3-105">HTTP-begäran</span><span class="sxs-lookup"><span data-stu-id="e73c3-105">HTTP request</span></span>

```HTTP
GET /_api/machinelearning/models/getbytitle('{modelFileName') HTTP/1.1
```

<span data-ttu-id="e73c3-106">Samma metod kan även användas för att ta bort en modell.</span><span class="sxs-lookup"><span data-stu-id="e73c3-106">This same method can be used for deleting a model, too.</span></span>

```HTTP
DELETE /_api/machinelearning/models/getbytitle('{modelFileName') HTTP/1.1
```

## <a name="uri-parameters"></a><span data-ttu-id="e73c3-107">URI-parametrar</span><span class="sxs-lookup"><span data-stu-id="e73c3-107">URI parameters</span></span>

|<span data-ttu-id="e73c3-108">Namn</span><span class="sxs-lookup"><span data-stu-id="e73c3-108">Name</span></span> |<span data-ttu-id="e73c3-109">In</span><span class="sxs-lookup"><span data-stu-id="e73c3-109">In</span></span> |<span data-ttu-id="e73c3-110">Obligatoriskt</span><span class="sxs-lookup"><span data-stu-id="e73c3-110">Required</span></span>|<span data-ttu-id="e73c3-111">Typ</span><span class="sxs-lookup"><span data-stu-id="e73c3-111">Type</span></span>|<span data-ttu-id="e73c3-112">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="e73c3-112">Description</span></span>|
|-----|---|--------|----|-----------|
|<span data-ttu-id="e73c3-113">modelFileName</span><span class="sxs-lookup"><span data-stu-id="e73c3-113">modelFileName</span></span>|<span data-ttu-id="e73c3-114">fråga</span><span class="sxs-lookup"><span data-stu-id="e73c3-114">query</span></span>|<span data-ttu-id="e73c3-115">Sant</span><span class="sxs-lookup"><span data-stu-id="e73c3-115">True</span></span>|<span data-ttu-id="e73c3-116">sträng</span><span class="sxs-lookup"><span data-stu-id="e73c3-116">string</span></span>|<span data-ttu-id="e73c3-117">Namnet på Syntex-modellfilen.</span><span class="sxs-lookup"><span data-stu-id="e73c3-117">Name of the Syntex model file.</span></span>|

## <a name="request-headers"></a><span data-ttu-id="e73c3-118">Frågerubrik</span><span class="sxs-lookup"><span data-stu-id="e73c3-118">Request headers</span></span>

| <span data-ttu-id="e73c3-119">Rubrikfält</span><span class="sxs-lookup"><span data-stu-id="e73c3-119">Header</span></span> | <span data-ttu-id="e73c3-120">Värde</span><span class="sxs-lookup"><span data-stu-id="e73c3-120">Value</span></span> |
|--------|-------|
|<span data-ttu-id="e73c3-121">Acceptera</span><span class="sxs-lookup"><span data-stu-id="e73c3-121">Accept</span></span>|<span data-ttu-id="e73c3-122">application/json;odata=verbose</span><span class="sxs-lookup"><span data-stu-id="e73c3-122">application/json;odata=verbose</span></span>|

## <a name="request-body"></a><span data-ttu-id="e73c3-123">Frågebrödtext</span><span class="sxs-lookup"><span data-stu-id="e73c3-123">Request body</span></span>

<span data-ttu-id="e73c3-124">För GET behövs ingen frågebrödtext.</span><span class="sxs-lookup"><span data-stu-id="e73c3-124">For GET, no request body is needed.</span></span>

## <a name="responses"></a><span data-ttu-id="e73c3-125">Svar</span><span class="sxs-lookup"><span data-stu-id="e73c3-125">Responses</span></span>

| <span data-ttu-id="e73c3-126">Namn</span><span class="sxs-lookup"><span data-stu-id="e73c3-126">Name</span></span>   | <span data-ttu-id="e73c3-127">Typ</span><span class="sxs-lookup"><span data-stu-id="e73c3-127">Type</span></span>  | <span data-ttu-id="e73c3-128">Beskrivning</span><span class="sxs-lookup"><span data-stu-id="e73c3-128">Description</span></span>|
|--------|-------|------------|
|<span data-ttu-id="e73c3-129">200 OK</span><span class="sxs-lookup"><span data-stu-id="e73c3-129">200 OK</span></span>| |<span data-ttu-id="e73c3-130">Klart</span><span class="sxs-lookup"><span data-stu-id="e73c3-130">Success</span></span>|

## <a name="examples"></a><span data-ttu-id="e73c3-131">Exempel</span><span class="sxs-lookup"><span data-stu-id="e73c3-131">Examples</span></span>

### <a name="get-information-about-the-contoso-contract-model"></a><span data-ttu-id="e73c3-132">Få information om Contoso Contract-modell</span><span class="sxs-lookup"><span data-stu-id="e73c3-132">Get information about the Contoso Contract model</span></span>

<span data-ttu-id="e73c3-133">I det här exemplet är namnet på tolkningsmodellen för Syntex-dokumentet `Contoso Contract`.</span><span class="sxs-lookup"><span data-stu-id="e73c3-133">In this sample, the name of the Syntex document understanding model is `Contoso Contract`.</span></span>

#### <a name="sample-request"></a><span data-ttu-id="e73c3-134">Exempelbegäran</span><span class="sxs-lookup"><span data-stu-id="e73c3-134">Sample request</span></span>

```HTTP
GET /_api/machinelearning/models/getbytitle('{Contoso Contract') HTTP/1.1
```

#### <a name="sample-response"></a><span data-ttu-id="e73c3-135">Exempelsvar</span><span class="sxs-lookup"><span data-stu-id="e73c3-135">Sample response</span></span>

<span data-ttu-id="e73c3-136">**Statuskod:** 204</span><span class="sxs-lookup"><span data-stu-id="e73c3-136">**Status code:** 204</span></span>
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a><span data-ttu-id="e73c3-137">Hämta och ta bort Contoso Contract-modellen med namn</span><span class="sxs-lookup"><span data-stu-id="e73c3-137">Get and delete the Contoso Contract model by name</span></span>

<span data-ttu-id="e73c3-138">I det här exemplet är namnet på tolkningsmodellen för Contoso Contract-dokumentet `Contoso Contract`.</span><span class="sxs-lookup"><span data-stu-id="e73c3-138">In this sample, the name of the Contoso Contract document understanding model is `Contoso Contract`.</span></span>

##### <a name="sample-request"></a><span data-ttu-id="e73c3-139">Exempelbegäran</span><span class="sxs-lookup"><span data-stu-id="e73c3-139">Sample request</span></span>

```HTTP
DELETE /_api/machinelearning/models/getbytitle('{Contoso Contract') HTTP/1.1
```

## <a name="see-also"></a><span data-ttu-id="e73c3-140">Se även</span><span class="sxs-lookup"><span data-stu-id="e73c3-140">See also</span></span>

[<span data-ttu-id="e73c3-141">REST API för Syntex-dokumentets tolkningsmodell</span><span class="sxs-lookup"><span data-stu-id="e73c3-141">Syntex document understanding model REST API</span></span>](syntex-model-rest-api.md)
