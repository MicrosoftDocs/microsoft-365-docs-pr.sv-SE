...
Hämtar information om en modell och biblioteket där den har tillämpats (se [exempel](rest-getmodelandlibraryinfo.md#examples)).
...
### <a name="get-information-about-the-contracts-model-and-primed-document-library-in-the-repository-site"></a>Få information om kontraktsmodellen och det främsta dokumentbiblioteket på lagringsplatsen
