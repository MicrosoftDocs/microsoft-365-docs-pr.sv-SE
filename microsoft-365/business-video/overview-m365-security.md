...
Windows Defender skydd mot virus, skadlig programvara, spionprogram och andra hot online för dina system-, fil- och onlineaktiviteter.
...
Du kan använda principer för dataförlustskydd (DLP) för att identifiera och hantera känslig information, till exempel personnummer eller kreditkortsnummer, så att den inte delas av misstag. 
