...
Principinställningarna bestämmer vad som sker automatiskt för att skydda en enhet som försvinner eller blir stulen. Vi rekommenderar att du godkänner standardvärdena vid installationen för att skapa programprinciper för Android, iOS och Windows 10 som gäller för alla användare. Du kan skapa fler principer när installationen har slutförts.
