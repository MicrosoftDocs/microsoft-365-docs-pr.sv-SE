...
2. Välj **enheter** i vänster navigeringsfält \> **Hantera**.

3. Markera kryssrutan bredvid den enhet som du vill ta bort data från och **Hantera** listrutan Välj i **Factory reset**på sidan **Hantera** .
