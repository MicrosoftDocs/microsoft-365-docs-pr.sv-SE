...
Du kan använda AutoPilot-profiler för att styra Windows installeras på användarenheter. Profilerna innehåller följande inställningar.
  
 **Standardfunktioner för AutoPilot (obligatoriskt) som konfigureras automatiskt:**
  
|**Inställning**|**Beskrivning**|
|:-----|:-----|
|Hoppa över Cortana OneDrive och OEM-registrering  <br/> |Hoppar över installationen av konsumentappar som Cortana och personliga OneDrive-konton. Enhetens användare kan installera dem senare om användaren är lokal administratör på enheten. Originaltillverkarens registrering hoppas över eftersom enheten hanteras av Microsoft 365 Business Premium.  <br/> |
|Inloggning med företagets varumärke  <br/> |Om ditt företag har en Lägg till företagets varumärke på [Microsoft 365 får](../admin/setup/customize-sign-in-page.md)enhetsanvändaren den upplevelsen när de loggar in.  <br/> |
