...
4. På sidan **Ny prenumeration** väljer du **Small Business** och sedan Microsoft 365 **Business** i listan.
5. Lägg till antalet licenser och välj sedan **Nästa: Granska för** att granska prenumerationen och välj sedan **Skicka**.
    ...
    De **licensbaserade prenumerationerna kommer** att visa **Microsoft 365 Business Preview** och **Microsoft 365 Business.** Nästa gång kommer du att avbryta förhandsversionen av prenumerationen.

6. Välj **Microsoft 365 Business Preview**.
7. På sidan **Microsoft 365 Business Preview väljer** du **Inaktiverad om du** vill avbryta förhandsgranskningsprenumerationen.
...
8. Välj **Skicka för** att bekräfta.
    ...
    På sidan **Prenumerationer** bekräftar du att statusen **för Microsoft 365 för företag** visar **Inaktiverad**.
...
9. Du kan också validera licensavtalet. Gör så här:
    ...
    3. På användarens sida markerar du avsnittet **Tilldela licenser** och bekräftar att det Microsoft 365 **Företag.**
...
| **Tjänsten påverkar**                                                        |
| **Administrationscenter för Microsoft 365** | Ingen påverkan på funktioner | Ingen påverkan på funktioner | Kan lägga till/ta bort användare, köpa prenumerationer.</br> Det går inte att tilldela/återkalla licenser. | Kundens prenumeration och alla data tas bort. Administratören kan hantera andra betalda prenumerationer. |
...
| **Tillåt användare att använda Cortana** | Administratören definierar princip för användaråtkomst till Cortana | Användarenheter för att aktivera/inaktivera Cortana |
