---
title: Vad är skillnaden mellan enhets- och apphantering
f1.keywords:
- NOCSH
ms.author: sirkkuw
author: Sirkkuw
...
Med hantering av mobilapplikationer kan du styra dina affärsdata på användarnas personliga enheter, till exempel iPhone och Android-datorer, och deras personliga Win 10-datorer. Du kan använda programhanteringsprinciper för att förhindra att användarna kopierar affärsdata från Office-appar till sina personliga appar. Du kan också ta bort alla data från Office-apparna på deras personliga enheter. Mer information finns i [Ange inställningar för appskydd för Android- eller iOS-enheter](../app-protection-settings-for-android-and-ios.md) och [Ange inställningar för programskydd för Windows 10-enheter](../protection-settings-for-windows-10-devices.md).
