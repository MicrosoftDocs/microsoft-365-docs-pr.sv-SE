...
---
# <a name="overview-of-setup"></a>Översikt över installationen
...
## <a name="step-2-set-up-security-policies-and-configure-devices"></a>Steg 2: Konfigurera säkerhetsprinciper och konfigurera enheter 
  ...
  - Använd [guiden Konfigurera inställningar](set-up.md#protect-your-organization) för att konfigurera enhetsprinciper. 
  ...
  - Installationsguiden kommer också att ställa in grundläggande hotskydd och inställningar för dataförlustförebyggande.
  
  Förutom säkerhetsinställningarna i installationsguiden kan du öka säkerheten genom att lägga till följande inställningar:

- **Skydd för e-post malware**
- **ATP anti-phishing**
- **Exchange Online - arkivering**
- **Azure-informationsskydd (Plan1**)

Om du vill komma igång läser du [öka hotskyddet](increase-threat-protection.md) och [konfigurera efterlevnadsfunktioner](set-up-compliance.md).
...
När du ansluter till en Windows 10-enhet till Azure AD tillämpas de principer som du anger för Windows 10-datorer på den. Mer information finns [i Konfigurera Windows-enheter för Microsoft 365 Business-användare](set-up-windows-devices.md).

## <a name="step-4-install-office-365-business"></a>Steg 4: Installera Office 365 Business
- Du kan automatiskt installera Office på Windows-enheterna med hjälp av [installationsguiden](set-up.md#deploy-office-365-client-apps).
...
- **Använda Autopilot för att konfigurera nya enheter**
     ...
     Du kan använda [Windows Autopilot](add-autopilot-devices-and-profile.md) för att automatiskt förkonfigurera **nya** Windows 10-enheter för en användare, men det kan vara lättare att få en [partner](https://www.microsoft.com/solution-providers/search) som kan göra detta åt dig. Du kan också gå till [Microsoft Store](https://go.microsoft.com/fwlink/?linkid=874598)och be en molnteknikexpert att konfigurera nya enheter som du köper.
