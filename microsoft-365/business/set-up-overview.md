...
De flesta installations anvisningarna kan göras i den interaktiva installationen, men de andra alternativen visas också.
...
## <a name="step-2-set-up-security-policies-and-configure-devices"></a>Steg 2: Konfigurera säkerhets principer och konfigurera enheter 
  ...
  - Använd den [guidade installationen](set-up.md#protect-your-organization) för att konfigurera enhets principer. 
...
Se även [de 10 bästa sätten att skydda din Microsoft 365 Business Premium](https://docs.microsoft.com/office365/admin/security-and-compliance/secure-your-business-data) för en Road-karta över bästa säkerhets praxis.

## <a name="step-3-set-up-and-manage-windows-10-devices"></a>Steg 3: Konfigurera och hantera Windows 10-enheter

När du är klar med den interaktiva installationen ska du skydda alla Windows 10-datorer i organisationen.
