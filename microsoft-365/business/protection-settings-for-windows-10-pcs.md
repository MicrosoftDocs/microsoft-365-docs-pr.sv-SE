...
|Förhindra nätverksåtkomst till potentiellt skadlig innehåll på Internet  <br/> |Använd den här inställningen om du vill blockera utgående användaranslutningar till låg rykte Internet platser som kan vara värd för nätfiske, utnyttjar eller annat skadligt innehåll. Den här inställningen är endast tillgänglig om Windows Defender Antivirus är inställt **på på**. Mer information finns i [skydda nätverket](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-antivirus/configure-real-time-protection-windows-defender-antivirus).  <br/> |
