...
Om du inte har skapat enhetsgrupper eller profiler ännu är det bästa sättet att komma igång med hjälp av steg-för-steg-guiden. Du kan också [lägga till enheter](create-and-edit-autopilot-devices.md) och tilldela [profiler](create-and-edit-autopilot-profiles.md) till dem utan att använda guiden. 
...
2. Välj **Enhets** \> **Autopilot**i det vänstra navigeringsfönstret.
...
3. Bläddra till en plats där du har förberett på **filen Ladda upp CSV med listan över enheter.** CSV-fil och **öppna** \> sedan **nästa**. Filen måste ha tre rubriker:
...
6. **Du är klar** anger att profilen du skapade (eller valde) kommer att tillämpas på den enhetsgrupp som du skapade genom att ladda upp listan över enheter. Inställningarna gäller när enhetsanvändarna loggar in härnäst. Välj **Stäng**.
