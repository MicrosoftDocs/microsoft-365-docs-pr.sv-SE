...
6. **Vem får de här inställningarna?** Om du inte vill använda standardgruppen **För alla användare** väljer du **Ändra**väljer \> du de säkerhetsgrupper som får de här inställningarna **Välj**.
...
1. Välj **Redigera policy**på kortet **Policyer** .
...
4. När du är klar stänger du **åtgärdsprincipfönstret.** 
...
2. Välj **Bekräfta** för att ta bort principen eller principerna som du har valt i **åtgärdsfönstret Ta bort.** 
    
## <a name="available-settings"></a>Tillgängliga inställningar

Följande tabeller ger detaljerad information om inställningar som är tillgängliga för att skydda arbetsfiler på enheter och de inställningar som styr hur användare kommer åt Office-filer från sina mobila enheter.
...
|:-----|:-----|
|Inställning  <br/> |Beskrivning  <br/> |
|Kräv PIN-kod eller fingeravtryck för åtkomst till Office-program  <br/> |Om den här inställningen är **On-användare** måste tillhandahålla en annan form av autentisering, förutom deras användarnamn och lösenord, innan de kan använda Office-appar på sina mobila enheter.<br/> |
