...
Ämne | Beskrivning
:---|:---
Allmänna inställningar | Ändra de allmänna inställningar som tidigare definierats som en del av introduktionsprocessen.
Behörigheter | Hantera portalåtkomst med RBAC och enhetsgrupper.
API:er | Aktivera hot som intel och SIEM-integrering.
Regler | Konfigurera etiska regler och automatiseringsinställningar.
Enhetshantering | Onboard and offboard devices.
Nätverksutvärderingar | Välj enheter som ska skannas regelbundet och läggas till i enhetsinventeringen.
