...
**Välkommen till konfigurationsfasen av migrering [från McAfee Endpoint Security (McAfee) till Defender för slutpunkt](mcafee-to-microsoft-defender-migration.md#the-migration-process)**. Den här fasen omfattar följande steg:

1. [Installera om eller Microsoft Defender Antivirus på slutpunkterna](#reinstall-or-enable-microsoft-defender-antivirus-on-your-endpoints).
...
## <a name="reinstall-or-enable-microsoft-defender-antivirus-on-your-endpoints"></a>Installera om eller Microsoft Defender Antivirus på slutpunkterna
...
- [Ange DisableAntiSpyware till False på Windows Server](#set-disableantispyware-to-false-on-windows-server) (endast om det behövs)
...
Eftersom din organisation fortfarande använder McAfee måste du ställa Microsoft Defender Antivirus till passivt läge. Då kan McAfee och Microsoft Defender Antivirus körs sida vid sida tills du har avslutat introduktionen till Defender för Endpoint.
...
Det här steget i konfigurationsprocessen omfattar att lägga till Defender för Endpoint i undantagslistan för McAfee och andra säkerhetsprodukter som din organisation använder. 
...
|OS |Undantag |
|--|--|
| Windows 10 version [1803 eller](/windows/release-health/status-windows-10-1803) senare (se Windows 10 [versionsinformation)](/windows/release-health/release-information)<p>Windows 10, version 1703 eller [1709](/windows/release-health/status-windows-10-1709) med [KB4493441](https://support.microsoft.com/help/4493441) installerat <p>[Windows Server 2019](/windows/release-health/status-windows-10-1809-and-windows-server-2019)<p>[Windows Server, version 1803](/windows-server/get-started/whats-new-in-windows-server-1803) |`C:\Program Files\Windows Defender Advanced Threat Protection\MsSense.exe`<p>`C:\Program Files\Windows Defender Advanced Threat Protection\SenseCncProxy.exe`<p>`C:\Program Files\Windows Defender Advanced Threat Protection\SenseSampleUploader.exe`<p>`C:\Program Files\Windows Defender Advanced Threat Protection\SenseIR.exe`<br/>  |
...
I det här steget i installationsprocessen lägger du till McAfee och dina andra säkerhetslösningar i Microsoft Defender Antivirus för uteslutning. 

När du lägger [till undantag Microsoft Defender Antivirus genomsökningar](configure-exclusions-microsoft-defender-antivirus.md)bör du lägga till undantag för sökvägar och processer. 

Du kan välja mellan flera metoder för att lägga till Microsoft Defender Antivirus undantag, som anges i följande tabell:

|Metod | Lämplig åtgärd|
|--|--|
|[Intune](/mem/intune/fundamentals/tutorial-walkthrough-endpoint-manager) <p>**OBS!** Intune är nu en del av Microsoft Endpoint Manager. |1. Gå till [Microsoft Endpoint Manager och](https://go.microsoft.com/fwlink/?linkid=2109431) logga in.<p>2. Välj  >  **Konfigurationsprofiler för** enheter och välj sedan den profil som du vill konfigurera.<p>3. Under **Hantera** väljer du **Egenskaper**. <p>4. Välj **Konfigurationsinställningar: Redigera**.<p>5. Visa **Microsoft Defender Antivirus** och expandera **Microsoft Defender Antivirus Undantag**.<p>6. Ange de filer och mappar, tillägg och processer som ska undantas från Microsoft Defender Antivirus genomsökningar. Information finns i [Microsoft Defender Antivirus undantag](/mem/intune/configuration/device-restrictions-windows-10#microsoft-defender-antivirus-exclusions).<p>7. Välj **Granska + Spara** och välj sedan **Spara**.  |
...
**Grattis!** Du har slutfört konfigurationsfasen av [migreringen från McAfee till Defender för Endpoint](mcafee-to-microsoft-defender-migration.md#the-migration-process)!

- [Gå vidare till fas 3: Onboard to Defender för Endpoint](mcafee-to-microsoft-defender-onboard.md)
