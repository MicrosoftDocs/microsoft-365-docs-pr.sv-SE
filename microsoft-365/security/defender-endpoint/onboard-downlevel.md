...
Defender för Endpoint utökar stödet till att inkludera operativsystem på undernivå, med avancerade funktioner för identifiering och undersökning av attack i Windows-versioner som stöds.

Om du vill introducera Windows-klientslutpunkter på nednivå till Defender för slutpunkt måste du:
...
> [!IMPORTANT]
> Det här steget krävs bara om din organisation använder System Center Endpoint Protection (S DATACENTER).
...
- Installera uppdateringen [för plattformsuppdateringen för skydd mot skadlig programvara i januari 2017 för Endpoint Protection-klienter](https://support.microsoft.com/help/3209361/january-2017-anti-malware-platform-update-for-endpoint-protection-clie) 
- Konfigurera medlemskap i S FLERA-klientens Molnskyddstjänst till **inställningen** Avancerat
- Konfigurera nätverket så att anslutningar till Microsoft Defender Antivirus-molnet tillåts. Mer information finns i [Tillåta anslutningar till molnet Microsoft Defender Antivirus](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-antivirus/configure-network-connections-microsoft-defender-antivirus#allow-connections-to-the-microsoft-defender-antivirus-cloud)
...
- Installera den [månatliga uppdateringen för februari 2018](https://support.microsoft.com/help/4074598/windows-7-update-kb4074598)
  ...
  > [!NOTE]
  > Endast tillämpligt för Windows 7 SP1 Enterprise och Windows 7 SP1 Pro. 
...
- Uppfylla systemkraven för Azure Log Analytics-agenten. Mer information finns i Samla [in data från datorer i din miljö med logganalys](https://docs.microsoft.com/azure/log-analytics/log-analytics-concept-hybrid#prerequisites)
...
3. Använd nyckeln Arbetsyte-ID och Arbetsyta genom att välja någon av följande installationsmetoder för att installera agenten:
    - [Installera agenten manuellt med hjälp av konfigurationen](https://docs.microsoft.com/azure/log-analytics/log-analytics-windows-agents#install-agent-using-setup-wizard). <br>
      På sidan **Konfigurationsalternativ för** agent väljer du **Anslut agenten till Azure Log Analytics (OMS)**
