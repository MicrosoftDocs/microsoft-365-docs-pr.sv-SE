...
> [!NOTE]
> Efter introduktionen till Defender för Slutpunkt kan du behöva Microsoft Defender Antivirus passivt läge på Windows Server. Om du vill verifiera att passivt läge ställts in som förväntat söker du efter händelse *5007* i **Microsoft-Windows-Windows Defender Driftlogg** (finns i ) och bekräftar att antingen `C:\Windows\System32\winevt\Logs` **ForcePassiveMode** eller **PassiveMode-registernycklar** har angetts till **0x1.**
