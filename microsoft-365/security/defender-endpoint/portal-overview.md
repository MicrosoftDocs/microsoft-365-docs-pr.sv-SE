...
---
# <a name="microsoft-defender-security-center-portal-overview"></a>Översikt över Microsoft Defender Säkerhetscenter-portalen
...
## <a name="microsoft-defender-security-center"></a>Microsoft Defender Säkerhetscenter
...
**Konfigurationshantering** | Visar enheter som är ombord, organisationens säkerhetsbaslinje, prognosanalys, webbskyddstäckning och gör att du kan utföra hantering av attackytor på dina enheter.
...
Ikon | Beskrivning
:---|:---
![ATP-logotypikon](images/atp-logo-icon.png)| Microsoft Defender för Endpoint-logotyp
![Aviseringsikon](images/alert-icon.png)| Avisering – Indikation på en aktivitet som är korrelerad med avancerade attacker.
![Identifieringsikon](images/detection-icon.png)| Identifiering – Indikation på identifiering av skadlig kod.
![Ikon för aktiva hot](images/active-threat-icon.png)| Aktiva hot – hot som körs aktivt vid identifieringen.
![Ikon för åtgärdad1](images/remediated-icon.png)| Åtgärdat – Hot har tagits bort från enheten.
...
![Ikon för observerade filhändelser](images/atp-file-observed-icon.png)| Filhändelser
![Ikonen Registerhändelser](images/atp-registry-event-icon.png)| Registerhändelser
![Ikon för DLL-händelser för inläsning av modul](images/atp-module-load-icon.png)| Läsa in DLL-händelser
![Ikonen Övriga händelser](images/atp-Other-events-icon.png)| Andra händelser
![Ikon för att ändra åtkomsttoken](images/atp-access-token-modification-icon.png)| Ändra åtkomsttoken
![Ikon för att skapa filer](images/atp-file-creation-icon.png)| Skapa filer
![Ikonen Signerare](images/atp-signer-icon.png)| Undertecknaren
![Ikonen Sökväg](images/atp-File-path-icon.png)| Sökväg
![Kommandoradsikon](images/atp-command-line-icon.png)| Kommandorad
![Ikon för osignerad fil](images/atp-unsigned-file-icon.png)| Osignerad fil
![Ikon för processträd](images/atp-process-tree.png)| Processträd
![Ikon för minnestilldelning](images/atp-memory-allocation-icon.png)| Minnestilldelning
![Processinlösningsikon](images/atp-process-injection.png)| Processinlösning
![Powershell-kommandoikonen Kör](images/atp-powershell-command-run-icon.png)| Powershell-kommando som körs
![Ikon för Community Center](images/atp-community-center.png) | Community center
![Meddelandeikon](images/atp-notifications.png) | Meddelanden
![Inga hot hittades](images/no-threats-found.png) | Automatisk undersökning – inga hot hittades
![Ikonen Misslyckades](images/failed.png) | Automatiserad undersökning – misslyckades
![Delvis åtgärdad ikon](images/partially-investigated.png) | Automatiserad undersökning – delvis undersökad
![Avslutas av systemet](images/terminated-by-system.png) | Automatisk undersökning – avslutas av systemet
![Ikonen Väntande](images/pending.png) | Automatiserad undersökning – väntande
![Ikonen Kör](images/running.png) | Automatiserad undersökning – körs
![Ikon för åtgärdad2](images/remediated.png) | Automatiserad undersökning – åtgärdad
![Delvis undersöka-ikon](images/partially_remediated.png) | Automatiserad undersökning – delvis åtgärdat
![Ikon för hotinsikter](images/tvm_bug_icon.png) | Hot & sårbarhetshantering – insikter om hot
![Eventuell aktiv aviseringsikon](images/tvm_alert_icon.png) | Hot & sårbarhetshantering – möjlig aktiv avisering
![Ikon för Rekommendationsinformation](images/tvm_insight_icon.png) | Hot & sårbarhetshantering – rekommendation insikter
