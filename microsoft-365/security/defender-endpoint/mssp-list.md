...
:---|:---|:---
![Bild på Accenture-logotyp](images/accenture-logo.png)|[Accenture Managed Detection & Response (MDR)](https://go.microsoft.com/fwlink/?linkid=2164353) | Hantera, underhålla och förbättra global cybersäkerhet med utökade funktioner för att identifiera, proaktivt leta efter och hantera avancerade cyberattacker i både IT- och OT-miljöer i molnet och lokalt.
...
![Bild på BDO Digital-logotyp](images/bdo-logo.png)| [BDO Digital](https://go.microsoft.com/fwlink/?linkid=2090394) | BDO Digitals hanterade skydd använder best practice-verktyg, AI och in-house säkerhetsexperter för 7/24/365-identitetsskydd
...
![Bild på CyberProof-logotyp](images/cyberproof-logo.png) |[MdR (CyberProof Managed Detection & Response)](https://go.microsoft.com/fwlink/?linkid=2163964) | 24x7 hanterade tjänster för identifiering av hot och svar helt integrerade med Azure Sentinel och Defender för Endpoint.
...
![Bild på Mandiant-logotyp](images/mandiant-logo.png) | [Mandiant Managed Defense (MDR) för Microsoft Defender för Endpoint](https://go.microsoft.com/fwlink/?linkid=2164352) | Förstärka defendern för slutpunkten med mdrinintelligens dygnet runt alla dagar i veckan och expertkunskaper från Mandiant.
...
![Bild på logon för Trustwave Threat Detection & Response Services](images/trustwave-logo.png)| [Trustwave Threat Detection & Response Services](https://go.microsoft.com/fwlink/?linkid=2127542) | Tjänster för identifiering av hot och svar för Azure med integreringar med Sentinel och Defender för Slutpunkt
