...
---
# <a name="turn-on-cloud-delivered-protection"></a>Aktivera moln levererat skydd
...
> [!NOTE]
> Microsoft Defender Antivirus-molntjänsten är en mekanism för att tillhandahålla uppdaterat skydd till nätverket och slutpunkterna. Även om den kallas för en molntjänst är den inte bara skydd för filer som lagras i molnet. I stället används distribuerade resurser och maskininlärning för att ge skydd till dina slutpunkter i en takt som är mycket snabbare än traditionella säkerhetsintelligensuppdateringar.
...
Du kan aktivera eller inaktivera moln leveransskydd i Microsoft Defender Antivirus på flera olika sätt:
...
- PowerShell-cmdlets.
 ...
 Du kan också aktivera eller inaktivera det i enskilda klienter med Windows-säkerhetsappen.

Se [Använda Moln levererat skydd för Microsoft för](cloud-protection-microsoft-defender-antivirus.md) en översikt över moln levererat skydd i Microsoft Defender Antivirus.
...
> [!NOTE]
> I Windows 10 finns det ingen skillnad mellan **rapporteringsalternativen Grundläggande** **och Avancerat** som beskrivs i det här avsnittet. Det här är en äldre skillnad och om du väljer en av inställningarna får du samma nivå av moln levererat skydd. Det är ingen skillnad på vilken typ av information och hur mycket information som delas. Mer information om vad vi samlar in finns i [Microsofts sekretesspolicy.](https://go.microsoft.com/fwlink/?linkid=521839)
...
3. Välj den **profiltyp för** Enhetsbegränsningar som du vill konfigurera. Om du behöver skapa en ny **profiltyp för Enhetsbegränsningar** kan du gå [till Konfigurera inställningar för enhetsbegränsning i Microsoft Intune.](/intune/device-restrictions-configure)
...
Mer information om Intune-enhetsprofiler, bland annat hur du skapar och konfigurerar deras inställningar finns i Vad är Enhetsprofiler i [Microsoft Intune?](/intune/device-profiles)
...
Mer information om hur du konfigurerar Microsoft Endpoint Configuration Manager finns i Skapa och [distribuera principer för programskydd: Molnskyddstjänst](/configmgr/protect/deploy-use/endpoint-antimalware-policies#cloud-protection-service).
...
4. Expandera trädet till **Windows-komponenter > Microsoft Defender Antivirus > MAPS**
...
Mer information om hur du använder PowerShell med Microsoft Defender Antivirus finns i Använda [PowerShell-cmdlets](use-powershell-cmdlets-microsoft-defender-antivirus.md) för att konfigurera och köra [cmdlets](/powershell/module/defender/)för Microsoft Defender Antivirus och Defender. [Policy CSP – Defender](/windows/client-management/mdm/policy-csp-defender) har också mer information specifikt om [-SubmitSamplesConsent.](/windows/client-management/mdm/policy-csp-defender#defender-submitsamplesconsent)
...
## <a name="use-windows-management-instruction-wmi-to-turn-on-cloud-delivered-protection"></a>Aktivera moln levererat skydd med Windows Management Instruction (WMI)
...
## <a name="turn-on-cloud-delivered-protection-on-individual-clients-with-the-windows-security-app"></a>Aktivera moln levererat skydd på enskilda klienter med Windows-säkerhetsappen
...
1. Öppna appen Windows-säkerhet genom att välja sköldikonen i aktivitetsfältet eller genom att söka efter Defender på **startmenyn.**
...
- [Konfigurera tidsgränsen för molnblockering](configure-cloud-block-timeout-period-microsoft-defender-antivirus.md)
- [Konfigurera blocket vid första synen](configure-block-at-first-sight-microsoft-defender-antivirus.md)
- [Använda PowerShell-cmdlets för att hantera Microsoft Defender Antivirus](use-powershell-cmdlets-microsoft-defender-antivirus.md)
...
- [Använda molnskydd från Microsoft i Microsoft Defender Antivirus](cloud-protection-microsoft-defender-antivirus.md)
