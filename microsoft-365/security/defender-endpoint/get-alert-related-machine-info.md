...
---
# <a name="get-alert-related-machine-information-api"></a>Få aviseringsrelaterat API för maskininformation
...
Hämtar enheten [som](machine.md) är relaterad till en viss avisering.
