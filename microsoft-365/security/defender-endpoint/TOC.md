...
### [Växla från säkerhetslösning för slutpunkt som inte är från Microsoft till Microsoft Defender för slutpunkter]()
...
### [Hantera Defender för Endpoint efter migrering]()
#### [Översikt över hantering av Defender för Endpoint](manage-atp-post-migration.md)
