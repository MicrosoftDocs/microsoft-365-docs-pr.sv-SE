...
En av följande behörigheter krävs för att anropa detta API. Mer information, inklusive hur du väljer behörigheter, finns i Använda [ATP-API:er för Microsoft Defender](apis-intro.md)
