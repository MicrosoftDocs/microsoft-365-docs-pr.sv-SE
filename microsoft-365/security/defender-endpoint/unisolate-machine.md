...
---
# <a name="release-device-from-isolation-api"></a>Släpp enheten från isolations-API:t
...
- Information om hur du isolerar en enhet finns [i Isolera enhet](isolate-machine.md).
