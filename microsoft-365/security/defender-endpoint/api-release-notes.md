...
- Ny exportutvärderings-API-metod – _Sårbarhetsbedömning av programvara deltaexport (OData) Exportera_ [utvärderingsmetoder och egenskaper per enhet.](get-assessment-methods-properties.md)
