...
> [!NOTE]
> Webbplatsen Microsoft Defender Säkerhetscenter Microsoft Defender för Endpoint-portalen och kan nås på [https://aka.ms/MDATPportal](https://aka.ms/MDATPportal) . 
...
|Identifiering och åtgärd på slutpunkt  |macOS: <br/>- 11.3.1 (Big Sur)<br/>- 10.15 (Catalina)<br/>- 10.14 (Mojave)   |[Microsoft Defender för slutpunkt i macOS: Nätverksanslutningar](microsoft-defender-endpoint-mac.md#network-connections)  |
