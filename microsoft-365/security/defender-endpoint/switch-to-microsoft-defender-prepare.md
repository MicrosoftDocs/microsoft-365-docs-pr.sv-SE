...
> [!NOTE]
> The Microsoft Defender Säkerhetscenter kallas ibland för Defender för Endpoint-portalen och kan nås på [https://aka.ms/MDATPportal](https://aka.ms/MDATPportal) . 
