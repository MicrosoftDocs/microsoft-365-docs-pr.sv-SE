...
---
# <a name="get-machine-by-id-api"></a>Skaffa datorn via ID API
...
Hämtar specifik dator [med](machine.md) dess enhets-ID eller datornamn.


## <a name="limitations"></a>Begränsningar
1. Du kan se till att enheter som visas senast enligt din konfigurerade bevarandeprincip.
...
Om det fungerar och enheten finns - 200 OK med [datorenheten](machine.md) i brödtexten.
