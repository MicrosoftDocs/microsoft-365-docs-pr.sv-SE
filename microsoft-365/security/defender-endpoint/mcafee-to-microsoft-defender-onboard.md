...
**Välkommen till fas 3 av migreringen från [McAfee Endpoint Security (McAfee) till Microsoft Defender Avancerat skydd (Microsoft Defender för Slutpunkt).](mcafee-to-microsoft-defender-migration.md#the-migration-process)** Den här migreringsfasen omfattar följande steg:
...
- [Hantera Microsoft Defender Avancerat skydd efter migrering.](manage-atp-post-migration.md)
