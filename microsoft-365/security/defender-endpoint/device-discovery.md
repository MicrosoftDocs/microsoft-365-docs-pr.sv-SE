...
- **Upptäck slutpunkter för företag som är anslutna till företagets nätverk**
...
Säkerhetsproblem och risker på dina enheter samt andra identifierade ohanterade enheter i nätverket är en del av de aktuella TVM-flödena under "Security Rekommendationer" och representeras på entitetssidor i portalen.
Sök efter SSH-relaterade säkerhetsrekommendationer för att hitta svagheter i SSH som är relaterade till ohanterade och hanterade enheter.
