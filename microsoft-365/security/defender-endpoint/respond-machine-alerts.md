...
>[!IMPORTANT]
> - De här svarsåtgärderna är endast tillgängliga för enheter Windows 10, version 1703 eller senare. 
> - För icke-Windows-plattformar är svarsfunktioner (som enhetsisolering) beroende av tredjepartsfunktionerna.
...
|Installerade program | Den .CSV filen innehåller en lista över installerade program som kan hjälpa dig att identifiera vad som är installerat på enheten. Mer information finns i [Win32_Product klass](https://go.microsoft.com/fwlink/?linkid=841509).                                                                                  |
...
## <a name="run-microsoft-defender-antivirus-scan-on-devices"></a>Kör Microsoft Defender Antivirus sökning på enheter
...
I Windows 10 version 1709 eller senare har du ytterligare kontroll över nätverkisolering. Du kan också välja att Outlook, Microsoft Teams och Skype för företag (kallas även selektiv avgränsning).
