...
1. Välj ett namn för profilen, t.ex. "Defender eller Endpoint onboarding för macOS". Klicka **Nästa**.

    > [!div class="mx-imgBorder"]
    > ![Anpassad konfigurationsprofil – namn](images/mdatp-6-systemconfigurationprofiles-2.png)

1. Välj ett namn för konfigurationsprofilens namn, t.ex. "Defender för slutpunkts onboarding för macOS".
...
Följ instruktionerna för [blob för onboarding](#onboarding-blob) ovan, med "Defender för slutpunkt fullständig diskåtkomst" som profilnamn och nedladdad **fulldisk.mobileconfig** som konfigurationsprofilnamn.
...
Följ instruktionerna för [blob för onboarding](#onboarding-blob) ovan, med "Defender för slutpunktsnätverksfilter" som profilnamn och nedladdat **netfilter.mobileconfig** som konfigurationsprofilnamn.
...
Följ instruktionerna för [blob för onboarding](#onboarding-blob) ovan, med "Defender for Endpoint Notifications" som profilnamn och nedladdat **notif.mobileconfig** som konfigurationsprofilnamn.
