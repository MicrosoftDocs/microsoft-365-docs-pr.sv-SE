...
Följande gradvisa utrullningsmodell följs för månatliga Defender-uppdateringar:
...
Du kan också tilldela en dator till en kanal för att ange hur mycket den får dagliga definitionsuppdateringar. Observera att till skillnad från månadsprocessen finns det ingen Betakanal och den här gradvisa utgivningscykeln inträffar flera gånger om dagen.
