...
1. Logga in på [Microsoft Defender Säkerhetscenter](https://securitycenter.windows.com) som en * global **administratör** _ eller _*_säkerhetsadministratör_**.
...
## <a name="the-schema-of-the-events-in-azure-event-hubs"></a>Schemat för händelserna i Azure Event Hubs
