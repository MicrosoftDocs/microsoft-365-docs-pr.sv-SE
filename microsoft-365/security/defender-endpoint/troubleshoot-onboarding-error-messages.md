...
---
# <a name="troubleshoot-subscription-and-portal-access-issues"></a>Felsöka problem med prenumerationer och portalåtkomst
...
Om du får ett felmeddelande Microsoft Defender Säkerhetscenter en detaljerad förklaring av vad problemet är och relevanta länkar kommer att tillhandahållas.

## <a name="no-subscriptions-found"></a>Inga prenumerationer hittades

Om du får meddelandet Inga prenumerationer  hittades när du använde Microsoft Defender Säkerhetscenter, innebär det att den Azure Active Directory (Azure AD) som användes för att logga in användaren på portalen inte har någon Microsoft Defender för slutpunkt-licens.
...
- Licensen har köpts men inte etablerats till den här Azure AD-instansen.
    ...
    - Det kan vara så att du oavsiktligt har etablerat licensen till ett annat Microsoft Azure AD än den som används för autentisering i tjänsten.
...
Om ett meddelande om att din  prenumeration Microsoft Defender Säkerhetscenter du får ett meddelande om att din prenumeration har upphört att gälla när du öppnar ett e-postmeddelande har gått ut har onlinetjänstprenumerationen upphört att gälla. Microsoft Defender för Endpoint-prenumerationen har, precis som alla andra onlinetjänstprenumerationer, ett utgångsdatum. 
...
Mer information finns i Tilldela [**användaråtkomst till portalen.**](/windows/threat-protection/windows-defender-atp/assign-portal-access-windows-defender-advanced-threat-protection)
