...
|**Skydda din e-post från riktade nät fiske attacker**. Om du har konfigurerat en eller flera egna domäner för Office 365 eller Microsoft 365-miljön kan du konfigurera riktat mot nätfiske-skydd. Skydd mot nätfiske, som ingår i Defender för Office 365, skyddar din organisation från illasinnade nätfiske-attacker och andra nät fiske attacker. Om du inte har konfigurerat en egen domän behöver du inte göra detta.| |![grön bock markering](../media/green-check-mark.png)|
...
|Rekommendation  |E3  |E5  |
|---------|---------|---------|
|**Konfigurera Microsoft Defender för Office 365** :<br>* Säkra bifogade filer<br>* Säkra länkar<br>* ATP för SharePoint, OneDrive och Microsoft Teams<br>* Anti-nätfiske i Defender för Office 365-skydd|         |![grön bock markering](../media/green-check-mark.png) |
|**Konfigurera Microsoft Defender för slut punkts funktioner** :<br>* Windows Defender Antivirus <br>* Sårbarhets skydd <br> * Reducering av attack ytan <br> * Maskinvarubaserad isolering <br>* Reglerad mappåtkomst     |         |![grön bock markering](../media/green-check-mark.png) |
...
|**Använd [Microsoft Defender för slut punkter](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/information-protection-in-windows-overview) för att kontrol lera om användare lagrar känslig information på sina Windows-enheter**. |         |![grön bock markering](../media/green-check-mark.png)|
...
|**Distribuera [Microsoft Defender för](https://docs.microsoft.com/azure-advanced-threat-protection/what-is-atp)** att övervaka och skydda mot hot som riktar sig till din lokala Active Directory-miljö.   |         |![grön bock markering](../media/green-check-mark.png) |
|Använd **Azure Defender** _ för att övervaka för hot kring hybrid-och moln arbets belastningar. Azure Defender_ innehåller en kostnads fri kapacitets nivå och en standard uppsättning funktioner som betalas utifrån resurs timmar eller transaktioner.|         |         |
...
- **Granska Top malware och phished användare varje vecka** – Använd Microsoft Defender för Office 365 Threat Explorer för att granska de vanligaste användarna riktade mot skadlig program vara och Phish och för att ta reda på orsaken till varför dessa användare påverkas.
