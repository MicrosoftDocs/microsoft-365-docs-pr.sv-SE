...
| description                               | Sträng värde som beskriver varje varning.                                                                                                                                                                                                                                                                                                                                                        | User test user2 (testUser2@contoso.com) manipulerar 99-filer med flera tillägg som slutar med det ovanliga tillägget *Herunterladen*. Det här är ett ovanligt antal fil ändringar och är ett exempel på en potentiell utpressnings tro Jan attack. |
...
| **Enhets format**                             |                                                                                                                                                                                                                                                                                                                                                                                            |                                                                                                                                                                                                                                                   |
| DeviceId                                  | Enhets-ID enligt Microsoft Defender för slut punkt.                                                                                                                                                                                                                                                                                                                                                       | 24c222b0b60fe148eeece49ac83910cc6a7ef491                                                                                                                                                                                                          |
