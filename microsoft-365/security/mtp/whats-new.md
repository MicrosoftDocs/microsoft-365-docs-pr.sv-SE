...
RSS-flöde: Få ett meddelande när den här sidan uppdateras genom att kopiera och klistra in följande webbadress i flödesläsaren:
```http
...
- [Kontrollera rekord i avancerad jakt](advanced-hunting-query-results.md#drill-down-from-query-results) <br> Kontrollera snabbt poster i frågeresultatet med den nya informationspanelen.

## <a name="may-2020"></a>Maj 2020
- [Anpassade identifieringar](custom-detections-overview.md) <br> Använd avancerade jaktfrågor för att skapa anpassade identifieringsregler som automatiskt övervakar och svarar på säkerhetshändelser och systemtillstånd.

## <a name="february-2020"></a>Februari 2020
- [Incidenter](incidents-overview.md) <br> Vet exakt var en attack började och andra detaljer som hjälper dig att se omfattningen av attacken.
- [Automatiska undersökningar och svar](mtp-autoir.md) <br> AIR gör det möjligt för din säkerhetsoperationsgrupp att dramatiskt öka organisationens kapacitet att hantera säkerhetsvarningar och incidenter.
- [Avancerade jaktförbättringar](advanced-hunting-overview.md) <br> Proaktivt jakt efter hot över hela den moderna arbetsytan med Kusto Query Language och ett säkerhetsoptimerat schema.

## <a name="march-2019"></a>Mars 2019
- Avancerad jakt <br> Målsida till olika jaktfunktioner som gör att du proaktivt kan hitta hot som påverkar e-post och data, enheter och identiteter.
- [Microsoft Secure Score](microsoft-secure-score.md) <br> Mätning av en organisations säkerhetsposition, med ett högre antal som anger fler förbättringsåtgärder som vidtas. Om du följer rekommendationerna om säkerhetsresultat kan du skydda din organisation från hot. 
