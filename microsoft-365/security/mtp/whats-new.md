...
- [Funktionen AssignedIPAddresses ()](advanced-hunting-assignedipaddresses-function.md) <br> Med den här funktionen kan [du snabbt](advanced-hunting-overview.md) skaffa de senaste IP-adresserna som har tilldelats till en enhet eller de senaste IP-adresserna från en viss tidpunkt.
...
- [Gå på jakt](advanced-hunting-go-hunt.md)<br> Snabbt pivotera att utreda en olycka för att inspektera en viss händelse, en användare, en enhet eller andra entitetstyper som använder frågor baserade på de avancerade jakt funktionerna.
