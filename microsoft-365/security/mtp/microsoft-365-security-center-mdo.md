...
| [Undersökning](../office-365-security/office-365-air.md#changes-are-coming-soon-in-your-security-center) | Samlar AIR-funktioner i [Defender för Office 365](../office-365-security/office-365-atp.md) och [Defender för Endpoint](/windows/security/threat-protection/microsoft-defender-atp/automated-investigations). Med de här uppdateringarna och förbättringarna kommer säkerhetsgruppen att kunna visa information om automatiska undersökningar och åtgärder som gäller för e-post, samarbetsinnehåll, användarkonton och enheter, allt på ett och samma ställe.  | 
...
Avsnittet [Komma igång](../office-365-security/office-365-atp.md#getting-started) i artikeln [Microsoft Defender för Office 365](../office-365-security/office-365-atp.md) har en logisk tidig konfigurationsdel som ser ut så här:
...
- [Anpassade regler för identifiering](/windows/security/threat-protection/microsoft-defender-atp/custom-detection-rules)
