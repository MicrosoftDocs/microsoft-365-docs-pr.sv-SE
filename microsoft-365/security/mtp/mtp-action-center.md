...
Åtgärdscenter ger en "enda fönsterruta" för uppgifter, till exempel:
...
I det enhetliga åtgärdscentret samlas åtgärdsåtgärder i Defender för Endpoint och Defender för Office 365. Den definierar ett gemensamt språk för alla åtgärder och ger en enhetlig undersökningsupplevelse. Åtgärdscenter ger teamet för säkerhetsåtgärder ett "enda fönster av glas" för att visa och hantera åtgärder.  

Du kan använda det enhetliga åtgärdscentret om du har rätt behörigheter och en eller flera av följande prenumerationer:

- [Defender för Endpoint](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)
- [Defender förr Office 365](../office-365-security/office-365-atp.md)
...
| **Manuell svarsåtgärd** | Åtgärder som vidtas på en enhet med [live-svar](/windows/security/threat-protection/microsoft-defender-atp/live-response). Några exempel är att ta bort en fil, stoppa en process och ta bort en schemalagd aktivitet. |
...
- [Granska och hantera åtgärder](mtp-autoir-actions.md)