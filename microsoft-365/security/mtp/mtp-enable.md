...
[Microsoft 365 Defender](microsoft-threat-protection.md) ger en enhetlig svarsprocess för incidenter genom att integrera nyckelfunktioner i Microsoft Defender för slutpunkt, Microsoft Defender för Office 365, Microsoft Cloud App Security och Microsoft Defender för identitet. I den här enhetliga upplevelsen läggs kraftfulla funktioner som du kan komma åt i Säkerhetscenter för Microsoft 365.
...
Läs vanliga frågor om hur du använder Microsoft 365 Defender i Vanliga frågor och svar om hur du får svar på de vanligaste frågorna om hur du använder Microsoft 365 [Defender.](mtp-enable-faq.md)
...
- [Microsoft Defender för slutpunktsdatalagring](/windows/security/threat-protection/microsoft-defender-atp/data-storage-privacy)