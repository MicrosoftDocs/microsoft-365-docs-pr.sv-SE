...
ms.locfileid: "45092949"
---
# <a name="microsoft-secure-score-preview"></a>Microsoft Secure Score (förhandsgranskning)

>[!IMPORTANT]
>Viss information avser förhyrda produkter som kan ändras väsentligt innan den släpps kommersiellt. Microsoft lämnar inga garantier, uttryckliga eller underförstådda, med avseende på den information som lämnas här.
...
- Lösa osäkra kontoattribut
- Stoppa exponering för rensa textreferenser
