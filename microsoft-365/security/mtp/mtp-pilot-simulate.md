...
1. Kontrollera att klientorganisationen [har aktiverat Microsoft 365 Defender](./mtp-enable.md#starting-the-service).
...
|![Slutfas och sammanfattningsfas](../../media/mtp/close.png) <br>[Slutfas och sammanfattningsfas](mtp-pilot-close.md)|Analysera dina pilotresultat i Microsoft 365 Defender, presentera dem för dina intressenter och ta nästa steg.
|:-----|:-----|