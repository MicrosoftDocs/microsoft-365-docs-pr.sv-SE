...
**Automatiska åtgärder för undersökning och svar (AIR)** utlöses av aviseringar eller av säkerhetsoperationsgrupper inifrån Threat Explorer. De kan innehålla vissa rekommenderade medling som måste godkännas av säkerhetsoperationsgrupper. Dessa åtgärder för reparation finns på fliken Åtgärd i den automatiska undersökningen.  
...
All medling (antingen direkt godkännande eller tvåstegsgodkännande) som skapas genom Threat Explorer, och godkända åtgärder som kommer från automatiserade undersökningar, visas i Åtgärdscenter, som kan nås via den vänstra navigeringen under *Review* >  **Action Center**.
...
Se<https://docs.microsoft.com/microsoft-365/security/office-365-security/investigate-malicious-email-that-was-delivered?view=o365-worldwide>