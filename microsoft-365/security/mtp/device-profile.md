...
* **Initiera Live Response-session** – Läser in ett fjärrgränssnitt på enheten [för ingående säkerhetsundersökning.](/windows/security/threat-protection/microsoft-defender-atp/live-response)
...
* [Undersök enheter på enheter med hjälp av live-svar](/windows/security/threat-protection/microsoft-defender-atp/live-response)
