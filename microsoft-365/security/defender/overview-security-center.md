---
title: Microsoft 365 Defender-översikt, kombinerar MDO, MDE, MDI och MCAS
description: Fördelar med Microsoft 365 Defender, kombination av Microsoft Defender för Office 365 (MDO) och Microsoft Defender för Slutpunkt (MDE) med Microsoft Defender för identitet (MDI) och Microsoft Cloud App Security (MCAS). I den här artikeln beskrivs Microsoft 365 Defender-framsteg för administratörer.
...
**Microsoft 365 Defender** () kombinerar skydd, identifiering, undersökning och svar på e-post, samarbete, identitet och enhetshot [https://security.microsoft.com](https://security.microsoft.com) på en central portal.    

Microsoft 365 Defender samlar funktioner från befintliga Microsoft-säkerhetsportaler, som Microsoft Defender Säkerhetscenter och Säkerhets- Office 365 Säkerhets- & Efterlevnadscenter. Säkerhetscenter betonar snabb åtkomst till information, enklare layouter och att sammanföra relaterad information för enklare användning. Detta center omfattar:
...
- [Defender för slutpunkt i Microsoft 365 Defender](microsoft-365-security-center-mde.md)
...
Microsoft 365 Defender framhäver *enhet, tydlighet och gemensamma mål när* microsoft Defender slås samman för Office 365 och Microsoft Defender för Endpoint. Kopplingen gjordes utifrån de prioriteringar som anges nedan och skapade utan att ha tagit av de funktioner som respektive säkerhetssvit hade i kombination av:
...
Med den här snabb översiktsinformationen kan du hålla dig informerad om de senaste aktiviteterna i organisationen. Microsoft 365 Defender samlar signaler från olika källor för att presentera en vy över din Microsoft 365 miljö.
...
> [!NOTE]
> Det finns användbara **filter** längst upp i Microsoft 365 Defender utbildningsnav som gör att du kan välja mellan produkter (för närvarande Microsoft 365 Defender, Microsoft Defender för slutpunkt och Microsoft Defender för Office 365). Observera att antalet utbildningsresurser för varje avsnitt visas, vilket kan hjälpa eleverna att hålla reda på hur många resurser de har till hands för utbildning och inlärning.
>
...
Fortsätt utforska funktionerna i Microsoft 365 Defender:
