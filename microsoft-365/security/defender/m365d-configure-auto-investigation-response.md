...
Microsoft 365 Defender innehåller kraftfulla [automatiska undersöknings- och svarsfunktioner](m365d-autoir.md) som kan spara mycket tid och arbete från gruppen med säkerhetsåtgärder. Med [självbetjäning](m365d-autoir.md#how-automated-investigation-and-self-healing-works)imiterar de här funktionerna de steg en säkerhetsanalytiker skulle vidta för att undersöka och reagera på hot, bara snabbare och med större skalningsmöjligheter.
...
|Krav|Information|
|---|---|
|Prenumerationskrav|En av dessa prenumerationer: <ul><li>Microsoft 365 E5</li><li>Microsoft 365 A5</li><li>Microsoft 365 E3 med Microsoft 365 E5 Security tillägg</li><li>Microsoft 365 A3 med Microsoft 365 A5 säkerhets tillägget</li><li>Office 365 E5 plus Enterprise Mobility + Security E5 plus Windows E5</li></ul> <p> Se [Microsoft 365 Defender licenskrav](./prerequisites.md#licensing-requirements).|
...
1. I Microsoft 365 Defender () <https://security.microsoft.com> går du till Principer för & principer **för** hot \> **mot regler.**
...
3. Kontrollera [att Valv bifogade filer SharePoint, OneDrive och Microsoft Teams](../office-365-security/mdo-for-spo-odb-and-teams.md) är aktiverat.

4. Kontrollera att [ZAP (Zero-hour auto purge) Exchange Online](../office-365-security/zero-hour-auto-purge.md) är i kraft.

5. (Det här steget är valfritt.) Granska Office 365 [principer för avisering](../../compliance/alert-policies.md) i Microsoft 365 Efterlevnadscenter ( [https://compliance.microsoft.com/compliancepolicies](https://compliance.microsoft.com/compliancepolicies) ). Flera standardaviseringsprinciper finns i kategorin Hothantering. Vissa av dessa varningar kan utlösa automatisk undersökning och svar. Mer information finns i [Standardaviseringsprinciper](../../compliance/alert-policies.md#default-alert-policies).
...
1. Logga in på Microsoft 365 Defender portalen ( [https://security.microsoft.com](https://security.microsoft.com) ).

2. Leta efter Incidenter i **&,** Letar och Åtgärdscenter som visas i bilden ovan. 
   - Om du ser **& händelser i** **&,** **Om** det gäller Microsoft 365 Defender åtgärdscenter är Microsoft 365 Defender aktiverat. Läs avsnittet [Granska eller ändra automatiseringsnivån för enhetsgrupper i](#review-or-change-the-automation-level-for-device-groups) den här artikeln.
   - Om du inte *ser* **Incidenter,** **Åtgärdscenter** **eller** Microsoft 365 Defender kan det hända att Microsoft 365 Defender inte är aktiverat. I det här fallet [går du till Åtgärdscenter](m365d-action-center.md)).

3. I navigeringsfönstret väljer du **Inställningar**  >  **Microsoft 365 Defender**. Kontrollera Microsoft 365 Defender är aktiverat.
