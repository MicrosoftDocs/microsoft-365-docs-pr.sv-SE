...
kommentarer | Matris med kommentarer som skapats av sekops vid hantering av incidenten, till exempel ytterligare information om klassificeringsvalet. | \[\]
...
aadDeviceId |  Det enhets-ID som anges i [Azure Active Directory](/azure/active-directory/fundamentals/active-directory-whatis). Endast tillgängligt för domän anslutna enheter. | null
