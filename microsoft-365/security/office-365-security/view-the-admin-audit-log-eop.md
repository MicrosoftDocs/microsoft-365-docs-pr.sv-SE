...
- Parametern _ObjectIds_ filtrerar resultaten av objektet som ändrades av cmdleten. Ett giltigt värde beror på hur objektet representeras i granskningsloggen. Till exempel:
