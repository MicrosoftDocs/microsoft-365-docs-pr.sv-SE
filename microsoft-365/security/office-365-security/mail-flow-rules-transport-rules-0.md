...
- [Ansvarsfriskrivningar, signaturer, sidfötter och sidhuvuden för hela organisationen i Exchange Online](https://docs.microsoft.com/exchange/security-and-compliance/mail-flow-rules/disclaimers-signatures-footers-or-headers)
...
- [Minska skadlig programvara genom blockering av bifogade filer i Exchange Online Protection](reducing-malware-threats-through-file-attachment-blocking-in-exchange-online-pro.md)
...
Mer information om åtgärder för e-postflödesregel som är tillgängliga i fristående EOP finns i Åtgärder för [e-postflödesregel i Exchange Online.](https://docs.microsoft.com/exchange/security-and-compliance/mail-flow-rules/mail-flow-rule-actions)
...
|**Markerad** eller inte markerad vid kryssruta|Nya regler: _Aktiverad_ parameter i **cmdleten New-TransportRule.** <p> Befintliga regler: Använd **cmdletarna Enable-TransportRule** **eller Disable-TransportRule.** <p> Värdet visas i egenskapen **Delstat** för regeln.|Du kan skapa en inaktiverad regel och aktivera den när du är redo att testa den. Du kan också inaktivera en regel utan att ta bort den om du vill behålla inställningarna.|
...
|**Meddelandekryptering i Office 365:** Meddelanden som krypteras med meddelandekryptering i Office 365 i Office 365. Mer information finns i Kryptering [i Office 365.](../../compliance/encryption.md)|Regler kan alltid komma åt kuverthuvuden och bearbeta meddelanden utifrån villkor som inspekterar dessa sidhuvuden. <p> För att en regel ska granska eller ändra innehållet i ett krypterat meddelande måste du kontrollera att transportdekryptering är aktiverat (Obligatoriskt eller valfritt, standard är valfritt). Mer information finns i Definiera [regler för att kryptera eller dekryptera e-postmeddelanden i Office 365.](../../compliance/define-mail-flow-rules-to-encrypt-email.md)|
...
|**UM-meddelanden:** Meddelanden som skapas eller bearbetas av Unified Messaging-tjänsten, till exempel röstmeddelanden, fax, aviseringar om missade samtal och meddelanden som skapas eller vidarebefordras med Microsoft Outlook Voice Access.|Ja|
