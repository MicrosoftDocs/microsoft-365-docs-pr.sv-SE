...
|IR (Information Rights Management)<sup>\*</sup>||ComplianceManagement <p> OrganizationManagement|
...
|Karantän|Hantera alla typer av meddelande i karantän för alla mottagare.|OrganizationManagement <p> QuarantineAdministrator <p> SecurityAdministrator|
...
I följande tabell visas Microsoft 365-roller och de fristående EOP-rollgrupper som de motsvarar. Mer information om de här rollerna finns i [Om administratörsroller.](https://docs.microsoft.com/microsoft-365/admin/add-users/about-admin-roles)
...
Andra Microsoft 365-roller har inte en motsvarande EOP-rollgrupp och beviljar inte administrativa behörigheter i EOP. Mer information om hur du tilldelar en Microsoft 365-roll till en användare finns i [Tilldela administratörsroller.](https://docs.microsoft.com/microsoft-365/admin/add-users/assign-admin-roles)
