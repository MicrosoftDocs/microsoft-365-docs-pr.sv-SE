...
För **lästa eller olästa meddelanden** som innehåller skadlig programvara efter leverans sätts det meddelande som innehåller den bifogade filen som innehåller den bifogade filen i skadlig programvara i karantän. Endast administratörer kan visa och hantera meddelanden om skadlig programvara från karantän.
...
Som standard har ZAP för skräppost aktiverats i principer  för skräppostskydd, och standardåtgärden för filtrering  av skräppost är Flytta meddelande till mappen **Skräppost,** vilket innebär att ZAP i skräpposten flyttar olästa meddelanden till mappen Skräppost som standard.
...
Det finns inga begränsningar på licenser. ZAP fungerar för alla postlådor som finns på Exchange Online. ZAP fungerar inte i fristående Exchange Online Protection-miljöer (EOP) som skyddar lokala Exchange-postlådor.
...
ZAP sätts inte i karantän för meddelanden från postlådor som är i karantän. ZAP kan flytta meddelanden till mappen Skräppost baserat på åtgärder som konfigurerats för skräppost eller nätfiskeförsök i principer mot skräppost.
