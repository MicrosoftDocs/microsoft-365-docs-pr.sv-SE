...
Personifieringsskydd är en del av inställningarna för skydd mot nätfiske) som bara är exklusiva för Microsoft Defender för Office 365. Mer information om de här inställningarna finns [i Inställningar för personifiering i skydd mot nätfiske i Microsoft Defender för Office 365.](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365)

Du kan använda personifieringsinsikter för att snabbt identifiera meddelanden från imiterade avsändare eller avsändardomäner som du har konfigurerat för personifieringsskydd.

## <a name="what-do-you-need-to-know-before-you-begin"></a>Vad behöver jag veta innan jag börjar?

- Öppna Säkerhets- och efterlevnadscentret på <https://protection.office.com/>. Om du vill gå direkt till personifieringsinsikten **på sidan Skydd mot nätfiske** använder du <https://protection.office.com/antiphishing> .
...
## <a name="open-the-impersonation-insight-in-the-security--compliance-center"></a>Öppna personifieringsinsikten i säkerhets- & säkerhets- och efterlevnadscentret

1. Gå till policyn för & skydd mot **nätfiske** i säkerhets- och \>  \> **efterlevnadscentret.**

2. På huvudsidan **Mot nätfiske ser** personifieringsinsikten ut så här:

   Den här insikten har två lägen:

    - **Insiktsläge:** Om personifieringsskydd är aktiverat och konfigurerat i principer mot nätfiske visar insikten antalet identifierade meddelanden från imiterade avsändare under de senaste sju dagarna. Det här är totalt alla identifierade imiterade avsändare från alla principer mot nätfiske.
   ...
   Oavsett vilket så visar Domäner antalet meddelanden från avsändare i  skyddade domäner, medan användare **imiterade** visar antalet meddelanden från skyddade användare.
...
På personifieringsinsikten klickar du **på Domäner som utger sig för att vara .** Sidan **Personifieringsinformation** som öppnas innehåller följande information:
...
- **Tillåtet att personifiera**: Något av följande värden:
  - **Ja:** Domänen har konfigurerats som betrodd domän (ett undantag för personifieringsskydd) i principen mot skräppost. Meddelanden från avsändare i den imiterade domänen identifierades, men var tillåtna.
  - **Nej:** Domänen har konfigurerats för personifieringsskydd i principen mot skräppost. Meddelanden från avsändare i den imiterade domänen identifierades och agerade utifrån åtgärden för imiterade domäner i principen för skräppostskydd.

Du kan klicka på markerade kolumnrubriker för att sortera resultatet.

Om du vill filtrera resultaten kan du använda **rutan Filtrera** domän till att ange en kommaavgränsad lista med värden för att filtrera resultaten.
...
På sidan **Personifieringsinsikt** väljer du en av de tillgängliga raderna. Den utfällingstext för information som visas innehåller följande information och funktioner:
...
På personifieringsinsikten klickar du **på Användare som utger sig för att vara**. Sidan **Personifieringsinformation** som öppnas innehåller följande information:
...
- **Tillåtet att personifiera**: Något av följande värden:
  - **Ja:** Avsändaren har konfigurerats som betrodd användare (ett undantag för personifieringsskydd) i principen mot skräppost. Meddelanden från den imiterade avsändaren identifierades men var tillåtna.
  - **Nej:** Avsändaren har konfigurerats för personifieringsskydd i principen mot skräppost. Meddelanden från den imiterade avsändaren identifierades och agerade utifrån åtgärden för imiterade användare i principen för skräppostskydd.
