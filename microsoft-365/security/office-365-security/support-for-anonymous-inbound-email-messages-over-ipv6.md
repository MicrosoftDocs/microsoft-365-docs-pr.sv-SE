...
Innan din organisation kan ta emot anonymt inkommande e-postmeddelande via IPv6 måste en administratör kontakta Microsoft-supporten och be om det:

1. Öppna administrationscentret för Microsoft <https://admin.microsoft.com/adminportal/home> 365 och klicka på **Hjälp** (?).

2. Skriv något beskrivande i sökrutan i **hjälpen?**

3. Klicka på **Kontaktstöd**längst ned på sidan .

4. På sidan **Kontakta support** som visas fyller du i och verifierar informationen (bläddra nedåt efter behov) och klickar sedan på **Kontakta mig**.
