...
- **Kontrol lera organisationens inställningar**: se för inställningar som gör att meddelanden kan hoppa över skräp post (om du till exempel lägger till din egen domän i listan över tillåtna domäner i principer för skräp post). För våra rekommenderade inställningar, se [rekommenderade inställningar för EOP och Office 365 ATP Security](recommended-settings-for-eop-and-office365-atp.md) och [skapa säkra avsändare](create-safe-sender-lists-in-office-365.md).
