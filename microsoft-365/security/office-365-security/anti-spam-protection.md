...
- **Kontrollera organisationens inställningar:** Se upp med inställningar som tillåter att meddelanden hoppar över skräppostfiltrering (till exempel om du lägger till en egen domän i listan över tillåtna domäner i principer för skräppostskydd). Vi rekommenderar inställningar i Rekommenderade inställningar för EOP och Microsoft Defender för [Office 365-säkerhet](recommended-settings-for-eop-and-office365-atp.md) och [Skapa listor över betrodda avsändare.](create-safe-sender-lists-in-office-365.md)
