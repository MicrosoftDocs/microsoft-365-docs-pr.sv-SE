...
|**Ören**|Exportera post låda och webbplats innehåll som returneras från sökningar.|Data utredning <p> eDiscovery Manager|
...
|**Automatisk**|Visa en lista med objekt som returneras från innehålls sökningar och öppna varje objekt i listan för att visa dess innehåll.|Data utredning <p> eDiscovery Manager|
...
|**Översikt**|Använd Avancerad eDiscovery för att spåra, tagga, analysera och testa dokument som har kopplats till dem.|Data utredning <p> eDiscovery Manager <p> Granskare|
|**RMS-kryptering**|Dekryptera RMS-skyddat innehåll när du exporterar Sök resultat.|Data utredning <p> eDiscovery Manager|
|**Roll hantering**|Hantera roll grupp medlemskap och skapa eller ta bort anpassade roll grupper.|Organisationshantering|
|**Sök och ta bort**|Gör det möjligt för personer att ta bort data som matchar villkoren i en innehålls sökning.|Data utredning <p> Organisationshantering|
