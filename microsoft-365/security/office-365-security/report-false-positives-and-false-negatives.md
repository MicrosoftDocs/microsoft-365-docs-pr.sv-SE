...
---
# <a name="report-false-positives-and-false-negatives-in-outlook"></a>Rapportera falska positiva och falska negativa resultat i Outlook
...
I Microsoft 365-organisationer som har postlådor i Exchange Online eller lokala postlådor med modern hybridautentisering kan du skicka falska positiva identifieringar (bra e-post som markeras som skräppost) och falska negativa identifieringar (felaktig e-post och nätsmyckning tillåts) till Exchange Online Protection (EOP).

## <a name="things-to-remember-before-you-use-the-report-message-feature"></a>Saker att tänka på innan du använder funktionen Rapportmeddelande

- För bästa möjliga användarinskickning använder du tilläggen Rapportmeddelande eller Rapport nätfiske.

- Observera att det här tillägget fungerar för Outlook på alla plattformar– på webben, iOS, Android och skrivbordet.

- Om du är administratör i en organisation med Exchange Online-postlådor använder du portalen för sändning i säkerhets- & efterlevnadscenter. Mer information finns i Använda [administratörsinskick för att skicka misstänkt skräppost, nättr ut, URL:er och filer till Microsoft.](admin-submission.md)
...
## <a name="enable-the-report-message-and-report-phishing-add-ins"></a>Aktivera tilläggen Rapportmeddelande och Rapport nätfiske
...
om du är global administratör eller Exchange Online-administratör och Exchange är konfigurerat för OAuth-autentisering kan du aktivera tillägget Rapportmeddelande och tillägget Rapportfiske för organisationen. Båda tilläggen är nu tillgängliga via [centraliserad distribution.](../../admin/manage/centralized-deployment-of-add-ins.md)
