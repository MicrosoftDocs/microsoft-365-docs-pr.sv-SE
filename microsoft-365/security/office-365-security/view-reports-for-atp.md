...
I **rapporten filtyper i Defender för Office 365** ser du vilken typ av filer som identifierats som skadliga av [säkra bifogade filer.](atp-safe-attachments.md)
...
- **Visa data efter: Arkiv:** Diagrammet innehåller följande information:
  ...
  När du hovrar över en viss dag (datapunkt) kan du se [](atp-safe-attachments.md) detaljerad information om typer av skadliga filer som identifierats av Säkra bifogade filer och skydd mot [skadlig programvara i EOP.](anti-malware-protection.md)
...
- **Visa data efter: Meddelande:** Diagrammet innehåller följande information:
  ...
  - **Ersatts av Dynamisk e-postleverans:** Mer information finns [i Principer för dynamisk leverans i säkra bifogade filer.](atp-safe-attachments.md#dynamic-delivery-in-safe-attachments-policies)
