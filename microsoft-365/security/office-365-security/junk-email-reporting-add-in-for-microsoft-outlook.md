...
3. De valda meddelandena skickas till Microsoft för analys och flyttas till mappen Skräppost. Om du vill bekräfta att meddelandena har skickats öppnar du mappen **Skickat för** att visa de skickade meddelandena.
...
4. Klicka på **Nästa**på sidan **Välkommen till Microsofts inställningstillägg för skräppostrapportering.**

5. Granska licensavtalet, klicka på **Jag godkänner villkoren i licensavtalet** om du godkänner villkoren och klickar sedan på **Nästa**.
...
Välj nedpilen **bredvid Skräppost** om du vill ha fler alternativ, till exempel **Rapportera som Nätfiske** om du vill rapportera e-postmeddelanden med nätfiskebedrägeri till Microsoft. I skräppostmappen kan du också välja **Rapportera inte skräppost** om ett e-postmeddelande har identifierats felaktigt som skräppost.
