...
- Tillåta eller blockera förfalskning av avsändare i klientorganisationens lista över tillåtna/blockerade: När du åsidosätter omdömet i förfalskningsinformation blir den förfalskningsberättigade avsändaren en manuell tillåta- eller **blockeringspost** som bara visas på fliken **Spoof** i listan Över tillåtna/blockerade klientorganisationen. Du kan även manuellt skapa tillåta eller blockera poster för förfalskningsavsändare innan de identifieras av förfalskningsinformation. Mer information finns i [Hantera listan över tillåtna/blockerade klientorganisationen i EOP.](tenant-allow-block-list.md)
