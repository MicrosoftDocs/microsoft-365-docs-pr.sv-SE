...
Om du är en del av organisationens Microsoft för företag-säkerhetsteam med 365 och har de behörigheter som krävs i Säkerhets- och efterlevnadscenter för [&](permissions-in-the-security-and-compliance-center.md)kan du komma åt olika rapporter, bland annat smarta rapporter och insikter. Läs den här artikeln för att få en översikt över dessa rapporter och insikter, och var du kan gå för att lära dig mer om specifika rapporter.
...
En mängd olika rapporter finns tillgängliga i Säkerhets- & efterlevnadscenter. (Gå till **Rapporter**  >  **Säkerhetsrapport** för att visa hela vyn.) I följande tabell visas tillgängliga rapporter med länkar för mer information:
...
|**Instrumentpanel för hantering** av hot (kallas även för säkerhetsinstrumentpanel) <p> Identifiering av hot, trender mot skadlig programvara, populära användare, information om skickade och mottagna e-postmeddelanden och mer|I Säkerhets- & säkerhets- och efterlevnadscenter går du till **Vulnerability Management** \> **Dashboard**|[Visa rapporter för Defender för Office 365](view-reports-for-mdo.md)|
|**Utforskaren** (kallas även Hotutforskaren) **eller realtidsidentifiering** <p> Misstänkt skadlig kod som upptäckts i e-post och filer i Microsoft 365|I Säkerhets- & säkerhets- och efterlevnadscenter går du till **Vulnerability Management** Explorer eller \>  **identifieringar i realtid**<br> |[Hotutforskaren (eller realtidsidentifieringar)](threat-explorer.md)|
|**Defender för Office 365 säkerhetsrapporter och säkerhetsrapporter för e-post** <p> Rapporter om säkerhet och hot för e-post (inklusive skadlig kod, skräppost, nätfiske och förfalskningsrapporter)|I Säkerhets- & efterlevnadscenter går du till Rapporter  >  **e-& för samarbete**  >  **[E& och samarbetsrapporter](https://security.microsoft.com/emailandcollabreport)**|[Visa rapporter för Defender för Office 365](view-reports-for-mdo.md) <p> [Visa e-postsäkerhetsrapporter i Säkerhets- & Säkerhets- och efterlevnadscenter](view-email-security-reports.md)|
...
|**Granskningslogg** <p> Information om Microsoft 365, användare, filer eller mappar med mera|Gå till sökning & & granskningsloggsökning i säkerhets- & **säkerhets- och** \> **efterlevnadscenter**|[Söka i granskningsloggen i Säkerhets- & Efterlevnadscenter](../../compliance/search-the-audit-log-in-security-and-compliance.md)|
