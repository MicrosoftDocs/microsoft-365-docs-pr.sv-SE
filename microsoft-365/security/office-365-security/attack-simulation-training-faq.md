...
Både nätfiskebedrägeri-URL:er och administratörs-URL:er kan blockeras eller ignoreras av dina mellanliggande säkerhetsenheter eller filter. Ett exempel:
...
Simuleringsrapporter i attackutbildning ger information om användaraktivitet. Ett exempel:
