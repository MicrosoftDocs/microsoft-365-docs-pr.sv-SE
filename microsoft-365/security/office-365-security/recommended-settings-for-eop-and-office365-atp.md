...
>
> - [Skydd av säkra bifogade filer i SharePoint, OneDrive](atp-for-spo-odb-and-teams.md) och Microsoft Teams och skydd för säkra dokument är inte beroende av principer för säkra länkar. [](safe-docs.md)
...
- Använd de här länkarna för information om hur **du konfigurerar** [EOP-tjänsten](set-up-your-eop-service.md) **och konfigurera** Microsoft Defender för [Office 365.](office-365-atp.md) Kom ihåg de användbara anvisningarna i Skydda[mot hot i Office 365.](protect-against-threats.md)
