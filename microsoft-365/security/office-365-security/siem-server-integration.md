...
|[Microsoft Defender för Endpoint](/windows/security/threat-protection/)|HTTPS-slutpunkt med Azure som värd <p> REST API|[Dra aviseringar till dina SIEM-verktyg](/windows/security/threat-protection/microsoft-defender-atp/configure-siem)|
