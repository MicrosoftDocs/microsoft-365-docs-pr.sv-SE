...
## <a name="approve-or-reject-pending-actions"></a>Godkänna (eller avvisa) pågående åtgärder

När du visar [information om en undersökning](air-view-investigation-results.md)kan du godkänna eller avvisa eventuella pågående reparations åtgärder. Vi rekommenderar att du gör det så snart som möjligt så att dina automatiserade utredningar är slutförda.
...
- [Information och resultat från en automatisk undersökning i Office 365](air-view-investigation-results.md)
