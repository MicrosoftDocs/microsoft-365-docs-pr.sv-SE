---
title: Granska och godkänna väntande saneringsåtgärder i automatiserad undersökning och svar
...
> [!IMPORTANT]
> Lämpliga behörigheter krävs för att godkänna eller avvisa reparationsåtgärder. Se [Nödvändiga behörigheter för att använda AIR-funktioner](office-365-air.md#required-permissions-to-use-air-capabilities).
...
- [Använda Hot Explorer](threat-explorer.md)
