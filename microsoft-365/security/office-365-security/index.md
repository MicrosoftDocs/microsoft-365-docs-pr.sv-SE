...
Om du vill gå in på information om Microsoft Defender för Office 365 P1 och P2 kan du **[hoppa till den här artikeln](office-365-atp.md)**.
...
[Läs mer om specifika rekommenderade “gyllene” konfigurationer ](recommended-settings-for-eop-and-office365-atp.md) och [använda rekommenderade förval för att snabbt konfigurera säkerhetsprinciper](preset-security-policies.md)

Komma i kapp med [nyheter i Microsoft Defender för Office 365 (inklusive EOP-utveckling)](whats-new-in-office-365-atp.md)
