...
1. I din webbläsare går du till Azure-portalen <https://portal.azure.com> och loggar in med autentiseringsuppgifterna för ett konto som har tilldelats användar hanterings administratören eller administratörs rollen för administratörer.
...
1. Lägg till listan med användare från steg 1 i gruppen webbplats administratörer.
2. Lägg till listan med användare från steg 2 till gruppen webbplats medlemmar.
3. Lägg till listan med användare från steg 3 i gruppen webbplats visnings program.
