...
- **Principer för Microsoft Defender för Office 365:** Detta omfattar organisationer med Microsoft 365 E5 eller Defender för tilläggsprenumerationer för Office 365:
  ...
  - [Principer för säkra länkar](set-up-safe-links-policies.md) **med standard förvald säkerhetsprincip** **och strikt förinställd säkerhetsprincip.**

  - [Principer för säkra bifogade](set-up-safe-attachments-policies.md) filer **med standard förvald säkerhetsprincip** **och strikt förinställd säkerhetsprincip.**
