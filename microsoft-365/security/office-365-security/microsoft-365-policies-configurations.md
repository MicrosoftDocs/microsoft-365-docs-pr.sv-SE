...
- Är i linje med [Microsoft Secure Score](../mtp/microsoft-secure-score.md) samt [identitetspoäng i Azure AD](/azure/active-directory/fundamentals/identity-secure-score), och kommer att öka dessa resultat för din organisation.
