...
- Kör Secure Score månadsvis [för](../mtp/microsoft-secure-score.md) att utvärdera organisationens säkerhetsinställningar.
...
- Gå regelbundet igenom [rapporten om hotskyddsstatus](view-reports-for-atp.md#threat-protection-status-report).
