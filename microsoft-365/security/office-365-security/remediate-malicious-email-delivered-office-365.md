...
- **Åtgärdsloggar:** På den här fliken visas de meddelanden som har åtgärdats, inklusive godkänt datum, administratör som godkänt åtgärden, åtgärden, status och antal.
  ...
  Om du åtgärdar stora batchar kan du också exportera meddelandena som skickas för åtgärd via e-postinskick och meddelanden som har åtgärdats via åtgärdsloggar. Exportgränsen ökas till 100 000 poster.
