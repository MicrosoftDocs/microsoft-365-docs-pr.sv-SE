...
Kolumnerna som visas i e-postrutnätet innehåller alla Taggar som har använts för avsändaren eller mottagarna. Som standard visas systemtaggar som prioritets konton först.
...
- Med rapporten **real tids identifiering** kan du Visa identifiering i real tid. **Threat Explorer** fungerar också, men du kan även visa ytterligare information om en viss attack.
