...
1. En automatiserad undersökning initieras på något av följande sätt:
   ...
   - En säkerhetsanalytiker startar [en automatiserad undersökning med](automated-investigation-response-office.md#example-a-security-administrator-triggers-an-investigation-from-threat-explorer) hjälp av [Utforskaren.](threat-explorer.md)
...
> [!TIP]
> Mer information om aviseringsprinciper och hur du redigerar standardinställningarna finns [i Aviseringsprinciper i Microsoft 365 Efterlevnadscenter](../../compliance/alert-policies.md).
...
|Starta en automatiserad undersökning <p> --- eller --- <p> Godkänna eller avvisa rekommenderade åtgärder|En av följande roller, tilldelade i [Azure Active Directory](/azure/active-directory/users-groups-roles/directory-assign-admin-roles) eller i [Microsoft 365 Defender portalen:](permissions-microsoft-365-security-center.md) <ul><li>Global administratör</li><li>Säkerhetsadministratör</li><li>Säkerhetsoperatör</li><li>Säkerhetsläsare <br> --- och --- </li><li>Sökning och rensning (den här rollen tilldelas endast i [Microsoft 365 Defender portalen](permissions-microsoft-365-security-center.md). Du kan behöva skapa en ny **e&** för samarbete där och lägga till rollen Sök och rensa i den nya rollgruppen.</li></ul>|
...
Den nya och förbättrade Microsoft 365 Defender-portalen sammanför AIR-funktioner i [Microsoft Defender](defender-for-office-365.md) för Office 365 och i Microsoft Defender [för slutpunkt.](../defender-endpoint/automated-investigations.md) Med de här uppdateringarna och förbättringarna kommer säkerhetsgruppen att kunna visa information om automatiska undersökningar och åtgärder som gäller för e-post, samarbetsinnehåll, användarkonton och enheter, allt på ett och samma ställe.

> [!TIP]
> Den nya Microsoft 365 Microsoft 365 Defender <https://security.microsoft.com> () ersätter följande center:
>
...
|**Fliken Enheter**|Fliken **Enheter** har ett flikformat med en sammanfattningsvy och möjligheten att filtrera efter entitetstyp. Fliken **Enheter** innehåller nu alternativet **Sök** efter förutom alternativet Öppna **i Utforskaren.** Nu kan du använda [Utforskaren](threat-explorer.md) eller [avancerad sökning](../defender-endpoint/advanced-hunting-overview.md) för att hitta enheter och hot och filtrera på resultat.|
...
|**Åtgärdscenter**|I det **uppdaterade åtgärdscentret** <https://security.microsoft.com/action-center> () samlas väntande och slutförda åtgärder via e-post, enheter och identiteter. Mer information finns i Åtgärdscenter. (Mer information finns [i Åtgärdscenter](../defender/m365d-action-center.md).)|
