...
> [!TIP]
> En mer detaljerad översikt över [hur Air fungerar](automated-investigation-response-office.md).

## <a name="how-to-get-air"></a>Så här kommer du till luften

AIR-funktioner ingår i [Microsoft Defender för Office 365](office-365-atp.md#microsoft-defender-for-office-365-plan-1-and-plan-2), förutsatt att dina principer och aviseringar är konfigurerade. Om du vill ha hjälp med det här följer du anvisningarna i [skydda mot hot](protect-against-threats.md) för att konfigurera eller konfigurera följande skydds inställningar:
...
2. [Principer för antispionprogram](protect-against-threats.md#part-1---anti-malware-protection)

3. [Skydd mot nätfiske](protect-against-threats.md#part-2---anti-phishing-protection)

4. [Antispam skydd](protect-against-threats.md#part-3---anti-spam-protection).
...
6. [Säkra bilagor för SharePoint, OneDrive och Microsoft Teams](protect-against-threats.md#part-5---verify-atp-for-sharepoint-onedrive-and-microsoft-teams-is-turned-on).

7. [Rensa tom timme för e-post](protect-against-threats.md#zero-hour-auto-purge-for-email-in-eop).
...
[Microsoft Defender för Office 365 abonnemang 2](office-365-atp.md#microsoft-defender-for-office-365-plan-1-and-plan-2) -licenser ska tilldelas:
...
- [Visa information och resultat från en automatisk undersökning](air-view-investigation-results.md#view-details-of-an-investigation)

- [Granska och godkänna pågående åtgärder](air-remediation-actions.md)
