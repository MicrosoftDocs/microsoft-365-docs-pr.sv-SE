...
3. **Ett partnerteam:** Detta är ett team där du kan samordna med dina leverantörer, partners eller volontärer utan att tillåta dem i något känsligt.

Du kan också skapa team för specifika projekt och tillämpa rätt mängd skydd baserat på vem som ska inkluderas. 
...
När du skapar ett team skapas det här:

- En ny [Microsoft 365-grupp](https://docs.microsoft.com/MicrosoftTeams/office-365-groups)
- En [SharePoint Online-webbplats](https://docs.microsoft.com/MicrosoftTeams/sharepoint-onedrive-interact) och ett dokumentbibliotek för att lagra gruppfiler
- En delad [Exchange Online-postlåda](https://docs.microsoft.com/MicrosoftTeams/exchange-teams-interact) och kalender
- En OneNote-anteckningsbok
- Knyten till andra Office 365-appar som Planner och Power BI
...
4. **Aktivitet:** Håll er på alla olästa meddelanden, @mentions, svar med mera. 
...
Skapa ett privat team för bara kampanjchefen och kandidaten så här. 

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RWeqWA]

Skapa ett organisationsomfattande team som alla i kampanjen kan använda för att kommunicera och dela filer.

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE2GCG9]

Skapa ett team som du delar med gäster utanför kampanjen, till exempel reklam för finansiering.

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE1FQMp]

Läs mer om [teknisk dokumentation](https://docs.microsoft.com/microsoftteams/microsoft-teams) för Microsoft Teams på Microsoft Teams
