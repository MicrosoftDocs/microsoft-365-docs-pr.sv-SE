...
- MET150
- MOE150
description: Läs om hur de här säkerhetsrekommendationerna för Microsoft 365 Business Premium påverkar användarna och skyddar dina data.
...
- Öppna endast säkra länkar och bifogade filer, som verifierats med hjälp av säkra länkar och säkra bifogade filer.
...
- Använd Microsoft-mobilappar, till exempel Outlook Mobile, Word, OneDrive och andra Microsoft-appar från appbutiken. De inbyggda e-postapparna som ingår på iPhone- och Android-enheter stöds inte. 
...
## <a name="keep-byod-macs-and-windows-10-pcs-fresh"></a>Håll BYOD För Mac-datorer och Windows 10-datorer helt nya
