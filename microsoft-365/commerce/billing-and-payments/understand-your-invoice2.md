...
|Pris per månad|Prenumerationer faktureras per månad eller per år. Om du väljer månadsfakturering under prenumerationsköpet visas det månatliga licenspriset på fakturan. Om du vill ändra faktureringsfrekvensen måste du avbryta prenumerationen och köpa den på nytt med den nya faktureringsfrekvensen.|
...
5. Längst ned i fönstret **Redigera betalningsinformation** anger du ditt inköpsordernummer och väljer sedan **Spara**.
