...
ms.locfileid: "42811926"
---
# <a name="add-storage-space-for-your-subscription"></a>Lägga till lagringsutrymme för din prenumeration

Om du börjar få på lagringsutrymme för dina SharePoint Online-webbplatssamlingar kan du lägga till lagringsutrymme i din prenumeration om ditt abonnemang är kvalificerat. Om du inte ser extra fillagring för **Office 365** i listan över tillgängliga tillägg betyder det att ditt abonnemang inte är kvalificerat. Mer information finns i [Är min plan berättigad?](#is-my-plan-eligible-for-office-365-extra-file-storage)
...
## <a name="increase-or-decrease-storage"></a>Öka eller minska lagringsutrymmet
