...
2. På sidan **Prenumeration** väljer du **Lägg till prenumerationer**.
    ...
    Prenumerationerna som är tillgängliga för din organisation visas. Alla prenumerationer som du redan har köpt identifieras på det här sätt.
...
3. Musen över eller tryck på den prenumeration som du vill köpa och välj sedan **Köp nu**.
