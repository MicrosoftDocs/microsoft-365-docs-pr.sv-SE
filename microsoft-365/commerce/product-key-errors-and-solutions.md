...
| "Den begärda prenumerationen är inte tillgänglig. En av följande orsaker kan ha orsakat detta: Erbjudandet är inte tillgängligt - Tjänsten är inte tillgänglig i ditt land - Det är omöjligt att använda / välja samma testperiod två gånger. Om problemet kvarstår kontaktar du Microsoft-supporten." | Kontakta [supporten](../admin/contact-support-for-business-products.md). Om du arbetar med en partner kontaktar du din partner för support. |
...
> [!NOTE]
> När du köper Microsoft 365 via en partner skickar Microsoft ett e-postmeddelande med instruktioner för att hämta produktnyckeln och aktivera din prenumeration i [Volymlicensieringstjänstcenter](https://go.microsoft.com/fwlink/p/?LinkID=282016). Mer information om volymlicenser finns i [Hjälp för befintliga volymlicenskunder](https://go.microsoft.com/fwlink/p/?LinkId=534992). 
