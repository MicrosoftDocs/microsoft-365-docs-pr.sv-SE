...
2. Leta reda på den utvärderingsprenumeration som du vill utöka på sidan **Dina produkter.** I avsnittet **Inställningar & Åtgärder** väljer du Utöka **utvärderingsversion**.

3. Granska tilläggsinformationen och ändra betalningsmetoden om det behövs. När du är klar väljer du **Utöka utvärderingsversionen**.
...
2. På sidan Prenumerationer väljer du den **utvärderingsprenumeration** som du vill utöka och väljer sedan **Utöka utvärderingsversionen**under utgångsdatumet.
...
När du är redo att köpa läser du [Köp din utvärderingsversion](buy-a-subscription-from-your-free-trial.md).
