...
2. På **supportärenden**väljer du **+ Ny supportbiljett**.
...
--- | ---
Incident | Du måste undersöka Microsoft Managed Desktop Operations Team, till exempel omfattande effekter av en ändrings- eller säkerhetsincident.
...
Vi uppskattar din feedback och använder den för att förbättra administratörens supportupplevelse.
