...
Du kan ta bort enheter från Microsoft Hanterad dator med hjälp av administrationsportalen. Den här åtgärden är permanent, men du kan registrera dem i Microsoft Managed Desktop igen genom att följa [registreringsstegen.](../get-started/register-devices-self.md)
...
2. Titta efter avsnittet **Microsoft Managed Desktop** på menyn och välj **Enheter**.
3. I arbetsytan Microsoft Hanterade skrivbordsenheter väljer du de enheter du vill ta bort.
