...
Ny eller ändrad artikel | Beskrivning
--- | ---
[Få hjälp för slutanvändare](working-with-managed-desktop/end-user-support.md) | Uppdaterad artikel
[Steg för partner för att registrera enheter](get-started/register-devices-partner.md) | Uppdaterad artikel
[Microsoft Hanterade skrivbordsenheter](service-description/device-list.md) | Uppdaterad artikel
...
[Regioner och språk som stöds av Microsoft Managed Desktop](service-description/regions-languages.md) | Uppdaterad artikel
...
[Steg för partner för att registrera enheter](get-started/register-devices-partner.md)| Uppdaterad artikel
[Registrera nya enheter själv](get-started/register-devices-self.md) | Uppdaterad artikel
[Förbereda skrivarresurser för Microsoft Hanterat skrivbord](get-ready/printing.md) | Ny artikel
...
[Så här hanteras uppdateringar på Microsoft Managed Desktop](service-description/updates.md) | Uppdaterad artikel
[Microsoft Managed Desktop-enhetstjänster](service-description/device-services.md) | Uppdaterad artikel
...
[Lägga till och verifiera administratörskontakter i administratörsportalen](get-started/add-admin-contacts.md) | Uppdaterad artikel
[Enhetskonfiguration](service-description/device-policies.md) | Uppdaterad artikel
...
[Microsoft Hanterade skrivbordsenheter](service-description/device-list.md) | Uppdaterad artikel
[Microsoft Hanterade skrivbord arkiverade enheter](service-description/archived-device-list.md) | Uppdaterad artikel
...
[Microsoft Hanterade skrivbordsenheter](service-description/device-list.md) | Uppdaterad artikel
[Microsofts huvudsida för hanterade skrivbord](https://docs.microsoft.com/microsoft-365/managed-desktop/) | Uppdaterad artikel
...
Ny eller ändrad artikel | Beskrivning
--- | ---
[Undantag från tjänstplanen](service-description/customizing.md) | Ny artikel
[Få hjälp för slutanvändare](working-with-managed-desktop/end-user-support.md) | Uppdaterad artikel
[Admin-support för Microsoft Hanterat skrivbord](working-with-managed-desktop/admin-support.md) | Uppdaterad artikel
...
Ny eller ändrad artikel | Beskrivning
--- | ---
[Arbeta med Microsoft Consulting Services](get-ready/apps-mcs.md) | Uppdaterad artikel
[Admin-support för Microsoft Hanterat skrivbord](working-with-managed-desktop/admin-support.md) | Uppdaterad artikel
[Få hjälp för slutanvändare](working-with-managed-desktop/end-user-support.md) | Uppdaterad artikel
[Förutsättningar för Microsoft Hanterat skrivbord](get-ready/prerequisites.md) | Uppdaterad artikel
[Teknologier i Microsoft Hanterat skrivbord](intro/technologies.md) | Uppdaterad artikel
...
--- | ---
[Arbeta med Microsoft Consulting Services](get-ready/apps-mcs.md) | Uppdaterad artikel
[Microsoft Hanterat skrivbord och ITIL](MMD-and-ITSM.md) | Ny artikel
[Enhetskonfiguration](service-description/device-policies.md) | Uppdaterad artikel
...
[Microsoft Managed Desktop-produktlivscykel](service-description/device-lifecycle.md) | Ny artikel
...
[Regioner och språk som stöds av Microsoft Managed Desktop](service-description/regions-languages.md) | Uppdaterad artikel
[Microsoft Hanterade skrivbordsenheter](service-description/device-list.md) | Uppdaterad artikel
[Microsoft Hanterade skrivbord arkiverade enheter](service-description/archived-device-list.md) | Ny artikel
...
[Beställ Microsoft Managed Desktop-enheter](get-started/devices.md) | Uppdaterad artikel
[Få hjälp för slutanvändare](working-with-managed-desktop/end-user-support.md) | Ny artikel

## <a name="april-2019"></a>April 2019
Ny eller ändrad artikel | Beskrivning
--- | ---
[Installera Intune Company Portal på Microsoft Managed Desktop-enheter](get-started/company-portal.md) | Ny artikel
[Installera Microsoft Project och Microsoft Visio på Microsoft Managed Desktop-enheter](get-started/project-visio.md) | Ny artikel 
...
[Registrera enheter i Microsoft Managed Desktop for Partners](get-started/register-devices-partner.md) | Ny artikel
[Distribuera appar till Microsoft Managed Desktop-enheter](get-started/deploy-apps.md) | Uppdaterad artikel
...
Ny eller ändrad artikel | Beskrivning
--- | ---
[Programenheter](service-description/device-list.md) | Uppdaterad med stöd för vissa Dell- och HP-enheter.
[Översikt över konfigurerbara inställningar](working-with-managed-desktop/config-setting-overview.md) | Ny artikel
[Referens för inställningar som kan konfigureras](working-with-managed-desktop/config-setting-ref.md) | Ny artikel
[Spåra och distribuera konfigurerbara inställningar](working-with-managed-desktop/config-setting-deploy.md) | Ny artikel
[Komma igång med enheter](get-started/get-started-devices.md) | Ny artikel

## <a name="january-2019"></a>Januari 2019
Ny eller ändrad artikel | Beskrivning
--- | ---
[Distribuera appar för Microsoft Managed Desktop-enheter](get-started/deploy-apps.md) | Ny artikel.
[Hantera appar för Microsoft Managed Desktop](working-with-managed-desktop/manage-apps.md) | Uppdaterad med information om hur du uppdaterar eller återställer till en tidigare version av affärsappar. 

## <a name="december-2018"></a>I december 2018
Ny eller ändrad artikel | Beskrivning
--- | ---
[Drift och övervakning för Microsoft Managed Desktop](service-description/operations-and-monitoring.md) | Lade till ansvarsbalanstabell och uppdaterade andra tabeller.
[Admin-support för Microsoft Hanterat skrivbord](working-with-managed-desktop/admin-support.md) | Uppdaterade supporttyper, allvarlighetsgrad förklaringar och ytterligare information.

## <a name="november-2018"></a>I november 2018

Ny eller ändrad artikel | Beskrivning
--- | ---
[Stöd för Microsoft Managed Desktop](service-description/support.md)<br />och [slutanvändarstöd för Microsoft Managed Desktop](working-with-managed-desktop/end-user-support.md) | Uppdaterad för att inkludera Australien.

## <a name="october-30-2018"></a>den 30 oktober 2018
Innehåll omorganiserat: lagt till avsnitt för [Microsoft Managed Desktop-tjänstbeskrivning](service-description/index.md). 
