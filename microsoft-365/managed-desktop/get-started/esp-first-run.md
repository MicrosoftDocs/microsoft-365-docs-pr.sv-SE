...
Microsoft Hanterat skrivbord använder både [Windows Autopilot](/windows/deployment/windows-autopilot/windows-autopilot) och Microsoft Intune:s [ESP (Enrollment Status Page)](/windows/deployment/windows-autopilot/enrollment-status) för att ge användarna bästa möjliga förstahandsupplevelse.
...
För att kunna tillhandahålla ESP-upplevelsen måste du registrera enheter Microsoft Hanterat skrivbord tjänsten. Mer information om registrering finns i Registrera [nya enheter själv eller](../get-started/register-devices-self.md) Anvisningar för partner för att registrera [enheter.](../get-started/register-devices-partner.md)

När enheterna är registrerade med tjänsten kan du aktivera ESP för dina Microsoft Hanterat skrivbord-enheter genom att spara ett support ärende via [administrationsportalen.](https://portal.azure.com/) Vi kommer först att distribuera ESP-konfigurationen till testgruppen när du arkiverar biljetten. Den distribueras till andra efterföljande distributionsgrupper (Första, Snabb och Bred) var 24:e timme. Om du vill pausa distributionen arkiverar du ett annat ärende där åtgärder ska pausas.
...
Microsoft Hanterat skrivbord följande inställningar för läget Statussida för registrering:
...
2. Enheten öppnar statussidan Registrering och fortsätter genom faserna Förberedelse av enhet och Enhetskonfiguration. Det tredje steget (Kontokonfiguration) *hoppas för närvarande över i* konfigurationen Microsoft Hanterat skrivbord eftersom Esp för användare är inaktiverad. Enheten startar om.
3. Efter omstarten öppnar enheten inloggningssidan Windows andra användaren **.**
...
> [!NOTE]
> Autopilot för förhandsdistribution i Microsoft Hanterat skrivbord finns för närvarande i offentlig förhandsversion.
...
- Om du har enheter som registrerats med Microsoft Hanterat skrivbord-portalen innan augusti 2020 måste du avregistrera dig och registrera dem igen.
- Enheter måste ha en fabriksavbildning som innehåller den kumulativa uppdateringen för november 2020 [19H1/19H2 2020.11C](https://support.microsoft.com/topic/november-19-2020-kb4586819-os-builds-18362-1237-and-18363-1237-preview-25cbb849-74af-b8b8-29b8-68aa925e8cc3) eller [20H1 2020.11C](https://support.microsoft.com/topic/november-30-2020-kb4586853-os-builds-19041-662-and-19042-662-preview-8fb07fb8-a7dd-ea62-d65e-3305da09f92e) efter behov installerat eller måste uppdateras med den senaste Microsoft Hanterat skrivbord-bilden.
- Fysiska enheter måste ha stöd för TPM 2.0 och enhetsövning. Virtuella datorer stöds inte. Före etableringsprocessen använder själv Windows i Autopilot, så TPM 2.0 krävs. För TPM-attestationsprocessen krävs också åtkomst till en uppsättning HTTPS-URL:er som är unika för varje TPM-provider. Mer information finns i posten för Autopilot-självdistributionsläge och föreetablering av Autopilot i [Windows nätverkskrav för Autopilot.](/mem/autopilot/networking-requirements#tpm)
...
2. IT-administratören startar enheten, når den indeade upplevelsen och trycker på Windows fem gånger.
3. IT-administratören väljer Windows Provisioning för Autopilot och väljer sedan **Fortsätt.** På Windows I Autopilot-konfigurationsskärmen visas information om enheten.
4. IT-administratören väljer **Etablera** för att starta etableringsprocessen.
5. Enheten startar ESP och går igenom enhetsförberedelser och konfigurationsfaser. Under installationsfasen för enheten visas x av **x** (beroende på den exakta konfigurationen av ESP-profilen).
6. Steget för kontokonfiguration hoppas för närvarande över i Microsoft Hanterat skrivbord konfiguration, eftersom vi inaktiverar User ESP.
7. Enheten startar om.
...
Om konfigurationen som används av Microsoft Hanterat skrivbord dina behov inte exakt motsvarar dina behov kan du arkivera ett support ärende via [administratörsportalen.](https://portal.azure.com/) Här är några exempel på de konfigurationstyper du kan behöva:

### <a name="autopilot-settings-change"></a>Ändring av Autopilot-inställningar

Du kanske vill begära en annan mall med enhetsnamn. Du kan däremot inte ändra distributionsläge, ansluta till Azure AD As, Inställningar eller Användarkontotyp.
