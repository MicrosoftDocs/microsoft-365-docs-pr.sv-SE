...
> [!NOTE]
> Men du väljer att använda Microsoft Managed Desktop, i [Microsoft slut punkts Manager](https://endpoint.microsoft.com/) eller [Azure-portalen](https://portal.azure.com), följande webbläsare stöds:
...
För att göra det lättare att hantera inbyggda roller finns det en säkerhets grupp för varje anpassad roll (till exempel "moderna arbets plats roller – säkerhets chef"). Följ de här stegen om du vill tilldela användare till en av säkerhets grupperna:
...
4.  Välj **medlemmar** till vänster och välj sedan **+ Lägg till medlemmar** i kommando fältet.
5.  Ange e-postmeddelandet för den person som ska läggas till. Om det är en gäst måste du bjuda in dem innan du kan tilldela gruppen.
