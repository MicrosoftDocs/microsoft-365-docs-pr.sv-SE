...
Du har vissa principer för multifaktorautentisering som angetts **som** obligatoriska för villkorsstyrda åtkomstprinciper som har tilldelats till alla användare. Under registrering exkluderar vi Microsoft Hanterade skrivbordskonton från relevanta villkorsstyrda åtkomstprinciper och tillämpar nya villkorsstyrda åtkomstprinciper för att begränsa åtkomsten till dessa konton. Mer information om de här tjänstkontona finns [i Standard-operativsystem.](../service-description/operations-and-monitoring.md#standard-operating-procedures)

**Rådgivning**

Du har multifaktorautentisering som krävs för villkorsstyrda åtkomstprinciper som kan hindra Microsoft Hanterat skrivbord från att hantera Microsofts tjänst för hanterade skrivbordet. Under registreringen exkluderar vi Microsofts hanterade skrivbordskonton från relevanta villkorsstyrda åtkomstprinciper och tillämpar nya villkorsstyrda åtkomstprinciper för att begränsa åtkomsten till dessa konton. Mer information om de här tjänstkontona finns [i Standard-operativsystem.](../service-description/operations-and-monitoring.md#standard-operating-procedures)
...
Information om hur du kontrollerar en inställning som (om inställningen är "falskt") kan förhindra att Företagstillståndsroaming fungerar korrekt.
...
### <a name="microsoft-managed-desktop-service-accounts"></a>Microsofts tjänstkonton för hanterad stationär dator

Vissa kontonamn kan vara i konflikt med kontonamn som skapats av Microsoft Hanterat skrivbord för att hantera tjänsten Microsoft Managed Desktop.
...
Microsoft Managed Desktop-användare har inte lokal administratörsbehörighet på sina Microsoft Managed Desktop-enheter efter registrering.
