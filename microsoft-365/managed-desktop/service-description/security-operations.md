...
- SOC för hot-och säkerhets problem för sårbarhet använder vissa av Microsofts tjänster för att hjälpa dig att skydda dig mot hot. SOC använder data från ditt säkerhets Center för Microsoft Defender Avancerat skydd och från relevanta sårbarhets data källor inom och utanför Microsoft för att upptäcka säkerhets problem och felkonfigurationer och för att tillhandahålla åtgärdade rapporter.
