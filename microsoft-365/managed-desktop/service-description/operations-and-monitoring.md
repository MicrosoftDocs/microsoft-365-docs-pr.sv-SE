...
BitLocker är en viktig del av datasäkerheten i den här processen. Med BitLocker kryptering på Microsoft Hanterat skrivbord enheter förblir data på enheten säkra även efter att enheten har fabriksåterställts. Data som fanns på enheten blir inte tillgängliga för nästa användare av enheten. Mer information finns i [BitLocker översikt](/windows/security/information-protection/bitlocker/bitlocker-overview).
