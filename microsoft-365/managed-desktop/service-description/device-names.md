...
Microsoft Hanterat skrivbord använder Windows Autopilot, Azure Active Directory och Microsoft Intune. För att de här tjänsterna ska kunna samarbeta smidigt måste enheterna ha konsekventa och standardiserade namn. Microsoft Hanterat skrivbord ett standardiserat namnformat (av formuläret *MMD-%SLUMP11)* när enheter registreras. Windows Autopilot tilldelar dessa namn. Mer information om Autopilot finns i [First-run-upplevelsen med Autopilot och registreringsstatussidan.](../get-started/esp-first-run.md)

## <a name="automated-name-changes"></a>Automatiserade namnändringar

Om en enhet byter namn senare Microsoft Hanterat skrivbord automatiskt namnet till ett nytt namn i standardiserat format. Den här processen sker var fjärde timme. Namnändringen sker nästa gång användaren startar om enheten.
