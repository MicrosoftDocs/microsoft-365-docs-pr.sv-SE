...
Windows Defender Brandvägg med avancerad säkerhet | Värdbaserad, tvåvägsfiltrering av nätverkstrafik för en enhet, Windows Defender brandvägg blockerar obehörig nätverkstrafik som går in i eller ut från den lokala enheten. Mer information finns i Windows Defender [med avancerad säkerhet.](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security)
