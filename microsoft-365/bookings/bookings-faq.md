...
### <a name="can-i-use-bookings-even-if-i-dont-have-a-web-page-for-my-business"></a>Kan jag använda bokningar även om jag inte har en webb sida för företaget?
...
### <a name="is-bookings-customizable"></a>Är bokningar anpassningsbara?
...
### <a name="is-all-the-functionality-of-the-original-bookings-web-app-available-in-microsoft-teams"></a>Finns alla funktioner i det ursprungliga webb programmet i Microsoft Teams?
...
### <a name="is-bookings-a-small-business-offering-or-an-enterprise-offering-or-both"></a>Är det bara att boka ett företag eller en företags tjänst?
...
### <a name="can-my-employees-use-bookings-without-a-microsoft-365-account"></a>Kan mina anställda använda bokningar utan ett Microsoft 365-konto?
...
### <a name="can-i-create-more-than-one-bookings-calendar-under-the-same-microsoft-365-account-and-switch-between-them"></a>Kan jag skapa fler än en kalender under samma Microsoft 365-konto och växla mellan dem?
...
## <a name="product-features"></a>Produkt funktioner

### <a name="where-do-bookings-calendars-show-up-in-my-microsoft-365-tenant"></a>Var visas kalendrar i min Microsoft 365-klient organisation? * *
...
### <a name="can-i-delete-a-previously-created-bookings-calendar"></a>Kan jag ta bort en tidigare skapad kalender?

Du måste ta bort den associerade post lådan i Exchange för att kunna ta bort en kalender.

### <a name="if-i-create-a-calendar-and-someone-else-has-access-to-bookings-would-they-be-able-to-see-my-calendar"></a>Om jag skapar en kalender och någon annan har till gång till bokningar kan han eller hon se min kalender?
...
### <a name="are-video-conferencing-meetings-integrated-into-the-bookings-app"></a>Är video konferens möten integrerade i programmet bokningar?
...
### <a name="how-does-scheduling-policy-work"></a>Hur fungerar schemaläggnings princip?
...
### <a name="how-can-bookings-appointments-show-up-on-a-persons-calendar"></a>Hur kan de avtalade tider visas i en persons kalender?
...
### <a name="what-triggers-service-provider-or-staff-and-customer-emails"></a>Vilken utlösare är tjänste leverantör eller personal och kund e-post?
...
### <a name="can-i-book-classroom-style-appointments-that-are-1many-instead-of-11"></a>Kan jag boka avtalade tider i klass rummet som är 1: många i stället för 1:1?
...
### <a name="can-calendars-remain-unpublished-not-public-facing-but-still-accessible-to-designated-users"></a>Kan kalendrar förbli avpublicerade (inte publikt), men är ändå tillgängliga för avsedda användare?
...
### <a name="can-i-turn-off-the-email-notifications-for-time-off"></a>Kan jag stänga av e-postaviseringar för timeout?
...
### <a name="is-it-possible-to-share-only-one-service-on-the-self-service-page-at-a-time"></a>Är det möjligt att bara dela en tjänst på självbetjänings sidan åt gången?
...
### <a name="what-options-are-available-for-embedding-a-consent-form-or-disclosure-for-those-booking-an-appointment"></a>Vilka alternativ finns det för att bädda in ett godkännande formulär eller upplysning om en avtalad tid?
...
### <a name="what-changes-can-be-made-to-the-staff-selection-capability-on-the-self-service-booking-page"></a>Vilka ändringar kan göras för personal urvals funktionen på sidan självbetjänings bokning?
...
### <a name="can-bookings-support-many-concurrent-booking-requests-and-self-service-page-visits"></a>Kan bokningar hantera flera samtidiga boknings förfrågningar och självbetjänings sidor?
...
### <a name="where-is-bookings-data-stored"></a>Var lagras uppgifter i bokningarna?
...
### <a name="is-there-a-way-to-centrally-manage-bookings-calendars-for-all-users"></a>Finns det något sätt att centralt hantera kalendrar för alla användare?
...
### <a name="is-there-the-ability-to-customize-email-addresses-for-customer-replies"></a>Är det möjligt att anpassa e-postadresser för kund svar?
...
### <a name="we-would-like-for-the-customer-to-accept-our-terms-and-conditions-during-the-booking-process-is-that-possible"></a>Vi skulle vilja för kunden att acceptera våra villkor under boknings processen. Är det möjligt?
...
### <a name="how-can-bookings-associated-mailboxes-in-exchange-be-identified"></a>Hur kan bokningar-associerade post lådor i Exchange identifieras?
...
### <a name="how-are-staff-assigned-to-appointments-when-anyone-is-selected-or-when-customers-do-not-have-the-ability-to-choose-a-staff-member-for-the-appointment"></a>Hur är personal tilldelad till avtalade tider när "alla" är markerad, eller när kunder inte har möjlighet att välja en personal medlem för den avtalade tiden?
...
### <a name="how-can-users-opt-out-of-receiving-sms-messages-if-they-have-already-opted-in-previously"></a>Hur kan användarna avanmäla SMS-meddelanden om de redan har valt tidigare?
...
### <a name="this-staff-members-calendar-cant-be-synced"></a>Den här personal medlemmens kalender kan inte synkroniseras
...
### <a name="the-staff-member-needs-to-change-their-calendar-permissions"></a>Personal medlemmen måste ändra sina kalender behörigheter
