...
---
# <a name="contosos-covid-19-response-and-support-for-a-hybrid-workforce"></a>Contosos COVID – 19 svar och support för en hybrid arbets styrka
...
## <a name="contosos-support-for-a-dynamic-hybrid-workforce"></a>Organisationens support för en dynamisk hybrid arbets styrka

Efter det att de ursprungliga ändringarna har gjorts till stöd som var och en av de flesta fjärranställdaer under regionala låsningar, har contoso infrastruktur ändringar för att stödja en hybrid arbets styrka där en anställd kan vara:
