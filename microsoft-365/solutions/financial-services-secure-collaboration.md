...
_*_Skyddet av åtkomst till kundinformation, finansiella dokument och program börjar med att skydda användaridentiteter._*_ Det kräver en säker plattform där företaget kan lagra och hantera identiteter, ett tillförlitligt sätt att autentisera, och dynamiskt styra åtkomsten till de programmen.
...
***Microsoft 365 tillhandahåller flexibla funktioner för att definiera kvarhållningsetiketter och principer för att smart implementera kraven för hantering av arkivhandlingar** _En arkivhandlingansvarig definierar en kvarhållningsetikett som representerar en "posttyp" i ett traditionellt kvarhållningsschema. Lagringsetiketten har inställningar som definierar den här informationen:
