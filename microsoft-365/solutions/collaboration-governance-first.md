...
- Hur ger verktyg och funktioner värde till hela organisationen och för enskilda anställda?
...
- Stöds extern delning och i vilka scenarier? [Läs mer om extern delning](./collaborate-with-people-outside-your-organization.md).
...
- **Informationsgranskning** – hantera innehåll under hela livscykeln och behandla information som en tillgång, inklusive hantering av arkivhandlingar, efterlevnad och säkerhet. För Informationsgranskning krävs att du förstår både affärsmål och reglerande krav. Under idealiska förhållanden bör du använda automatiserade principer som hindrar användare från att göra misstag eller varna dem i scenarier där de behöver fatta ett välgrundat beslut. Där det inte är möjligt att genomdriva en princip måste du planera för utbildning och utbildning.

- **Resultatgranskning** – att säkerställa att webbplats- eller teamägare har rätt behörighet för att uppnå affärsresultat. Resultatgranskning handlar till stor del om att tillhandahålla vägledning till innehållsförfattare och webbplats-, grupp- och teamägare – att se till att rätt utbildning är tillgänglig för att säkerställa att de vet hur de ska göra bra val för att få önskat resultat i övergripande organisationsstandarder och -metoder.
...
- **Balansera risker och förmåner.** Genom att noggrant granska styrningsbeslut tidigt i distributionen kan organisationer förstå hela miljön – företag, regelverk, lagstiftning och efterlevnad – och planera en lösning som optimerar för alla resultat – balansera risker med fördelar – ibland acceptera risken och andra tider, välja att inte acceptera risken. Om du tar välgrundade beslut i fronten får du bättre resultat utan att det blir en sprawling och ohanterat innehåll.

- **Anpassa till olika organisationer och olika typer av innehåll och scenarier.** Styrningsbeslut är unika beslut för varje organisation – en storlek passar inte alla. Varje organisation har inte bara olika behov för styrning, utan styrningsbeslut är ofta inte samma för varje typ av innehåll i Microsoft 365. Styrning för teaminnehåll kan till exempel vara annorlunda än styrning för intranätinnehåll och från enskilt innehåll i OneDrive.

- **Justera affärsprioriteringar.** Det är dags att börja tänka på styrning när du identifierar viktiga affärsprioriteringar för de lösningar du skapar i Microsoft 365. Dessa viktiga affärsresultat definierar sammanhanget för planering av styrning. Det är viktigt eftersom dina affärsmål hjälper dig att definiera hur mycket tid och energi du behöver för att investera i styrning. Om det till exempel inte är särskilt viktigt att förbättra innehållstillgängligheten i hela organisationen, behöver du förmodligen inte ägna för mycket tid åt att tillämpa eller planera namngivningskonventioner för filer. Om du å andra sidan vill minska antalet förekomster av flera versioner av samma dokument på olika lagringsplatser i företaget så kommer dina styrningsbeslut att behöva processer och principer och utbildning för att säkerställa att innehållsförfattare förstår hur filer namnges och följer "en kopia av ett dokument"-vägledning för att se till att innehåll publiceras på bara en plats. Det innebär också att du behöver en process för att säkerställa att du inte skapar mer än en webbplats eller grupp för samma ändamål.

## <a name="how-should-we-be-communicating-about-governance"></a>Hur ska vi kommunicera om styrning?

Många styrningsbeslut kan implementeras genom att aktivera eller inaktivera funktioner i Microsoft 365. Det kan bidra till att tillämpa dina styrningsstandarder men det kanske inte hjälper människorna i din organisation att förstå vad som är tillgängligt för dem och varför (eller varför inte). 
...
Styrning är en lagsport. Kontrollera att ditt centrala team för styrningsplanering omfattar representanter från både företag och IT. Ditt team kommer antagligen att behöva träffas oftare i början av din roll och sedan regelbundet gå igenom nya funktioner och nya affärsförväntningar.

Arbeta igenom viktiga styrningsbeslut – men försök inte att fatta alla beslut på en gång. Fatta viktiga beslut om etablering och namngivning och extern åtkomst och gå sedan igenom de återstående besluten.
...
Affärsresultatsmål bör vara den primära drivrutinen för dina styrningsbeslut:

- Förstå de reglerande kraven som påverkar din organisation. Vissa av dina viktigaste beslut och implementeringskrav kan behöva anpassas till den miljö där du arbetar.

- Försök att inte bli fångad i "Det är vad vi alltid har gjort". Molnet och den växande globaliseringen av många organisationer introducerar nya möjligheter. Utmaningsantaganden om de inte är i linje med affärsmål. Kan du slappna av reglerna för vissa scenarier eller för vissa personer? Kan du få samma affärsresultat med hjälp av funktionerna i Microsoft 365 i stället för att blockera en aktivitet helt och hållet?

- Om du låser allt hittar andra en arbets igen. Försök att förstå viktiga affärsscenarier som användarna vill aktivera och tillhandahålla riktlinjer och utbildning efter behov. 

- Överväg att införliva aktiviteter för att granska viktiga webbplatser och aktiviteter för att se till att webbplats- och gruppägare följer din styrningsvägledning.
...
[Filsamarbete i SharePoint med Microsoft 365](/sharepoint/deploy-file-collaboration)