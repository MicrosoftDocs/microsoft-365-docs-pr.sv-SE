...
Mer information finns i den här [översikt över Configuration Manager](/mem/configmgr/core/understand/introduction).
...
Mer information finns i den här [översikt över samhantering](/mem/configmgr/comanage/overview).
...
Mer information finns i den här [översikt över Desktop Analytics](/mem/configmgr/desktop-analytics/overview)
...
Mer information finns i den här [översikt över Windows Autopilot](/windows/deployment/windows-autopilot/windows-autopilot).
...
- [Registrera olika typer av enheter för hantering av mobila enheter](/mem/intune/enrollment/device-enrollment)
- [Hur du utbildar dina slutanvändare om Microsoft Intune](/mem/intune/fundamentals/end-user-educate)
