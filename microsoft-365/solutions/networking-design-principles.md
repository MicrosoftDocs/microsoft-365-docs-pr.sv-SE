...
---
# <a name="networking-up-to-the-cloud--one-architects-viewpoint"></a>Nätverk upp (till molnet) – en arkitekts synvinklar
...
Jag är för närvarande en teknisk specialist i den södra öst-regionen som fokuserar på säkerhets & efterlevnad. Jag har arbetat med kunder som flyttar till Office 365 under de senaste tio åren. Jag har arbetat med mindre butiker med en fåtal av platser till statliga myndigheter och företag med miljon tals användare i världen, och många andra kunder emellan, med massor av tusentals användare, flera platser i olika delar av världen, behovet av högre säkerhet och ett stort antal efterföljandekrav. Jag har hjälpt hundratals företag och miljon tals användare att flytta till molnet säkert och säkert.
...
## <a name="its-not-the-network--its-how-youre-misusing-it"></a>Det är inte nätverket – det är så du kan (MIS) använda det!

Det spelar ingen roll hur många gånger det tar att det inte går att överraska mig hur *kreativa* säkerhets team och nätverks Team försöker få information om hur de ska ansluta till Microsofts moln tjänster. Det finns alltid vissa säkerhets principer, efterlevnadar standard eller bättre sätt de måste att använda, utan att delta i en konversation om vad det är som de försöker genomföra, eller *hur* de är bättre, enklare, mer kostnads effektivt och mer på att göra detta. 

När den här sortens saker eskaleras till mig är jag vanligt vis villig att ta utmaningarna och gå igenom Hows och whys och få dem att vara. Men om jag är helt Frank måste jag dela det ibland jag vill för att bara låta dem göra vad de ska och komma tillbaka till Säg att jag får ett meddelande om att det inte fungerar. Jag kanske vill göra det ibland men jag vill *inte*. Vad jag gör är att förklara vad jag ska ta med i det här inlägget. Oberoende av din roll, om din organisation vill använda Microsofts moln tjänster, finns det troligen vissa ned idéerna som kan hjälpa dig.
...
- Det **innebär att du inte ska göra det** , eller Paraphrase Dr. Ian Malcolm från Jurassic Park-filmen ". . . Ja, ja, men din säkerhets grupp var så upptagen, oavsett om de kunde göra det eller inte. "    
- **Säkerhet betyder inte komplexitet** – du är inte säkrare eftersom du tillbringar mer pengar, dirigerar genom fler enheter eller klickar på fler knappar.
...
- **Chokepoints är skadade, lokaliserade breakouts är bra** – alla kan alltid fylla på alla sina Internet-uppgifter för alla sina användare till en central plats, så att de själv ska kunna övervaka den och genomföra principer, men ofta för att det är billigare än att tillhandahålla Internet åtkomst på alla platser, eller det är bara det du gör det. Men dessa chokepoints är exakt det... Poäng där trafikstrypningar är. Det finns inget fel med att förhindra att användarna surfar på Instagram eller direktuppspelande Cat-videor, men du kan inte hantera ditt uppdrag – kritisk affärs program trafik på samma sätt.
...
- Det innebär att du inte behöver **göra det nu** – teknik förändringar kontinuerligt och att Office 365 inte är ett undantag. Säkerhets åtgärder som har utvecklats och distribuerats för lokala tjänster eller för kontroll av webbsurfning kommer inte att tillhandahålla samma säkerhets garanti och kan ha en avsevärd negativ inverkan på prestanda.
- **Office 365 har utformats för att kunna nås via Internet** – det är nötskal. Oavsett vad du vill göra mellan användarna och din sida, kommer trafiken att gå över Internet när den lämnar nätverket och innan det får i vårt. Även om du använder Azure ExpressRoute för att dirigera viss fördröjnings känslig trafik från ditt nätverk direkt till vår, är Internet anslutningen absolut nödvändig. Godkänn det. Bry dig inte om det.
...
TLS-inspektion innebär säkerhet! Men inte riktigt det! Många kunder med proxyservrar vill använda dem för att kontrol lera all trafik och det innebär att TLS "bryta och inspektera". När du gör det för en webbplats som nås via HTTPS (sekretess frågor utan problem) kanske din proxy måste göra det för tio eller till och med 20 samtidiga data strömmar i några hundra millisekunder. Om det finns en stor nedladdning eller en video som är involverad kan en eller flera av dessa anslutningar vara längre, men de flesta av dessa anslutningar upprättar, överför och stänger snabbt. Om du gör paus och inspekterar måste den fungera dubbelt. För varje anslutning från klienten till proxyservern måste proxyservern också ansluta tillbaka till slut punkten. Det innebär att en blir två till fyra 32 till 64. . . Se var jag håller? Du har förmodligen begränsat storleken på din proxyserver för vanlig webbsurfning, men när du försöker göra samma sak för klient anslutningar till Office 365 kan antalet samtidiga lång tids lösa anslutningar vara större än vad du har för storlek.
...
Om du inte tillåter utgående UDP-trafik från klienter till tjänsten kan de använda TCP. Men om ett TCP-paket bryts *avbryts allting* tills timeout-värdet för överföring (RTO) upphör att gälla och det paket som saknas kan överföras. Om ett paket tar slut kan allting sluta tills de andra paketen ankommer och kan sättas ihop i rätt ordning. Båda kan leda till perceptiblea problem i ljudet (kom ihåg Max utrymme?) och video (klicka på someth. . . Det är bara att göra det och få en dålig prestanda och en dålig användar upplevelse. Och kom ihåg vad jag lägger upp ovanför om proxyservrar? När du tvingar en Teams-klient att använda en proxyserver tvingar du den att använda TCP. Det innebär att du får negativa prestanda konsekvenser två gånger.
...
Tvinga fram en TLS-anslutning, eller 32 av dem, för att gå över ett VPN innan de går vidare till tjänsten lägger inte till säkerhet. Det gör att du kan lägga till fördröjningar och reducerar hela flödet. I vissa VPN-lösningar tvingar det sig att UDP-till-tunnel via TCP vilket återigen får en mycket negativ inverkan på strömnings trafiken. Och såvida du inte genomför en TLS-kontroll finns det ingen upp och alla nack delar. Ett mycket vanligt tema mellan kunder, nu när de flesta av deras arbets styrka är fjärr, är det viktigt att de ser markanta bandbredd och prestanda påverkan från att göra alla sina användare anslutna med hjälp av ett VPN, i stället för att konfigurera dela tunnlar för Access för att [optimera kategorierna för Office 365-slutpunkter](https://docs.microsoft.com/microsoft-365/enterprise/microsoft-365-network-connectivity-principles#new-office-365-endpoint-categories).
