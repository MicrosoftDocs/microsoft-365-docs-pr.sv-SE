---
title: Microsoft 365 Enterprise resursplanering – Arkitektur för cybersäkerhet
...
|[Microsoft 365 Säkerhet för beslutsfattare i företaget](../security/Microsoft-365-security-for-bdm.md)    | När du har tid för en mer omfattande plan innehåller den här artikeln rekommendationer som spänner över Microsoft 365, prioriterad efter attackytan. Det har även ett kalkylblad som du kan använda för att sortera på licensiering och område (till exempel identitet, skydd mot hot och övervakning).  |
