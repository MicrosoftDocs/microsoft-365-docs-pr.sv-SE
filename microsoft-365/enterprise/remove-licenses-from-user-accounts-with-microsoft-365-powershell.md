...
2. Använd följande syntax:
  ...
  ```
I det här exemplet tas **licensen litwareinc:ENTERPRISEPACK** (Office 365 Enterprise, E3) bort från de användarkonton som definierats i textfilen C:\My Documents\Accounts.txt.
