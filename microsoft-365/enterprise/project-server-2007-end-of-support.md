...
2. I Project Professional 2013 Project Professional 2016, eller Project Online-skrivbordsklienten, varje MPP-fil och sparar och publicerar den sedan Project Online.
    
Du kan manuellt skapa Microsoft Project Web App-konfiguration (PWA) i Project Online. Återskapa till exempel alla nödvändiga anpassade fält eller företagskalendrar. Microsoft-partner kan också hjälpa dig med den här processen.
...
|[Project Online Tjänstbeskrivningar](/office365/servicedescriptions/project-online-service-description/project-online-service-description) <br/> |Information om de Project Online abonnemang som är tillgängliga för dig <br/> |
...
Om du inte kan migrera till Project Online rekommenderar vi att du migrerar till Project Server 2016. Project Server 2016 innehåller alla funktioner i tidigare versioner av Project Server. Den motsvarar bäst den upplevelse som är tillgänglig med Project Online, även om vissa funktioner endast är tillgängliga i Project Online.
...
Arkitekturskillnaderna mellan Project Server 2007 och Project Server 2016 att förhindra en direkt migreringväg. Så du måste migrera dina Project Server 2007-data till varje efterföljande version av Project Server tills du kommer till Project Server 2016.
  
Följ dessa steg för att Project Server 2016:
  
1. Migrera från Project Server 2007 till Project Server 2010.
    
2. Migrera från Project Server 2010 till Project Server 2013.
...
En detaljerad beskrivning av vad du behöver göra för att uppgradera från Project Server 2007 till Project Server 2010 finns i Uppgradera till [Project Server 2010.](/previous-versions/office/project-server-2010/gg502590(v=office.14))
  
Viktiga resurser:
  
|**Resurs**|**Beskrivning**|
|:-----|:-----|
|[Project Server 2010 – uppgradering – översikt](/previous-versions/office/project-server-2010/ee662496(v=office.14)) <br/> |En bra vy över vad du behöver göra för att uppgradera från Project Server 2007 till Project Server 2010 <br/> |
|[Planerar att uppgradera till Project Server 2010](/previous-versions/office/project-server-2010/ff603505(v=office.14)) <br/> |Att tänka på när du uppgraderar från Project Server 2007 till Project Server 2010, inklusive systemkrav  <br/> |
...
- **Uppgradering med databas bifoga:** Med den här metoden uppgraderas bara innehållet för miljön, inte konfigurationsinställningarna. Det är obligatoriskt om du uppgraderar från Office Project Server 2007 som är distribuerad på maskinvara som bara stöder 32-bitars serveroperativsystemet. Det finns två typer av uppgraderingsmetoder med databas bifoga:
  ...
  - Fullständig uppgradering med databas ***bifogar*** – Migrerar de projektdata som lagras i Office Project Server 2007-databaser, plus webbplatsdata från Microsoft Project Web App som lagras i en SharePoint-innehållsdatabas.
    
  - **Grundläggande uppgradering med *databas bifogar*** – Migrerar bara de projektdata som lagras i Project Server-databaser.
    
- **Uppgradering på plats:** Konfigurationsdata för servergruppen och allt innehåll i servergruppen uppgraderas på den befintliga maskinvaran i en fast ordning. När du startar uppgraderingen tar konfigurationen hela servergruppen offline. Webbplatserna och webbplatserna Microsoft Project Web App är inte tillgängliga förrän uppgraderingen är klar och sedan startar installationen om servern. När du påbörjar en på plats-uppgradering kan du inte pausa uppgraderingen eller gå tillbaka till den tidigare versionen. Det är bäst att göra en speglad bild av produktionsmiljön och uppgradera till den miljön på plats, inte i produktionsmiljön. 
...
|**Resurs**|**Beskrivning**|
|:-----|:-----|
|[Översikt över Project server 2013-uppgraderingen](/project/upgrade-to-project-server-2016) <br/> |Översikt över vad du behöver göra för att uppgradera från Project Server 2010 till Project Server 2013  <br/> |
...
[Vad är nytt i Project Server 2013-uppgraderingen](/project/what-s-new-in-project-server-2013-upgrade) beskriver viktiga ändringar för uppgradering för den här versionen. De mest märkbara är: 
...
|**Resurs**|**Beskrivning**|
|:-----|:-----|
|[Översikt över Project Server 2016 uppgraderingsprocessen](/previous-versions/office/project-server-2010/ee662104(v=office.14)) <br/> |Översikt över vad du behöver göra för att uppgradera från Project Server 2013 till Project Server 2016 <br/> |
...
[Saker du behöver veta om Project Server 2016 innebär att](/project/plan-for-upgrade-to-project-server-2016) du får information om vissa viktiga ändringar för uppgradering för den här versionen, bland annat:
  
- När du skapar Project Server 2016-miljön som du ska migrera dina Project Server 2013-data till ingår Project Server 2016-installationsfilerna i SharePoint Server 2016. Mer information finns i [Distribuera Project Server 2016](/project/deploy-project-server-2016).
...
- [Microsoft Office Project Portfolio Server 2007- migreringsguide.](https://go.microsoft.com/fwlink/p/?linkid=841279)
