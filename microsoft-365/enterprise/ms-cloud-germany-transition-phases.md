...
- Om du använder Exchange Online-hybrid:
    ...
    - Exchange Online-hybridkunder måste köra hybridkonfigurationsguiden (HCW) flera gånger som en del av den här övergången. Innan migreringsstegfas **5** börjar måste alla Exchange Online-hybridkunder köra den senaste versionen av HCW i Office 365 Germany-läget för att förbereda den lokala konfigurationen för migreringen till Office 365 globalt. När migreringsfasen **5** har slutförts (när meddelandet om meddelandecenter publiceras) måste du köra HCW mot att använda globala Inställningar för Office 365 så att dina lokala system pekar på den globala tjänsten. Ytterligare DNS-uppdateringar kan krävas om du använder anpassade domäner.
