...
- [Testlabbguiden Skydda filer i Teams](https://docs.microsoft.com/microsoft-365/security/office-365-security/secure-team-for-files-in-a-dev-test-environment)

### <a name="updates-and-enhancements"></a>Uppdateringar och förbättringar

-  Uppdatering av uppsättningen med [testlabbguider](m365-enterprise-test-lab-guides.md) 
...
- [Team för ett topphemligt projekt på Contoso Corporation](contoso-team-for-top-secret-project.md)
  ...
  [![Team för ett topphemligt projekt på Contoso Corporation](../media/contoso-team-for-highly-confidential-assets/final-config-example-file.png)](contoso-team-for-top-secret-project.md)
...
- [SharePoint-webbplatser för strikt reglerade data (affisch)](teams-sharepoint-online-sites-highly-regulated-data.md#poster)
...
- [Distribuera Windows 10 med Autopilot (affisch)](windows10-deploy-autopilot.md) 
...
- [Ge distansarbetare goda förutsättningar (affisch)](empower-people-to-work-remotely.md#poster)
...
- [Scenario för distansarbetare](empower-people-to-work-remotely.md)

  [![Konfiguration för distansarbetare i en organisation med hybrididentitet](../media/empower-people-to-work-remotely/remote-workers-hybrid.png)](empower-people-to-work-remotely.md) 
 
  Meddelanden: [Microsoft 365 Technical Community-bloggen](https://techcommunity.microsoft.com/t5/Microsoft-365-Blog/Empower-your-remote-workers-with-Microsoft-365-Enterprise/ba-p/935196#M236)  |  [LinkedIn](https://www.linkedin.com/pulse/how-do-i-configure-microsoft-365-enterprise-empower-my-joe-davies/)

- [Steg för e-postkryptering](infoprotect-email-encryption.md) för [Fas 6: Informationsskydd](infoprotect-infrastructure.md)

### <a name="updates-and-enhancements"></a>Uppdateringar och förbättringar

- Omorganisera och uppdatering av [Fas 2: Identitet](identity-infrastructure.md)
- Uppdatering av [Fas 1: Nätverk](networking-infrastructure.md) och [Fas 6: Informationsskydd](infoprotect-infrastructure.md)
...
- [Identitetsinfrastruktur för Microsoft 365 för företag (affisch)](identity-infrastructure.md)
  ...
  Meddelanden: [Microsoft 365 Technical Community-bloggen](https://techcommunity.microsoft.com/t5/Microsoft-365-Blog/Get-the-new-Identity-infrastructure-for-Microsoft-365-Enterprise/ba-p/874941)  |  [LinkedIn](https://www.linkedin.com/pulse/how-can-i-quickly-ramp-up-key-concepts-features-identity-joe-davies/?published=t)


- [Support upphör för Windows 7 och Office 10 (affisch)](migration-microsoft-365-enterprise-workload.md#summary-of-options-for-office-2010-clients-and-servers-and-windows-7)
  
  [![Bild på upphörande av support för Office 2010-klienter och -servar och Windows 7 (affisch)](../media/migration-microsoft-365-enterprise-workload/office2010-windows7-end-of-support.png)](../media/migration-microsoft-365-enterprise-workload/Office2010Windows7EndOfSupport.pdf)

  Meddelanden: [Microsoft 365 Technical Community-bloggen](https://techcommunity.microsoft.com/t5/Microsoft-365-Blog/Move-from-Office-2010-clients-and-servers-and-Windows-7-to/ba-p/846994)  |  [LinkedIn](https://www.linkedin.com/pulse/how-can-microsoft-365-enterprise-help-me-end-support-products-davies/)
...
- [Microsoft 365 för företag för organisationer som inte är större företag](deploy-foundation-infrastructure-non-enterprises.md)
  ...
  Meddelanden: [Microsoft 365 Technical Community-bloggen](https://techcommunity.microsoft.com/t5/Microsoft-365-Blog/Deploy-Microsoft-365-Enterprise-infrastructure-even-if-you-re/ba-p/900012)  |  [LinkedIn](https://www.linkedin.com/pulse/how-do-i-deploy-microsoft-365-enterprise-without-joe-davies/)
