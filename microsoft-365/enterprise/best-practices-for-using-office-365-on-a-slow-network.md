...
### <a name="major-factors-that-affect-network-performance"></a>Viktiga faktorer som påverkar nätverkets prestanda
...
Mer information finns i Windows [Prestanda och underhåll samt Tips](https://windows.microsoft.com/windows/performance-maintenance-help#performance-maintenance-help) för att förbättra [datorns prestanda i Windows 10.](https://support.microsoft.com/help/4002019/windows-10-improve-pc-performance)
...
### <a name="browsers-in-general"></a>Webbläsare i allmänhet
...
### <a name="browser-specific"></a>Specifika webbläsare
...
- **FireFox:** Mer information finns i [Firefox is slow or stops working](https://support.mozilla.org/products/firefox/fix-problems/slowness-or-hanging).
