...
---
# <a name="how-to-manage-microsoft-365-with-windows-powershell-for-delegated-access-permissions-partners"></a>Hur du hanterar Microsoft 365 med Windows PowerShell för partner med delegerade åtkomstbehörigheter

*Denna artikel gäller för både Microsoft 365 Enterprise och Office 365 Enterprise.*

DAP-partner (Delegerad åtkomstbehörighet) är syndicerings- och molnlösningsleverantörer (CSP). Många är nätverks- eller tjänsteleverantörer. De paketar Microsoft 365 prenumerationer till sina tjänsteerbjudanden. När de säljer en Microsoft 365-prenumeration tilldelas de automatiskt behörigheten Administrera för (AOBO) för kundens företag så att de kan administrera och rapportera om dessa tenaniteter. De här uppgifterna är svåra att göra Microsoft 365 administrationscentret. Det är mycket enklare att använda PowerShell för Microsoft 365 utföra administrativa uppgifter som:
