...
---
# <a name="manage-microsoft-365-with-powershell"></a>Hantera Microsoft 365 med PowerShell
...
- [**Användarkonton, licenser och grupper**](manage-user-accounts-and-licenses-with-microsoft-365-powershell.md)
    ...
    Börja här om du vill veta mer om att använda automatiseringskommandon för att hantera användarkonton, licenser och grupper.

- [**SharePoint**](manage-sharepoint-online-with-microsoft-365-powershell.md)

    Börja här om du vill använda automatiseringskommandon för att hantera SharePoint.

- [**Exchange Online**](/powershell/exchange/exchange-online-powershell)

    Börja här om du vill hantera Exchange Online.

- [**E-postmigrering**](use-powershell-for-email-migration-to-microsoft-365.md)

    Börja här om du vill migrera din e-post från befintliga system.

- [**Säkerhets- och efterlevnadscenter**](/powershell/exchange/scc-powershell)

    Börja här om du vill hantera funktionerna & Säkerhets- och efterlevnadscenter.
