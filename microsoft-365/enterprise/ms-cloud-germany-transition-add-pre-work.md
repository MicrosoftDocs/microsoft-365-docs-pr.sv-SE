...
| Förbereda för att meddela användarna om omstart och inloggning till och från sina klienter efter migreringen. | Office-klientlicensiering kommer att övergå från Microsoft Cloud Deutschland till Office 365-tjänster under migreringen. Klienter hämtar en ny giltig licens när de har loggat ut från och in i Office-klienter. | Microsoft 365 Apps-kunder |  Användarnas Office-produkter behöver uppdatera licenser från Office 365-tjänster. Om licenser inte uppdateras kan verifieringsfel uppstå för Office-produkter. |
...
| Steg | Beskrivning | Gäller för | Påverkan |
|:-------|:-----|:-------|:-------|
| Uppdatera till den senaste versionen av hybridkonfigurationsguiden (HCW) före migreringen. <br><br> Microsoft Cloud Deutschland-hybridkunder i Exchange Online måste avinstallera tidigare versioner av HCW och sedan installera och köra den senaste versionen (17.0.5378.0 eller senare) [https://aka.ms/hybridwizard](https://aka.ms/hybridwizard) från. | Den senaste versionen av HCW innehåller uppdateringar som stöd för kunder som övergår från Microsoft Cloud Deutschland till Office 365 Services. <br><br> Uppdateringar omfattar ändringar av lokala certifikatinställningar för skicka anslutare och mottagningskoppling. <br><br> Kunder måste installera om med inställningarna för Office 365 Germany innan fas 5 av 9 (Exchange-migrering) startar. <br><br> Obs! När migreringen till Office 365-tjänsterna har slutförts tar du bort och installerar om HCW igen, den här gången med hjälp av de globala Inställningarna för Office 365 för att slutföra hybridkonfigurationen med den globala tjänsten. | Exchange Online-kunder som kör hybriddistribution | Åtgärd krävs. Om du inte gör det före fas 5 av 9 (Exchange-migrering) kan det leda till tjänst- eller klientfel. |
|||||
...
| Steg | Beskrivning | Gäller för | Påverkan |
|:-------|:-----|:-------|:-------|
| Avgöra om någon konfiguration krävs efter migreringen. | Tredjepartstjänster och program som integrerar med Office 365 kan vara kodade för att förvänta sig Microsoft Cloud Deutschland IP-adresser och URL-adresser. | Alla kunder | Åtgärd krävs. Inaction kan resultera i fel i tjänsten eller klientprogramvaran. |
|||||
