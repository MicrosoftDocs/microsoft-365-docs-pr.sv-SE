...
I den här artikeln beskrivs hur du kan distribuera SharePoint Online utan traditionella belastningstester eftersom belastningstester inte är tillåtna på SharePoint Online. SharePoint Online är en molntjänst och belastningsfunktionerna, hälsotillståndet och den övergripande belastningsfördelningen i tjänsten hanteras av Microsoft.
...
## <a name="why-you-cannot-load-test-sharepoint-online"></a>Varför du inte kan läsa SharePoint Online
...
I stället för att försöka läsa in SharePoint som en tjänst bör du hellre fokusera på att följa de rekommenderade metoderna och följa vägledning, starta och underhålla en [felfri](/sharepoint/portal-health) portalvägledning.