...
_Windows-enheter_ är Windows-enheter som kör tidigare versioner av Windows (till exempel Windows 8.1 eller Windows 7) eller som kör Windows Server-versioner tidigare än 2019 och 2016. Om sådana enheter har registrerats tidigare måste du avregistrera och registrera om enheterna. 

Använd följande kommando på Windows om en enhet med lägre nivå tidigare var ansluten till Azure AD:
...
Föregående kommando behöver bara köras en gång per domänanvändare som loggar in Windows nednivåenheten. Det här kommandot ska köras inom ramen för domänanvändaren som loggar in. 
...
För att avgöra om Windows 10-enheten tidigare var ansluten till Azure AD kör du följande kommando på enheten:
...
Föregående kommando behöver bara köras en gång i ett administrativt sammanhang på Windows enhet.
...
Användaren kan ansluta enheten till Azure AD via Windows inställningar: **Inställningar >-> Arbets-** eller > Anslut .
