...
<p>Läs om fördelarna med Windows 10 och Microsoft 365-applikationer för företag, vilka större förändringar som gjorts och vilka överväganden som krävs jämfört med tidigare distributioner samt metodtips för att säkerställa en smidig övergång till Windows 10 och Microsoft 365-applikationer för företag.</p></td>
...
>[!NOTE]
>I den här serien går vi igenom de bästa sätten att använda befintliga verktyg och presenterar de nya tekniker, tjänster och metoder som möjliggjorts av molnet.  Om du vill se den fullständiga skrivbordsdistributionsprocessen kan du gå till [Center för skrivbordsdistribution](https://aka.ms/HowToShift).
>

Välkommen till Center för skrivbordsdistribution, en central plats där du kan lära dig hur du planerar för och utför övergången till Windows 10 och Microsoft 365-applikationer för företag. Det innebär att du kan använda en säker arbetsyta med de senaste produktivitets- och samarbetsfunktionerna.
...
I den här introduktionen beskriver vi vad som har ändrats och tar en titt på skrivbordsdistributionshjulet. Vi vägleder dig genom de rekommenderade stegen för övergången till Windows 10 och Microsoft 365-applikationer för företag, och vi visar i detalj hur du kan använda dina befintliga verktyg och processer samtidigt som du börjar använda moderna tekniker och metoder.
...
En viktig faktor inom modern hantering är att alltid ha uppdaterade enheter. I den här serien får du läsa om nya funktioner som du kan använda i din övergång till Windows 10 och Microsoft 365-applikationer för företag och hur du håller dem uppdaterade med nya versioner som släpps varje halvår.
...
**Klicka-och-kör-distributioner:** När du ska installera Office-skrivbordsprogram rekommenderar vi att du använder Microsoft 365-applikationer för företag. Det ger dig tillgång till de senaste nyheterna i Office allt eftersom de utvecklas, så du inte behöver vänta i åratal innan du får nya funktioner. Du kan också använda en ny installation som kallas Klicka-och-kör.
...
**[Steg 3: Leverans av Office och verksamhetsspecifika appar](https://aka.ms/mdd3)** Windows fortsätter att stödja MSI-baserade installationer men har nu också stöd för nya installationsmekanismer som är optimerade för automatiserad distribution och kontinuerliga uppdateringar. Klienter för Microsoft 365-applikationer för företag och Office 2019 använder installationstekniken Klicka-och-kör. Du kanske vill göra UWP-appar tillgängliga, och du kanske har börjat distribuera alltfler program från tredje part och egenutvecklade verksamhetsspecifika program som använder de nya MSIX-paketerade apparna. Det här steget säkerställer att dina program är redo för automatisk distribution, och att du är redo oavsett om dina appar distribueras via Klicka-och-kör, MSIX, MSI (traditionell distribution), eller om dina appar är UWP-appar som distribuerats från en Microsoft Store för företag som du konfigurerat.
...
Nu vet du vad som är nytt och annorlunda i Windows 10 och Microsoft 365-applikationer för företag. Vi har också gått igenom det rekommenderade distributionsprocesshjulet. Nu när du har fått ett smakprov på vilka instruktioner och verktyg som finns tillgängliga för hela processen för att hjälpa dig med övergången till Windows 10 och Microsoft 365-applikationer för företag är det dags att sätta igång.
