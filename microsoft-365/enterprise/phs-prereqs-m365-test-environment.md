...
I den här artikeln beskrivs hur du konfigurerar en Microsoft 365-testmiljö som uppfyller kraven för [hybriden](../security/office-365-security/identity-access-prerequisites.md#prerequisites) med lösenordshasharsynkronisering som krävs för konfiguration av identiteter och enhetsåtkomst.
