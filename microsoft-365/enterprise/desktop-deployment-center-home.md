        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Uppgradera ConfigMgr till Current Branch</h3>
            <p>Del av katalog- och nätverksberedskap för organisationer med Configuration Manager</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Verifiera beredskap för enheter och appar</h3>
            <p>Del av beredskap för enheter och appar. Hjälp finns tillgänglig via Desktop App Assure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Uppgradera datorer med Windows 7 till Windows 10</h3>
            <p>Del av distribution av operativsystem och funktionsuppdateringar för användarbevarade datorer</p>
                    </div>
                </div>
            </div>
        </div>
...
<td><p><strong><a href="https://aka.ms/mdd1">Steg 1: Beredskap för enheter och appar</a></strong></p>
<p>Starta ditt distributionsprojekt för datorhantering med en inventering av dina enheter och appar, prioritera vad du behöver för att gå vidare, testa prioriterade appar och enheter och åtgärda sedan vad som krävs för att distribueras.</p></td>
...
<td><p><strong><a href="https://aka.ms/mdd4">Steg 4: Användares filer och inställningar</a></strong></p>
