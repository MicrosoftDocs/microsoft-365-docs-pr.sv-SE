...
Om du fortfarande använder Azure Active Directory (Azure AD)-synkroniseringsverktyget (DirSync) läser du [Så här felsöker du felmeddelanden för installationen av och konfigurationsguiden för Azure Active Directory-synkroniseringsverktyget i Microsoft 365](https://go.microsoft.com/fwlink/p/?LinkId=396717). Där finns information om systemkraven för att installera dirsync, vilken behörighet du behöver och hur du felsöker vanliga fel. 
  
För Information om hur du uppdaterar från Azure AD-Synkronisering till Azure AD Connect se [Uppgraderingsinstruktioner](https://go.microsoft.com/fwlink/p/?LinkId=733240).
...
- Är du redo att hantera objekt endast i molnet? Eller finns det ett objekt som har tagits bort lokalt, men fastnat i molnet? Ta en titt på den här [Felsökningsfel under synkronisering ](https://go.microsoft.com/fwlink/p/?linkid=842044) och [Supportartikel](https://go.microsoft.com/fwlink/p/?LinkId=396720) för vägledning om hur du löser problemen.
...
- Du kan läsa mer om problemet [här](https://go.microsoft.com/fwlink/p/?LinkId=396721).
...
- [Skript för att räkna totalt antal synkroniserade objekt](https://go.microsoft.com/fwlink/p/?LinkId=396726)
